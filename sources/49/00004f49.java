...
@f(c = "com.stripe.android.link.repositories.LinkApiRepository$confirmVerification$2", f = "LinkApiRepository.kt", l = {126}, m = "invokeSuspend")
/* loaded from: classes6.dex */
public final class LinkApiRepository$confirmVerification$2 extends l implements p<o0, d<? super q<? extends ConsumerSession>>, Object> {
    ...
    public LinkApiRepository$confirmVerification$2(LinkApiRepository linkApiRepository, String str, String str2, String str3, d<? super LinkApiRepository$confirmVerification$2> dVar) {
        super(2, dVar);
    ...
    public final d<b0> create(Object obj, d<?> dVar) {
        LinkApiRepository$confirmVerification$2 linkApiRepository$confirmVerification$2 = new LinkApiRepository$confirmVerification$2(this.this$0, this.$consumerSessionClientSecret, this.$verificationCode, this.$authSessionCookie, dVar);
    ...
    public final Object invoke2(o0 o0Var, d<? super q<ConsumerSession>> dVar) {
        return ((LinkApiRepository$confirmVerification$2) create(o0Var, dVar)).invokeSuspend(b0.f54756a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (e11 != null) {
            ...
            logger.error("Error confirming consumer verification", e11);
            q.a aVar5 = q.f54772b;
        ...
        if (a11 == null) {
            q.a aVar7 = q.f54772b;
            j11 = q.b(r.a(new InternalError("Error confirming consumer verification")));
        } else {
            j11 = a11.j();
        }
        return q.a(j11);
