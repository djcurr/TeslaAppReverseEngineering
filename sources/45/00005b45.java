...
final class SimpleDialogElementUIKt$SimpleDialogElementUI$3$2$1$1 extends u implements a<b0> {
    final /* synthetic */ a<b0> $onConfirmListener;
    final /* synthetic */ o0<Boolean> $openDialog;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SimpleDialogElementUIKt$SimpleDialogElementUI$3$2$1$1(o0<Boolean> o0Var, a<b0> aVar) {
        super(0);
