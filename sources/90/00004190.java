...
public final class ButtonWithCards$ButtonWithCardsPane extends GeneratedMessageLite<ButtonWithCards$ButtonWithCardsPane, a> implements MessageLiteOrBuilder {
    private static final ButtonWithCards$ButtonWithCardsPane DEFAULT_INSTANCE;
    private static volatile Parser<ButtonWithCards$ButtonWithCardsPane> PARSER;
    ...
    public static final class Actions extends GeneratedMessageLite<Actions, b> implements MessageLiteOrBuilder {
        ...
        public static final class ButtonTapAction extends GeneratedMessageLite<ButtonTapAction, a> implements MessageLiteOrBuilder {
            ...
            public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
                switch (b0.f18185a[methodToInvoke.ordinal()]) {
                    case 1:
    ...
    public static final class Rendering extends GeneratedMessageLite<Rendering, a> implements MessageLiteOrBuilder {
            ...
            public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
                switch (b0.f18185a[methodToInvoke.ordinal()]) {
                    ...
                    case 2:
                        return new a();
                    case 3:
                        return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0003\u0000\u0000\u0001\u0003\u0003\u0000\u0000\u0000\u0001\t\u0002\t\u0003\t", new Object[]{"label_", "title_", "detail_"});
                    case 4:
                        return DEFAULT_INSTANCE;
                    case 5:
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setCards(int i11, Card card) {
            card.getClass();
            ensureCardsIsMutable();
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (b0.f18185a[methodToInvoke.ordinal()]) {
                ...
                case 2:
                    return new a();
                case 3:
                    return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\t\u0000\u0000\u0002\u000b\t\u0000\u0001\u0000\u0002\t\u0004\t\u0005\t\u0006\u001b\u0007\t\b\t\t\t\n\t\u000b\t", new Object[]{"institution_", "headerAsset_", "header_", "cards_", Card.class, "button_", "secondaryButton_", "events_", "paneHeader_", "buttonDisclaimerText_"});
                case 4:
                    return DEFAULT_INSTANCE;
                case 5:
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void addCards(int i11, Card card) {
            card.getClass();
            ensureCardsIsMutable();
    ...
    /* loaded from: classes2.dex */
    public static final class a extends GeneratedMessageLite.Builder<ButtonWithCards$ButtonWithCardsPane, a> implements MessageLiteOrBuilder {
        public a() {
            super(ButtonWithCards$ButtonWithCardsPane.DEFAULT_INSTANCE);
        }
    }

    static {
        ButtonWithCards$ButtonWithCardsPane buttonWithCards$ButtonWithCardsPane = new ButtonWithCards$ButtonWithCardsPane();
        DEFAULT_INSTANCE = buttonWithCards$ButtonWithCardsPane;
        GeneratedMessageLite.registerDefaultInstance(ButtonWithCards$ButtonWithCardsPane.class, buttonWithCards$ButtonWithCardsPane);
    }

    private ButtonWithCards$ButtonWithCardsPane() {
    }

    public static ButtonWithCards$ButtonWithCardsPane getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }
    ...
    public static ButtonWithCards$ButtonWithCardsPane parseDelimitedFrom(InputStream inputStream) {
        return (ButtonWithCards$ButtonWithCardsPane) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static ButtonWithCards$ButtonWithCardsPane parseFrom(ByteBuffer byteBuffer) {
        return (ButtonWithCards$ButtonWithCardsPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }

    public static Parser<ButtonWithCards$ButtonWithCardsPane> parser() {
        return DEFAULT_INSTANCE.getParserForType();
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (b0.f18185a[methodToInvoke.ordinal()]) {
            case 1:
                return new ButtonWithCards$ButtonWithCardsPane();
            case 2:
                return new a();
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0000", null);
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                Parser<ButtonWithCards$ButtonWithCardsPane> parser = PARSER;
                if (parser == null) {
                    synchronized (ButtonWithCards$ButtonWithCardsPane.class) {
                        parser = PARSER;
                        if (parser == null) {
                            parser = new GeneratedMessageLite.DefaultInstanceBasedParser<>(DEFAULT_INSTANCE);
                            PARSER = parser;
    ...
    public static a newBuilder(ButtonWithCards$ButtonWithCardsPane buttonWithCards$ButtonWithCardsPane) {
        return DEFAULT_INSTANCE.createBuilder(buttonWithCards$ButtonWithCardsPane);
    }

    public static ButtonWithCards$ButtonWithCardsPane parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (ButtonWithCards$ButtonWithCardsPane) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }

    public static ButtonWithCards$ButtonWithCardsPane parseFrom(ByteBuffer byteBuffer, ExtensionRegistryLite extensionRegistryLite) {
        return (ButtonWithCards$ButtonWithCardsPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, extensionRegistryLite);
    }

    public static ButtonWithCards$ButtonWithCardsPane parseFrom(ByteString byteString) {
        return (ButtonWithCards$ButtonWithCardsPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString);
    }

    public static ButtonWithCards$ButtonWithCardsPane parseFrom(ByteString byteString, ExtensionRegistryLite extensionRegistryLite) {
        return (ButtonWithCards$ButtonWithCardsPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, extensionRegistryLite);
    }

    public static ButtonWithCards$ButtonWithCardsPane parseFrom(byte[] bArr) {
        return (ButtonWithCards$ButtonWithCardsPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static ButtonWithCards$ButtonWithCardsPane parseFrom(byte[] bArr, ExtensionRegistryLite extensionRegistryLite) {
        return (ButtonWithCards$ButtonWithCardsPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, extensionRegistryLite);
    }

    public static ButtonWithCards$ButtonWithCardsPane parseFrom(InputStream inputStream) {
        return (ButtonWithCards$ButtonWithCardsPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static ButtonWithCards$ButtonWithCardsPane parseFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (ButtonWithCards$ButtonWithCardsPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }

    public static ButtonWithCards$ButtonWithCardsPane parseFrom(CodedInputStream codedInputStream) {
        return (ButtonWithCards$ButtonWithCardsPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, codedInputStream);
    }

    public static ButtonWithCards$ButtonWithCardsPane parseFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (ButtonWithCards$ButtonWithCardsPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, codedInputStream, extensionRegistryLite);
    }
}