...
public class HC256Engine implements StreamCipher {
    ...
    private byte[] f43501iv;
    private byte[] key;

    /* renamed from: p  reason: collision with root package name */
    private int[] f43502p = new int[1024];

    /* renamed from: q  reason: collision with root package name */
    private int[] f43503q = new int[1024];
    private int cnt = 0;
    ...
    private void init() {
        ...
        if (this.f43501iv.length >= 16) {
            ...
            byte[] bArr4 = this.f43501iv;
            if (bArr4.length < 32) {
                byte[] bArr5 = new byte[32];
                System.arraycopy(bArr4, 0, bArr5, 0, bArr4.length);
                byte[] bArr6 = this.f43501iv;
            ...
            for (int i13 = 0; i13 < 32; i13++) {
                int i14 = (i13 >> 2) + 8;
                iArr[i14] = iArr[i14] | ((this.f43501iv[i13] & 255) << ((i13 & 3) * 8));
            }
            ...
            System.arraycopy(iArr, 512, this.f43502p, 0, 1024);
            System.arraycopy(iArr, 1536, this.f43503q, 0, 1024);
    ...
    public void init(boolean z11, CipherParameters cipherParameters) {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            this.f43501iv = parametersWithIV.getIV();
            cipherParameters2 = parametersWithIV.getParameters();
        } else {
            this.f43501iv = new byte[0];
