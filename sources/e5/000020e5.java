...
public class zzfl {
    ...
    private zzfl(String str, int i11, zzfq zzfqVar, int i12) {
        this.zzqu = zzfqVar;
        this.zzqv = i12;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public /* synthetic */ zzfl(String str, int i11, zzfq zzfqVar, int i12, zzfk zzfkVar) {
        this(str, i11, zzfqVar, i12);
    }
