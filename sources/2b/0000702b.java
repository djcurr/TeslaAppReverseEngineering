...
public class b extends FilterOutputStream {
    ...
    private final Cipher f27811a;

    /* renamed from: b  reason: collision with root package name */
    private final byte[] f27812b;

    public b(OutputStream outputStream, Cipher cipher) {
        super(outputStream);
        this.f27812b = new byte[1];
        this.f27811a = cipher;
    }
    ...
    */
    public void close() {
        /*
            r4 = this;
            javax.crypto.Cipher r0 = r4.f27811a     // Catch: java.lang.Exception -> Lf java.security.GeneralSecurityException -> L27
        ...
        L40:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: g60.b.close():void");
    }
    ...
    public void write(byte[] bArr, int i11, int i12) {
        byte[] update = this.f27811a.update(bArr, i11, i12);
        if (update != null) {
