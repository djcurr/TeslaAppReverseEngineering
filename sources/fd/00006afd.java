...
public final class ModuleDefinitionBuilder$function$5 extends u implements p<Object[], Promise, b0> {
    final /* synthetic */ p<P0, P1, R> $body;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public ModuleDefinitionBuilder$function$5(p<? super P0, ? super P1, ? extends R> pVar) {
        super(2);
        this.$body = pVar;
    }
