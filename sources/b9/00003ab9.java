...
public final class Api extends GeneratedMessageV3 implements ApiOrBuilder {
    ...
    public int getSerializedSize() {
        ...
        for (int i12 = 0; i12 < this.methods_.size(); i12++) {
            computeStringSize += CodedOutputStream.computeMessageSize(2, this.methods_.get(i12));
        }
        ...
        for (int i14 = 0; i14 < this.mixins_.size(); i14++) {
            computeStringSize += CodedOutputStream.computeMessageSize(6, this.mixins_.get(i14));
        }
    ...
    public void writeTo(CodedOutputStream codedOutputStream) {
        ...
        for (int i11 = 0; i11 < this.methods_.size(); i11++) {
            codedOutputStream.writeMessage(2, this.methods_.get(i11));
        }
        ...
        for (int i13 = 0; i13 < this.mixins_.size(); i13++) {
            codedOutputStream.writeMessage(6, this.mixins_.get(i13));
        }
        if (this.syntax_ != Syntax.SYNTAX_PROTO2.getNumber()) {
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements ApiOrBuilder {
        ...
        public Method.Builder getMethodsBuilder(int i11) {
            return getMethodsFieldBuilder().getBuilder(i11);
        }
        ...
        public Mixin.Builder getMixinsBuilder(int i11) {
            return getMixinsFieldBuilder().getBuilder(i11);
        }
        ...
        public Builder setMethods(int i11, Method method) {
            ...
            if (repeatedFieldBuilderV3 == null) {
                ...
                repeatedFieldBuilderV3.setMessage(i11, method);
            }
            return this;
        }
        ...
        public Builder setMixins(int i11, Mixin mixin) {
            ...
            if (repeatedFieldBuilderV3 == null) {
                ...
                repeatedFieldBuilderV3.setMessage(i11, mixin);
            }
            return this;
        }
        ...
        public Method.Builder addMethodsBuilder(int i11) {
            return getMethodsFieldBuilder().addBuilder(i11, Method.getDefaultInstance());
        }

        public Mixin.Builder addMixinsBuilder(int i11) {
            return getMixinsFieldBuilder().addBuilder(i11, Mixin.getDefaultInstance());
        }
        ...
        public Builder addMethods(int i11, Method method) {
            ...
            if (repeatedFieldBuilderV3 == null) {
                ...
                repeatedFieldBuilderV3.addMessage(i11, method);
            }
            return this;
        }
        ...
        public Builder addMixins(int i11, Mixin mixin) {
            ...
            if (repeatedFieldBuilderV3 == null) {
                ...
                repeatedFieldBuilderV3.addMessage(i11, mixin);
            }
            return this;
        }
        ...
        */
        public com.google.protobuf.Api.Builder mergeFrom(com.google.protobuf.CodedInputStream r3, com.google.protobuf.ExtensionRegistryLite r4) {
            /*
                r2 = this;
                r0 = 0
