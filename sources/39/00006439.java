...
final class g {
    ...
    private final List<int[]> f23027a = new ArrayList();

    /* renamed from: b  reason: collision with root package name */
    private final List<String> f23028b = new ArrayList();

    private void a(int[] iArr, String str) {
        this.f23027a.add(iArr);
        this.f23028b.add(str);
    }
    ...
    private synchronized void b() {
        if (this.f23027a.isEmpty()) {
            ...
            a(new int[]{485}, "AM");
            a(new int[]{486}, "GE");
            a(new int[]{DownloaderService.STATUS_FILE_DELIVERED_INCORRECTLY}, "KZ");
            a(new int[]{DownloaderService.STATUS_CANNOT_RESUME}, "HK");
            a(new int[]{DownloaderService.STATUS_CANCELED, DownloaderService.STATUS_DEVICE_NOT_FOUND_ERROR}, "JP");
    ...
    public String c(String str) {
        ...
        for (int i12 = 0; i12 < size && parseInt >= (i11 = (iArr = this.f23027a.get(i12))[0]); i12++) {
            if (iArr.length != 1) {
                i11 = iArr[1];
            }
            if (parseInt <= i11) {
                return this.f23028b.get(i12);
            }
        }
        return null;
    }
