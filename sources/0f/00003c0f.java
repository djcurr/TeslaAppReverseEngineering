...
public final class FloatValue extends GeneratedMessageV3 implements FloatValueOrBuilder {
    ...
    public static FloatValue of(float f11) {
        return newBuilder().setValue(f11).build();
    }
    ...
    public int getSerializedSize() {
        ...
        int computeFloatSize = (Float.floatToRawIntBits(this.value_) != 0 ? 0 + CodedOutputStream.computeFloatSize(1, this.value_) : 0) + this.unknownFields.getSerializedSize();
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements FloatValueOrBuilder {
        ...
        */
        public com.google.protobuf.FloatValue.Builder mergeFrom(com.google.protobuf.CodedInputStream r3, com.google.protobuf.ExtensionRegistryLite r4) {
            /*
                r2 = this;
                r0 = 0
