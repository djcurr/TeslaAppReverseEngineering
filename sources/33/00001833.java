...
public class ReadableNativeMap extends NativeMap implements ReadableMap {
    ...
    public HashMap<String, Object> getLocalMap() {
        ...
        synchronized (this) {
            if (this.mKeys == null) {
                this.mKeys = (String[]) wf.a.c(importKeys());
                mJniCallCounter++;
            }
            if (this.mLocalMap == null) {
                Object[] objArr = (Object[]) wf.a.c(importValues());
                mJniCallCounter++;
                int length = this.mKeys.length;
                this.mLocalMap = new HashMap<>(length);
                for (int i11 = 0; i11 < length; i11++) {
                    this.mLocalMap.put(this.mKeys[i11], objArr[i11]);
                }
            }
        }
    ...
    private HashMap<String, ReadableType> getLocalTypeMap() {
        ...
        synchronized (this) {
            ...
            if (this.mLocalTypeMap == null) {
                Object[] objArr = (Object[]) wf.a.c(importTypes());
                mJniCallCounter++;
                int length = this.mKeys.length;
                this.mLocalTypeMap = new HashMap<>(length);
                for (int i11 = 0; i11 < length; i11++) {
                    this.mLocalTypeMap.put(this.mKeys[i11], (ReadableType) objArr[i11]);
                }
            }
        }
    ...
    private Object getValue(String str) {
        if (hasKey(str) && !isNull(str)) {
            return wf.a.c(getLocalMap().get(str));
        }
    ...
    public Iterator<Map.Entry<String, Object>> getEntryIterator() {
        ...
        final Object[] objArr = (Object[]) wf.a.c(importValues());
    ...
    public ReadableType getType(String str) {
        if (getLocalTypeMap().containsKey(str)) {
            return (ReadableType) wf.a.c(getLocalTypeMap().get(str));
        }
        throw new NoSuchKeyException(str);
    }
        ...
        for (String str : hashMap.keySet()) {
            switch (AnonymousClass3.$SwitchMap$com$facebook$react$bridge$ReadableType[getType(str).ordinal()]) {
                ...
                case 4:
                    break;
                case 5:
                    hashMap.put(str, ((ReadableNativeMap) wf.a.c(getMap(str))).toHashMap());
                    break;
                case 6:
                    hashMap.put(str, ((ReadableArray) wf.a.c(getArray(str))).toArrayList());
                    break;
                default:
    ...
    private <T> T getNullableValue(String str, Class<T> cls) {
        T t11 = (T) getNullableValue(str);
        checkInstance(str, t11, cls);
        return t11;
    }
