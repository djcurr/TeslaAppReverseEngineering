...
abstract class CameraCapturer implements CameraVideoCapturer {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void createSessionInternal(int i11) {
        this.uiThreadHandler.postDelayed(this.openCameraTimeoutRunnable, i11 + 10000);
    ...
    public void changeCaptureFormat(int i11, int i12, int i13) {
        Logging.d(TAG, "changeCaptureFormat: " + i11 + "x" + i12 + "@" + i13);
        synchronized (this.stateLock) {
            stopCapture();
    ...
    protected abstract void createCameraSession(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, Context context, SurfaceTextureHelper surfaceTextureHelper, String str, int i11, int i12, int i13);
    ...
    public void startCapture(int i11, int i12, int i13) {
        Logging.d(TAG, "startCapture: " + i11 + "x" + i12 + "@" + i13);
