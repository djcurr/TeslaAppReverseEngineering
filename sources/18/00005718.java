...
public final class USBankAccountFormFragment$VerifyWithMicrodepositsScreen$2 extends u implements p<i, Integer, b0> {
    ...
    public final void invoke(i iVar, int i11) {
        this.$tmp0_rcvr.VerifyWithMicrodepositsScreen(this.$screenState, iVar, this.$$changed | 1);
    }
}