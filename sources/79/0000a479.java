...
public class PolynomialGF2mSmallM {
    ...
    private void computeDegree() {
        ...
        while (true) {
            int i11 = this.degree;
            if (i11 < 0 || this.coefficients[i11] != 0) {
                return;
            }
            this.degree = i11 - 1;
        }
    ...
    public String toString() {
        ...
        for (int i11 = 0; i11 < this.coefficients.length; i11++) {
            str = str + this.field.elementToStr(this.coefficients[i11]) + "Y^" + i11 + Marker.ANY_NON_NULL_MARKER;
        }
        return str + ";";
    }
    ...
    private int[] multiply(int[] iArr, int[] iArr2) {
        ...
        if (length2 != length) {
            ...
            System.arraycopy(normalForm, length2, iArr5, 0, i11);
        ...
        System.arraycopy(normalForm, 0, iArr6, 0, i12);
        System.arraycopy(normalForm, i12, iArr8, 0, i13);
        System.arraycopy(normalForm2, 0, iArr7, 0, i12);
        System.arraycopy(normalForm2, i12, iArr9, 0, i13);
