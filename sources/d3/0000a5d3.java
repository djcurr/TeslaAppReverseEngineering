...
public class PeerConnection {
    ...
    public enum AdapterType {
        ...
        static AdapterType fromNativeIndex(int i11) {
    ...
    public enum IceConnectionState {
        ...
        static IceConnectionState fromNativeIndex(int i11) {
            return values()[i11];
        }
    }
    ...
    public enum IceGatheringState {
        ...
        static IceGatheringState fromNativeIndex(int i11) {
            return values()[i11];
        }
    }
    ...
    public enum PeerConnectionState {
        ...
        static PeerConnectionState fromNativeIndex(int i11) {
            return values()[i11];
        }
    }
    ...
    public enum SignalingState {
        ...
        static SignalingState fromNativeIndex(int i11) {
            return values()[i11];
        }
    }
    ...
    public boolean startRtcEventLog(int i11, int i12) {
        return nativeStartRtcEventLog(i11, i12);
    }
