...
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
    ...
    private static AsymmetricKeyInfoConverter getAsymmetricKeyInfoConverter(k kVar) {
    ...
    public static PrivateKey getPrivateKey(p pVar) {
        AsymmetricKeyInfoConverter asymmetricKeyInfoConverter = getAsymmetricKeyInfoConverter(pVar.i().e());
    ...
    public static PublicKey getPublicKey(m0 m0Var) {
        AsymmetricKeyInfoConverter asymmetricKeyInfoConverter = getAsymmetricKeyInfoConverter(m0Var.e().e());
        if (asymmetricKeyInfoConverter == null) {
            return null;
        }
    ...
    private void loadPQCKeys() {
        addKeyInfoConverter(e.f55682e, new c());
        addKeyInfoConverter(e.f55683f, new j70.c());
        addKeyInfoConverter(e.f55684g, new f());
        addKeyInfoConverter(a.f40491a, new f());
        addKeyInfoConverter(e.f55689l, new g());
        addKeyInfoConverter(a.f40492b, new g());
        addKeyInfoConverter(e.f55680c, new i70.f());
        addKeyInfoConverter(e.f55681d, new i70.e());
        addKeyInfoConverter(e.f55678a, new l70.c());
        addKeyInfoConverter(e.f55694q, new k70.c());
        addKeyInfoConverter(e.f55695r, new k70.c());
        addKeyInfoConverter(n.G2, new h70.c());
    }
    ...
    public AsymmetricKeyInfoConverter getKeyInfoConverter(k kVar) {
        return (AsymmetricKeyInfoConverter) keyInfoConverters.get(kVar);
    }
