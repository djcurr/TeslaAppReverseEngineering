...
final class FieldMaskTree {
    ...
    FieldMaskTree addFieldPath(String str) {
        ...
        for (String str2 : split) {
            if (!z11 && node != this.root && node.children.isEmpty()) {
                return this;
            }
    ...
    FieldMaskTree removeFieldPath(String str) {
        List<String> k11 = x.i(FIELD_PATH_SEPARATOR_REGEX).k(str);
        if (k11.isEmpty()) {
            return this;
        }
        removeFieldPath(this.root, k11, 0);
        return this;
    }
    ...
    private static boolean removeFieldPath(Node node, List<String> list, int i11) {
        ...
        if (node.children.containsKey(str)) {
            ...
            if (removeFieldPath(node.children.get(str), list, i11 + 1)) {
                node.children.remove(str);
            }
            return node.children.isEmpty();
        }
