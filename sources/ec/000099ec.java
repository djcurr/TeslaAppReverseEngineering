...
public class X509v2CRLBuilder {
    ...
    public X509v2CRLBuilder addCRLEntry(BigInteger bigInteger, Date date, int i11) {
        this.tbsGen.addCRLEntry(new ASN1Integer(bigInteger), new Time(date), i11);
        return this;
    }

    public X509v2CRLBuilder addExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z11, ASN1Encodable aSN1Encodable) {
    ...
    public X509v2CRLBuilder addCRLEntry(BigInteger bigInteger, Date date, int i11, Date date2) {
        this.tbsGen.addCRLEntry(new ASN1Integer(bigInteger), new Time(date), i11, new ASN1GeneralizedTime(date2));
        return this;
    }

    public X509v2CRLBuilder addExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z11, byte[] bArr) {
