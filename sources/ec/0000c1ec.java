...
public class g implements org.bouncycastle.crypto.m {
    ...
    public BigInteger[] generateSignature(byte[] bArr) {
        ...
        y b11 = this.f59152g.b();
        BigInteger e11 = b11.e();
        BigInteger c11 = ((d0) this.f59152g).c();
        n60.h a11 = a();
        while (true) {
            BigInteger e12 = r70.a.e(e11.bitLength(), this.f59153h);
    ...
    public void init(boolean z11, org.bouncycastle.crypto.i iVar) {
        ...
        if (!z11) {
            ...
            g1 g1Var = (g1) iVar;
            this.f59153h = g1Var.b();
            this.f59152g = (d0) g1Var.a();
            return;
        } else {
            this.f59153h = org.bouncycastle.crypto.k.b();
            b0Var = (d0) iVar;
        }
        this.f59152g = b0Var;
    }
    ...
    public boolean verifySignature(byte[] bArr, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger e11 = this.f59152g.b().e();
        ...
        n60.i A = n60.c.r(this.f59152g.b().b(), bigInteger2.multiply(k11).mod(e11), ((e0) this.f59152g).c(), e11.subtract(bigInteger).multiply(k11).mod(e11)).A();
        if (A.u()) {
            return false;
        }
