...
public class FusedLocationProviderClient extends GoogleApi<Api.ApiOptions.NoOptions> {
    ...
    public Task<Location> getCurrentLocation(int i11, final CancellationToken cancellationToken) {
    ...
    public Task<Void> setMockMode(final boolean z11) {
        return doWrite(TaskApiCall.builder().run(new RemoteCall() { // from class: com.google.android.gms.location.zzab
            ...
            public final void accept(Object obj, Object obj2) {
                com.google.android.gms.internal.location.zzbe zzbeVar = (com.google.android.gms.internal.location.zzbe) obj;
                zzbeVar.zzF(z11, new zzas(FusedLocationProviderClient.this, (TaskCompletionSource) obj2));
            }
    ...
    public Task<Void> removeLocationUpdates(LocationCallback locationCallback) {
        return doUnregisterEventListener(ListenerHolders.createListenerKey(locationCallback, LocationCallback.class.getSimpleName()), 2418).continueWith(new Executor() { // from class: com.google.android.gms.location.zzaj
