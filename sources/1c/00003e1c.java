...
public final class j {
    ...
    private static final int[] f17451e = {31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017};

    /* renamed from: f  reason: collision with root package name */
    private static final j[] f17452f = b();
    ...
    private j(int i11, int[] iArr, b... bVarArr) {
        a[] a11;
        this.f17453a = i11;
        this.f17454b = iArr;
        this.f17455c = bVarArr;
        int b11 = bVarArr[0].b();
        int i12 = 0;
    ...
    public uo.b a() {
        int e11 = e();
        uo.b bVar = new uo.b(e11);
        bVar.m(0, 0, 9, 9);
        int i11 = e11 - 8;
        bVar.m(i11, 0, 8, 9);
        bVar.m(0, i11, 9, 8);
        int length = this.f17454b.length;
        for (int i12 = 0; i12 < length; i12++) {
            int i13 = this.f17454b[i12] - 2;
            for (int i14 = 0; i14 < length; i14++) {
                if ((i12 != 0 || (i14 != 0 && i14 != length - 1)) && (i12 != length - 1 || i14 != 0)) {
                    bVar.m(this.f17454b[i14] - 2, i13, 5, 5);
                }
            }
        }
        int i15 = e11 - 17;
    ...
    public int e() {
        return (this.f17453a * 4) + 17;
    }

    public b f(f fVar) {
        return this.f17455c[fVar.ordinal()];
    }
    ...
    public String toString() {
        return String.valueOf(this.f17453a);
    }
}