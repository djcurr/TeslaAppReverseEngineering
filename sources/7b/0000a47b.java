...
public class PolynomialRingGF2m {
    ...
    private PolynomialGF2mSmallM f43879p;
    ...
    public PolynomialRingGF2m(GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM) {
        ...
        this.f43879p = polynomialGF2mSmallM;
    ...
    private void computeSquareRootMatrix() {
        int coefficient;
        int degree = this.f43879p.getDegree();
    ...
    private void computeSquaringMatrix() {
        ...
        while (i11 < degree) {
            ...
            iArr2[i14] = 1;
            this.sqMatrix[i11] = new PolynomialGF2mSmallM(this.field, iArr2).mod(this.f43879p);
            i11++;
        }
    }
