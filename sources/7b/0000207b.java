...
public final class zzby<FieldDescriptorType extends zzca<FieldDescriptorType>> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int zza(zzfl zzflVar, int i11, Object obj) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void zza(zzbn zzbnVar, zzfl zzflVar, int i11, Object obj) {
        if (zzflVar == zzfl.zzql) {
    ...
    */
    ...
    public final void zza(zzby<FieldDescriptorType> zzbyVar) {
        for (int i11 = 0; i11 < zzbyVar.zzgt.zzdr(); i11++) {
            zzc(zzbyVar.zzgt.zzak(i11));
        }
    ...
    public final int zzas() {
        ...
        for (int i12 = 0; i12 < this.zzgt.zzdr(); i12++) {
            ...
            i11 += zzb((zzca<?>) zzak.getKey(), zzak.getValue());
        }
        for (Map.Entry<FieldDescriptorType, Object> entry : this.zzgt.zzds()) {
            i11 += zzb((zzca<?>) entry.getKey(), entry.getValue());
        }
        return i11;
    }
    ...
    public final int zzat() {
        int i11 = 0;
        for (int i12 = 0; i12 < this.zzgt.zzdr(); i12++) {
            i11 += zzd((Map.Entry) this.zzgt.zzak(i12));
        }
        for (Map.Entry<FieldDescriptorType, Object> entry : this.zzgt.zzds()) {
            i11 += zzd((Map.Entry) entry);
        }
        return i11;
    }
