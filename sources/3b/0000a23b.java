...
public abstract class ECPoint {
    ...
    protected ECFieldElement f43708x;

    /* renamed from: y  reason: collision with root package name */
    protected ECFieldElement f43709y;

    /* renamed from: zs  reason: collision with root package name */
    protected ECFieldElement[] f43710zs;
    ...
    public static abstract class AbstractF2m extends ECPoint {
        ...
        protected boolean satisfiesCurveEquation() {
            ...
            if (coordinateSystem == 6) {
                ECFieldElement eCFieldElement2 = this.f43710zs[0];
                boolean isOne = eCFieldElement2.isOne();
                if (eCFieldElement.isZero()) {
                    ECFieldElement square = this.f43709y.square();
                    if (!isOne) {
                        b11 = b11.multiply(eCFieldElement2.square());
                    }
                    return square.equals(b11);
                }
                ECFieldElement eCFieldElement3 = this.f43709y;
                ECFieldElement square2 = eCFieldElement.square();
                if (isOne) {
                    multiplyPlusProduct = eCFieldElement3.square().add(eCFieldElement3).add(a11);
                    ...
                    multiplyPlusProduct = eCFieldElement3.add(eCFieldElement2).multiplyPlusProduct(eCFieldElement3, a11, square3);
            ...
            if (coordinateSystem != 0) {
                if (coordinateSystem == 1) {
                    ...
                    if (!eCFieldElement5.isOne()) {
                        ...
                        a11 = a11.multiply(eCFieldElement5);
            ...
            return multiply.equals(eCFieldElement.add(a11).multiply(eCFieldElement.square()).add(b11));
        }
        ...
        public AbstractF2m tau() {
            ...
            if (coordinateSystem != 0) {
                ...
                return (AbstractF2m) curve.createRawPoint(eCFieldElement.square(), this.f43709y.square(), new ECFieldElement[]{this.f43710zs[0].square()}, this.withCompression);
            }
            return (AbstractF2m) curve.createRawPoint(eCFieldElement.square(), this.f43709y.square(), this.withCompression);
        }
        ...
        public AbstractF2m tauPow(int i11) {
            ...
            if (coordinateSystem != 0) {
                ...
                return (AbstractF2m) curve.createRawPoint(eCFieldElement.squarePow(i11), this.f43709y.squarePow(i11), new ECFieldElement[]{this.f43710zs[0].squarePow(i11)}, this.withCompression);
            }
            return (AbstractF2m) curve.createRawPoint(eCFieldElement.squarePow(i11), this.f43709y.squarePow(i11), this.withCompression);
        }
        ...
        protected boolean satisfiesCurveEquation() {
            ...
            if (curveCoordinateSystem != 0) {
                if (curveCoordinateSystem == 1) {
                    ...
                    ECFieldElement eCFieldElement4 = this.f43710zs[0];
    ...
    public static class F2m extends AbstractF2m {
        ...
        public ECPoint add(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement8 = eCPoint.f43708x;
            if (coordinateSystem == 0) {
                ECFieldElement eCFieldElement9 = this.f43709y;
                ECFieldElement eCFieldElement10 = eCPoint.f43709y;
                ...
                ECFieldElement eCFieldElement11 = this.f43709y;
                ECFieldElement eCFieldElement12 = this.f43710zs[0];
                ECFieldElement eCFieldElement13 = eCPoint.f43709y;
                ECFieldElement eCFieldElement14 = eCPoint.f43710zs[0];
                ...
                ECFieldElement eCFieldElement15 = this.f43709y;
                ECFieldElement eCFieldElement16 = this.f43710zs[0];
                ECFieldElement eCFieldElement17 = eCPoint.f43709y;
                ECFieldElement eCFieldElement18 = eCPoint.f43710zs[0];
        ...
        public ECPoint negate() {
            ...
            if (curveCoordinateSystem != 0) {
                if (curveCoordinateSystem == 1) {
                    return new F2m(this.curve, eCFieldElement, this.f43709y.add(eCFieldElement), new ECFieldElement[]{this.f43710zs[0]}, this.withCompression);
                    ...
                    return new F2m(this.curve, eCFieldElement, this.f43709y.addOne(), this.withCompression);
                }
            }
            return new F2m(this.curve, eCFieldElement, this.f43709y.add(eCFieldElement), this.withCompression);
        }
        ...
        public ECPoint twice() {
            ...
            int coordinateSystem = curve.getCoordinateSystem();
            if (coordinateSystem == 0) {
                ECFieldElement add2 = this.f43709y.divide(eCFieldElement).add(eCFieldElement);
                ...
                if (b11.bitLength() < (curve.getFieldSize() >> 1)) {
                    ...
                    if (b11.isOne()) {
                        ...
                        squarePlusProduct = multiply3.squarePlusProduct(b11, square3.square());
                    }
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = eCPoint.f43708x;
            ECFieldElement eCFieldElement3 = eCPoint.f43710zs[0];
            if (!eCFieldElement2.isZero() && eCFieldElement3.isOne()) {
                ECFieldElement eCFieldElement4 = this.f43709y;
                ECFieldElement eCFieldElement5 = this.f43710zs[0];
                ECFieldElement eCFieldElement6 = eCPoint.f43709y;
                ECFieldElement square = eCFieldElement.square();
        ...
        public F2m(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, boolean z11) {
            ...
            if ((eCFieldElement == null) == (eCFieldElement2 == null)) {
                if (eCFieldElement != null) {
                    ECFieldElement.F2m.checkFieldElements(this.f43708x, this.f43709y);
                    if (eCCurve != null) {
                        ECFieldElement.F2m.checkFieldElements(this.f43708x, this.curve.getA());
                    }
                }
    ...
    public static class Fp extends AbstractFp {
        ...
        */
        ...
        public ECFieldElement getZCoord(int i11) {
            if (i11 == 1 && 4 == getCurveCoordinateSystem()) {
        ...
        public ECPoint negate() {
            ...
            if (curve.getCoordinateSystem() != 0) {
                return new Fp(curve, this.f43708x, this.f43709y.negate(), this.f43710zs, this.withCompression);
            }
            return new Fp(curve, this.f43708x, this.f43709y.negate(), this.withCompression);
        }
        ...
        public ECPoint threeTimes() {
            ...
            ECFieldElement eCFieldElement = this.f43709y;
            if (eCFieldElement.isZero()) {
                return this;
            }
            ECCurve curve = getCurve();
            ...
            ECFieldElement eCFieldElement2 = this.f43708x;
            ...
            if (i11 >= 0) {
                ...
                if (!fromBigInteger.isOne() && coordinateSystem != 0) {
                    if (coordinateSystem == 1) {
                        ...
                        a11 = calculateJacobianModifiedW(fromBigInteger, square);
                    } else if (coordinateSystem == 2) {
                        a11 = calculateJacobianModifiedW(fromBigInteger, null);
                ...
                int i12 = 0;
                ECFieldElement eCFieldElement3 = a11;
        ...
        public ECPoint twice() {
            ...
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement eCFieldElement3 = this.f43708x;
            if (coordinateSystem == 0) {
                ...
                ECFieldElement a11 = curve.getA();
                if (!a11.isZero() && !isOne) {
                    a11 = a11.multiply(eCFieldElement4.square());
                }
                ECFieldElement add = a11.add(three(eCFieldElement3.square()));
                ...
                if (negate.toBigInteger().equals(BigInteger.valueOf(3L))) {
                    ...
                    if (isOne2) {
                        ...
                        if (negate.bitLength() < a12.bitLength()) {
                            ...
                            eCFieldElement = three.add(square5.multiply(a12));
                        }
                    }
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = this.f43708x;
            ECFieldElement eCFieldElement3 = eCPoint.f43708x;
            ECFieldElement eCFieldElement4 = eCPoint.f43709y;
    ...
    public boolean isInfinity() {
        if (this.f43708x != null && this.f43709y != null) {
            ECFieldElement[] eCFieldElementArr = this.f43710zs;
    ...
    public boolean isNormalized() {
        int curveCoordinateSystem = getCurveCoordinateSystem();
        return curveCoordinateSystem == 0 || curveCoordinateSystem == 5 || isInfinity() || this.f43710zs[0].isOne();
    }
    ...
    public String toString() {
        ...
        for (int i11 = 0; i11 < this.f43710zs.length; i11++) {
            stringBuffer.append(CoreConstants.COMMA_CHAR);
            stringBuffer.append(this.f43710zs[i11]);
        }
    ...
    protected ECPoint(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
        ...
        this.curve = eCCurve;
        this.f43708x = eCFieldElement;
        this.f43709y = eCFieldElement2;
        this.f43710zs = eCFieldElementArr;
    }
