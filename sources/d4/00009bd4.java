...
public final class CAST6Engine extends CAST5Engine {
    ...
    protected final void CAST_Decipher(int i11, int i12, int i13, int i14, int[] iArr) {
        int i15;
        int i16 = 0;
        while (true) {
            if (i16 >= 6) {
    ...
    protected final void CAST_Encipher(int i11, int i12, int i13, int i14, int[] iArr) {
        int i15;
        int i16 = 0;
        while (true) {
            if (i16 >= 6) {
    ...
    protected int decryptBlock(byte[] bArr, int i11, byte[] bArr2, int i12) {
        int[] iArr = new int[4];
    ...
    @Override // org.spongycastle.crypto.engines.CAST5Engine
    protected int encryptBlock(byte[] bArr, int i11, byte[] bArr2, int i12) {
        int[] iArr = new int[4];
    ...
    protected void setKey(byte[] bArr) {
        ...
        for (int i17 = 0; i17 < 12; i17++) {
            ...
            int i31 = i28 + 2;
            iArr11[4] = iArr11[4] ^ F3(iArr11[5], this._Tm[i31], this._Tr[i31]);
            int[] iArr12 = this._workingKey;
            int i32 = i28 + 3;
            iArr12[3] = F1(iArr12[4], this._Tm[i32], this._Tr[i32]) ^ iArr12[3];
            int[] iArr13 = this._workingKey;
            int i33 = i28 + 4;
            iArr13[2] = F2(iArr13[3], this._Tm[i33], this._Tr[i33]) ^ iArr13[2];
            int[] iArr14 = this._workingKey;
            int i34 = i28 + 5;
            iArr14[1] = F3(iArr14[2], this._Tm[i34], this._Tr[i34]) ^ iArr14[1];
            int[] iArr15 = this._workingKey;
            int i35 = i28 + 6;
            iArr15[0] = iArr15[0] ^ F1(iArr15[1], this._Tm[i35], this._Tr[i35]);
            int[] iArr16 = this._workingKey;
            int i36 = i28 + 7;
            iArr16[7] = F2(iArr16[0], this._Tm[i36], this._Tr[i36]) ^ iArr16[7];
            int[] iArr17 = this._Kr;
            int i37 = i17 * 4;
