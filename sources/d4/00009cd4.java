...
public class DualECSP800DRBG implements SP80090DRBG {
    ...
    static {
        ...
        ECCurve.Fp fp3 = (ECCurve.Fp) NISTNamedCurves.getByName("P-384").getCurve();
        ECCurve.Fp fp4 = (ECCurve.Fp) NISTNamedCurves.getByName("P-521").getCurve();
        DualECPoints[] dualECPointsArr = {new DualECPoints(128, fp2.createPoint(bigInteger, bigInteger2), fp2.createPoint(bigInteger3, bigInteger4), 1), new DualECPoints(192, fp3.createPoint(bigInteger5, bigInteger6), fp3.createPoint(bigInteger7, bigInteger8), 1), new DualECPoints(256, fp4.createPoint(bigInteger9, bigInteger10), fp4.createPoint(bigInteger11, bigInteger12), 1)};
    }
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z11) {
        ...
        if (!Utils.isTooLarge(bArr2, 512)) {
            ...
            if (i11 < bArr.length) {
                ...
                if (length5 > i14) {
                    System.arraycopy(byteArray2, byteArray2.length - i14, bArr, i11, length4);
                } else {
                    System.arraycopy(byteArray2, 0, bArr, i11 + (i14 - byteArray2.length), length4);
                }
                this._reseedCounter++;
            }
