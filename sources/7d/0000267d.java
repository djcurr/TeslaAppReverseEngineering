...
public enum zzlc implements zzdh {
    UNKNOWN_EVENT(0),
    ...
    CLOUD_WEB_SEARCH_CREATE(d.SDK_ASSET_ILLUSTRATION_EMPLOYER_NOT_FOUND_VALUE),
    ...
    OPTIONAL_MODULE_LANGUAGE_ID_INIT(DownloaderService.STATUS_FORBIDDEN),
    ...
    CODE_SCANNER_SCAN_API(DownloaderService.STATUS_UNKNOWN_ERROR),
    CODE_SCANNER_OPTIONAL_MODULE(DownloaderService.STATUS_FILE_ERROR),
