...
public class zzahe extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i11 = 0;
        if (size >= 0) {
            int compareTo = comparable.compareTo(((zzagy) this.zzb.get(size)).zza());
            if (compareTo > 0) {
                return -(size + 2);
            }
            if (compareTo == 0) {
        ...
        while (i11 <= size) {
            int i12 = (i11 + size) / 2;
            int compareTo2 = comparable.compareTo(((zzagy) this.zzb.get(i12)).zza());
            if (compareTo2 < 0) {
                size = i12 - 1;
    ...
    public final Object get(Object obj) {
        ...
        if (zzk >= 0) {
            return ((zzagy) this.zzb.get(zzk)).getValue();
        }
    ...
    public final int hashCode() {
        ...
        for (int i12 = 0; i12 < zzb; i12++) {
            i11 += ((zzagy) this.zzb.get(i12)).hashCode();
        }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int zzk = zzk(comparable);
        if (zzk >= 0) {
            return ((zzagy) this.zzb.get(zzk)).setValue(obj);
        }
        zzn();
