...
public class TlsExtensionsUtils {
    ...
    public static void addMaxFragmentLengthExtension(Hashtable hashtable, short s11) {
        hashtable.put(EXT_max_fragment_length, createMaxFragmentLengthExtension(s11));
    }

    public static void addPaddingExtension(Hashtable hashtable, int i11) {
        hashtable.put(EXT_padding, createPaddingExtension(i11));
    }
    ...
    public static byte[] createMaxFragmentLengthExtension(short s11) {
        TlsUtils.checkUint8(s11);
        byte[] bArr = new byte[1];
        TlsUtils.writeUint8(s11, bArr, 0);
        return bArr;
    }

    public static byte[] createPaddingExtension(int i11) {
