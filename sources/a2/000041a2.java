...
public final class ButtonWithTable$ButtonWithTablePane extends GeneratedMessageLite<ButtonWithTable$ButtonWithTablePane, a> implements MessageLiteOrBuilder {
    private static final ButtonWithTable$ButtonWithTablePane DEFAULT_INSTANCE;
    private static volatile Parser<ButtonWithTable$ButtonWithTablePane> PARSER;
    ...
    public static final class Actions extends GeneratedMessageLite<Actions, b> implements MessageLiteOrBuilder {
        ...
        public static final class ButtonTapAction extends GeneratedMessageLite<ButtonTapAction, a> implements MessageLiteOrBuilder {
            ...
            public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
                switch (g0.f18612a[methodToInvoke.ordinal()]) {
                    case 1:
    ...
    public static final class Rendering extends GeneratedMessageLite<Rendering, a> implements MessageLiteOrBuilder {
        ...
        public static final class TableRow extends GeneratedMessageLite<TableRow, a> implements b {
            ...
            public void setStyle(h0 h0Var) {
                this.style_ = h0Var.getNumber();
            }

            /* JADX INFO: Access modifiers changed from: private */
            public void setStyleValue(int i11) {
                this.style_ = i11;
            }
            ...
            public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
                switch (g0.f18612a[methodToInvoke.ordinal()]) {
                    ...
                    case 2:
                        return new a();
                    case 3:
                        return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0003\u0000\u0000\u0001\u0003\u0003\u0000\u0000\u0000\u0001\t\u0002\t\u0003\f", new Object[]{"label_", "value_", "style_"});
                    case 4:
                        return DEFAULT_INSTANCE;
                    case 5:
            ...
            public h0 getStyle() {
                h0 forNumber = h0.forNumber(this.style_);
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (g0.f18612a[methodToInvoke.ordinal()]) {
                ...
                case 2:
                    return new a();
                case 3:
                    return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u000b\u0000\u0000\u0001\u000b\u000b\u0000\u0001\u0000\u0001\t\u0002\t\u0003\t\u0004\u001b\u0005\t\u0006\t\u0007\t\b\t\t\t\n\t\u000b\t", new Object[]{"headerAsset_", "header_", "tableTitle_", "tableRows_", TableRow.class, "button_", "secondaryButton_", "events_", "institution_", "content_", "buttonDisclaimerText_", "paneHeader_"});
                case 4:
                    return DEFAULT_INSTANCE;
                case 5:
    ...
    /* loaded from: classes2.dex */
    public static final class a extends GeneratedMessageLite.Builder<ButtonWithTable$ButtonWithTablePane, a> implements MessageLiteOrBuilder {
        public a() {
            super(ButtonWithTable$ButtonWithTablePane.DEFAULT_INSTANCE);
        }
    }

    static {
        ButtonWithTable$ButtonWithTablePane buttonWithTable$ButtonWithTablePane = new ButtonWithTable$ButtonWithTablePane();
        DEFAULT_INSTANCE = buttonWithTable$ButtonWithTablePane;
        GeneratedMessageLite.registerDefaultInstance(ButtonWithTable$ButtonWithTablePane.class, buttonWithTable$ButtonWithTablePane);
    }

    private ButtonWithTable$ButtonWithTablePane() {
    }

    public static ButtonWithTable$ButtonWithTablePane getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }
    ...
    public static ButtonWithTable$ButtonWithTablePane parseDelimitedFrom(InputStream inputStream) {
        return (ButtonWithTable$ButtonWithTablePane) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static ButtonWithTable$ButtonWithTablePane parseFrom(ByteBuffer byteBuffer) {
        return (ButtonWithTable$ButtonWithTablePane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }

    public static Parser<ButtonWithTable$ButtonWithTablePane> parser() {
        return DEFAULT_INSTANCE.getParserForType();
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (g0.f18612a[methodToInvoke.ordinal()]) {
            case 1:
                return new ButtonWithTable$ButtonWithTablePane();
            case 2:
                return new a();
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0000", null);
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                Parser<ButtonWithTable$ButtonWithTablePane> parser = PARSER;
                if (parser == null) {
                    synchronized (ButtonWithTable$ButtonWithTablePane.class) {
                        parser = PARSER;
                        if (parser == null) {
                            parser = new GeneratedMessageLite.DefaultInstanceBasedParser<>(DEFAULT_INSTANCE);
                            PARSER = parser;
    ...
    public static a newBuilder(ButtonWithTable$ButtonWithTablePane buttonWithTable$ButtonWithTablePane) {
        return DEFAULT_INSTANCE.createBuilder(buttonWithTable$ButtonWithTablePane);
    }

    public static ButtonWithTable$ButtonWithTablePane parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (ButtonWithTable$ButtonWithTablePane) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }

    public static ButtonWithTable$ButtonWithTablePane parseFrom(ByteBuffer byteBuffer, ExtensionRegistryLite extensionRegistryLite) {
        return (ButtonWithTable$ButtonWithTablePane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, extensionRegistryLite);
    }

    public static ButtonWithTable$ButtonWithTablePane parseFrom(ByteString byteString) {
        return (ButtonWithTable$ButtonWithTablePane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString);
    }

    public static ButtonWithTable$ButtonWithTablePane parseFrom(ByteString byteString, ExtensionRegistryLite extensionRegistryLite) {
        return (ButtonWithTable$ButtonWithTablePane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, extensionRegistryLite);
    }

    public static ButtonWithTable$ButtonWithTablePane parseFrom(byte[] bArr) {
        return (ButtonWithTable$ButtonWithTablePane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static ButtonWithTable$ButtonWithTablePane parseFrom(byte[] bArr, ExtensionRegistryLite extensionRegistryLite) {
        return (ButtonWithTable$ButtonWithTablePane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, extensionRegistryLite);
    }

    public static ButtonWithTable$ButtonWithTablePane parseFrom(InputStream inputStream) {
        return (ButtonWithTable$ButtonWithTablePane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static ButtonWithTable$ButtonWithTablePane parseFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (ButtonWithTable$ButtonWithTablePane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }

    public static ButtonWithTable$ButtonWithTablePane parseFrom(CodedInputStream codedInputStream) {
        return (ButtonWithTable$ButtonWithTablePane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, codedInputStream);
    }

    public static ButtonWithTable$ButtonWithTablePane parseFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (ButtonWithTable$ButtonWithTablePane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, codedInputStream, extensionRegistryLite);
    }
}