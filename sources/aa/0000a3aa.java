...
public class McEliecePrivateKey extends ASN1Object {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f43756n));
        aSN1EncodableVector.add(new ASN1Integer(this.f43755k));
    ...
    private McEliecePrivateKey(ASN1Sequence aSN1Sequence) {
        this.f43756n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).getValue().intValue();
        this.f43755k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).getValue().intValue();
