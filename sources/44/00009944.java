...
public class DSTU4145NamedCurves {
    ...
    static {
        ...
        while (true) {
            ...
            eCDomainParametersArr[i12] = new ECDomainParameters(f2mArr[i12], eCPointArr[i12], bigIntegerArr[i12], bigIntegerArr2[i12]);
            i12++;
        }
        while (true) {
