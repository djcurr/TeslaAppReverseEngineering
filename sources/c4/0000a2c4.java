...
public class DiscoverEndomorphisms {
    ...
    private static void printGLVTypeBParameters(X9ECParameters x9ECParameters) {
        ...
        BigInteger[] solveQuadraticEquation = solveQuadraticEquation(n11, bigInteger, bigInteger);
    ...
    private static void printGLVTypeBParameters(X9ECParameters x9ECParameters, BigInteger bigInteger, ECFieldElement[] eCFieldElementArr) {
        ...
        if (normalize.getYCoord().equals(normalize2.getYCoord())) {
            ...
            BigInteger n11 = x9ECParameters.getN();
            BigInteger[] extEuclidGLV = extEuclidGLV(n11, bigInteger);
            ...
            if (!isVectorBoundedBySqrt(chooseShortest, n11) && areRelativelyPrime(bigIntegerArr[0], bigIntegerArr[1])) {
                BigInteger bigInteger2 = bigIntegerArr[0];
                BigInteger bigInteger3 = bigIntegerArr[1];
                BigInteger divide = bigInteger2.add(bigInteger3.multiply(bigInteger)).divide(n11);
                ...
                if (extEuclidBezout != null) {
                    ...
                    if (subtract.equals(bigInteger6)) {
                        BigInteger subtract2 = bigInteger5.multiply(n11).subtract(bigInteger4.multiply(bigInteger));
                        BigInteger negate = bigInteger4.negate();
                        BigInteger negate2 = subtract2.negate();
                        BigInteger add = isqrt(n11.subtract(bigInteger6)).add(bigInteger6);
            ...
            int bitLength = (n11.bitLength() + 16) - (n11.bitLength() & 7);
