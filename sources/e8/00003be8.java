...
final class ExtensionSchemaFull extends ExtensionSchema<Descriptors.FieldDescriptor> {
    ...
    public static final /* synthetic */ int f17410a = 0;
    ...
    public Object findExtensionByNumber(ExtensionRegistryLite extensionRegistryLite, MessageLite messageLite, int i11) {
        return ((ExtensionRegistry) extensionRegistryLite).findExtensionByNumber(((Message) messageLite).getDescriptorForType(), i11);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.google.protobuf.ExtensionSchema
    public <UT, UB> UB parseExtension(Reader reader, Object obj, ExtensionRegistryLite extensionRegistryLite, FieldSet<Descriptors.FieldDescriptor> fieldSet, UB ub2, UnknownFieldSchema<UT, UB> unknownFieldSchema) {
        Object field;
        ArrayList arrayList;
        ...
        if (extensionInfo.descriptor.isRepeated() && extensionInfo.descriptor.isPacked()) {
                ...
                case 14:
                    ...
                    for (Integer num : arrayList3) {
                        ...
                        if (findValueByNumber != null) {
                            ...
                            ub2 = (UB) SchemaUtil.storeUnknownEnum(number, intValue, ub2, unknownFieldSchema);
                        }
                    }
                    break;
                default:
            ...
            if (extensionInfo.descriptor.getLiteType() == WireFormat.FieldType.ENUM) {
                ...
                if (obj2 == null) {
                    return (UB) SchemaUtil.storeUnknownEnum(number, readInt32, ub2, unknownFieldSchema);
                }
            } else {
                switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[extensionInfo.descriptor.getLiteType().ordinal()]) {
                    case 1:
            ...
            if (extensionInfo.descriptor.isRepeated()) {
                ...
                int i11 = AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[extensionInfo.descriptor.getLiteType().ordinal()];
                if ((i11 == 17 || i11 == 18) && (field = fieldSet.getField(extensionInfo.descriptor)) != null) {
