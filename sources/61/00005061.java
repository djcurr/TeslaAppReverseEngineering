...
public final class C1422VerificationViewModel_Factory implements e<VerificationViewModel> {
    ...
    public C1422VerificationViewModel_Factory(Provider<LinkAccountManager> provider, Provider<Navigator> provider2, Provider<Logger> provider3, Provider<LinkAccount> provider4) {
    ...
    public static C1422VerificationViewModel_Factory create(Provider<LinkAccountManager> provider, Provider<Navigator> provider2, Provider<Logger> provider3, Provider<LinkAccount> provider4) {
        return new C1422VerificationViewModel_Factory(provider, provider2, provider3, provider4);
    }
