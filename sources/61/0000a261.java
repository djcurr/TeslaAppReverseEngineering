...
public class SecP160K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160K1Point(this.curve, this.f43708x, this.f43709y.negate(), this.f43710zs, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        int[] create = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement.f43721x, create);
        int[] create2 = Nat160.create();
        SecP160R2Field.square(create, create2);
        int[] create3 = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement2.f43721x, create3);
        SecP160R2Field.reduce32(Nat160.addBothTo(create3, create3, create3), create3);
        SecP160R2Field.multiply(create, secP160R2FieldElement2.f43721x, create);
        ...
        SecP160R2Field.square(create3, secP160R2FieldElement4.f43721x);
        int[] iArr = secP160R2FieldElement4.f43721x;
        ...
        SecP160R2Field.subtract(create, secP160R2FieldElement4.f43721x, secP160R2FieldElement5.f43721x);
        int[] iArr3 = secP160R2FieldElement5.f43721x;
        ...
        if (!secP160R2FieldElement3.isOne()) {
            int[] iArr5 = secP160R2FieldElement6.f43721x;
            SecP160R2Field.multiply(iArr5, secP160R2FieldElement3.f43721x, iArr5);
        }
    ...
    public SecP160K1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, boolean z11) {
    ...
    public SecP160K1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr, boolean z11) {
