...
public class i1 extends e.b {
    ...
    private static final n60.f[] f47870k = {new h1(n60.d.f40585b)};

    /* renamed from: j  reason: collision with root package name */
    protected j1 f47871j;

    /* loaded from: classes5.dex */
    class a extends n60.a {

        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ int f47872a;
        ...
        private n60.i d(long[] jArr, long[] jArr2) {
            return i1.this.i(new h1(jArr), new h1(jArr2), i1.f47870k);
        }
        ...
        public n60.i b(int i11) {
            ...
            long[] i13 = v60.f.i();
            int i14 = 0;
            for (int i15 = 0; i15 < this.f47872a; i15++) {
                long j11 = ((i15 ^ i11) - 1) >> 31;
                for (int i16 = 0; i16 < 3; i16++) {
                    long j12 = i12[i16];
                    long[] jArr = this.f47873b;
    ...
    public i1() {
        ...
        this.f47871j = new j1(this, null, null);
        n60.f m11 = m(BigInteger.valueOf(1L));
        this.f40591b = m11;
        this.f40592c = m11;
        this.f40593d = new BigInteger(1, org.bouncycastle.util.encoders.b.b("04000000000000000000020108A2E0CC0D99F8A5EF"));
