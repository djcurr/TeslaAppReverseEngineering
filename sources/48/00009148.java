...
public class DH {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.addAlgorithm("KeyAgreement", n.f55530d3, "org.bouncycastle.jcajce.provider.asymmetric.dh.KeyAgreementSpi$DHwithRFC2631KDF");
            configurableProvider.addAlgorithm("KeyAgreement", n.f55532e3, "org.bouncycastle.jcajce.provider.asymmetric.dh.KeyAgreementSpi$DHwithRFC2631KDF");
            ...
            registerOid(configurableProvider, n.G1, "DH", new KeyFactorySpi());
            registerOid(configurableProvider, o.U0, "DH", new KeyFactorySpi());
        }
    }
