...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u0004\u001a\u00020\u0003¢\u0006\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, d2 = {"Lcom/withpersona/sdk/inquiry/governmentid/network/CreateVerificationRequest_DataJsonAdapter;", "Lcom/squareup/moshi/f;", "Lcom/withpersona/sdk/inquiry/governmentid/network/CreateVerificationRequest$Data;", "Lcom/squareup/moshi/p;", "moshi", "<init>", "(Lcom/squareup/moshi/p;)V", "government-id_release"}, k = 1, mv = {1, 5, 1})
/* loaded from: classes6.dex */
public final class CreateVerificationRequest_DataJsonAdapter extends f<CreateVerificationRequest.Data> {

    /* renamed from: a  reason: collision with root package name */
    private final h.b f22526a;

    /* renamed from: b  reason: collision with root package name */
    private final f<CreateVerificationRequest.Attributes> f22527b;

    /* renamed from: c  reason: collision with root package name */
    private volatile Constructor<CreateVerificationRequest.Data> f22528c;
    ...
    public CreateVerificationRequest.Data b(h reader) {
        ...
        while (reader.p()) {
            int G0 = reader.G0(this.f22526a);
            if (G0 == -1) {
                reader.Q0();
                reader.R0();
            } else if (G0 == 0) {
                attributes = this.f22527b.b(reader);
                if (attributes == null) {
        ...
        reader.l();
        if (i11 == -2) {
            Objects.requireNonNull(attributes, "null cannot be cast to non-null type com.withpersona.sdk.inquiry.governmentid.network.CreateVerificationRequest.Attributes");
            return new CreateVerificationRequest.Data(attributes);
        }
        Constructor<CreateVerificationRequest.Data> constructor = this.f22528c;
        if (constructor == null) {
            constructor = CreateVerificationRequest.Data.class.getDeclaredConstructor(CreateVerificationRequest.Attributes.class, Integer.TYPE, kr.b.f35691c);
            this.f22528c = constructor;
