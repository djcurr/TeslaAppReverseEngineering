...
public final class TnepresEngine extends SerpentEngineBase {
    ...
    protected void decryptBlock(byte[] bArr, int i11, byte[] bArr2, int i12) {
        this.X3 = this.wKey[131] ^ Pack.bigEndianToInt(bArr, i11);
        this.X2 = this.wKey[130] ^ Pack.bigEndianToInt(bArr, i11 + 4);
        this.X1 = this.wKey[129] ^ Pack.bigEndianToInt(bArr, i11 + 8);
        int bigEndianToInt = Pack.bigEndianToInt(bArr, i11 + 12) ^ this.wKey[128];
        ...
        inverseLT();
        ib0(this.X0, this.X1, this.X2, this.X3);
        Pack.intToBigEndian(this.X3 ^ this.wKey[3], bArr2, i12);
        Pack.intToBigEndian(this.X2 ^ this.wKey[2], bArr2, i12 + 4);
        Pack.intToBigEndian(this.X1 ^ this.wKey[1], bArr2, i12 + 8);
        Pack.intToBigEndian(this.X0 ^ this.wKey[0], bArr2, i12 + 12);
    }

    @Override // org.spongycastle.crypto.engines.SerpentEngineBase
    protected void encryptBlock(byte[] bArr, int i11, byte[] bArr2, int i12) {
        this.X3 = Pack.bigEndianToInt(bArr, i11);
        this.X2 = Pack.bigEndianToInt(bArr, i11 + 4);
        this.X1 = Pack.bigEndianToInt(bArr, i11 + 8);
        int bigEndianToInt = Pack.bigEndianToInt(bArr, i11 + 12);
        this.X0 = bigEndianToInt;
        int[] iArr = this.wKey;
        ...
        Pack.intToBigEndian(this.wKey[131] ^ this.X3, bArr2, i12);
        Pack.intToBigEndian(this.wKey[130] ^ this.X2, bArr2, i12 + 4);
        Pack.intToBigEndian(this.wKey[129] ^ this.X1, bArr2, i12 + 8);
        Pack.intToBigEndian(this.wKey[128] ^ this.X0, bArr2, i12 + 12);
    }
