...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u0004\u001a\u00020\u0003¢\u0006\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, d2 = {"Lcom/withpersona/sdk/inquiry/phone/network/CreateVerificationRequestJsonAdapter;", "Lcom/squareup/moshi/f;", "Lcom/withpersona/sdk/inquiry/phone/network/CreateVerificationRequest;", "Lcom/squareup/moshi/p;", "moshi", "<init>", "(Lcom/squareup/moshi/p;)V", "phone_release"}, k = 1, mv = {1, 5, 1})
/* loaded from: classes6.dex */
public final class CreateVerificationRequestJsonAdapter extends f<CreateVerificationRequest> {

    /* renamed from: a  reason: collision with root package name */
    private final h.b f22793a;

    /* renamed from: b  reason: collision with root package name */
    private final f<CreateVerificationRequest.Data> f22794b;

    /* renamed from: c  reason: collision with root package name */
    private volatile Constructor<CreateVerificationRequest> f22795c;
    ...
    public CreateVerificationRequest b(h reader) {
        ...
        while (reader.p()) {
            int G0 = reader.G0(this.f22793a);
            if (G0 == -1) {
                reader.Q0();
                reader.R0();
            } else if (G0 == 0) {
                data = this.f22794b.b(reader);
                if (data == null) {
        ...
        reader.l();
        if (i11 == -2) {
            Objects.requireNonNull(data, "null cannot be cast to non-null type com.withpersona.sdk.inquiry.phone.network.CreateVerificationRequest.Data");
            return new CreateVerificationRequest(data);
        }
        Constructor<CreateVerificationRequest> constructor = this.f22795c;
        if (constructor == null) {
    ...
    public void j(m writer, CreateVerificationRequest createVerificationRequest) {
        ...
        this.f22794b.j(writer, createVerificationRequest.a());
        writer.C();
    }
