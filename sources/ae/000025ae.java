...
public final class zzdl implements d {
    ...
    static {
        ...
        zzd = new c() { // from class: com.google.android.gms.internal.mlkit_vision_barcode.zzdk
            @Override // lm.c
            public final void encode(Object obj, Object obj2) {
                zzdl.zzg((Map.Entry) obj, (d) obj2);
            }
        };
    }

    public zzdl(OutputStream outputStream, Map map, Map map2, c cVar) {
    ...
    private static int zzh(b bVar) {
        zzdj zzdjVar = (zzdj) bVar.c(zzdj.class);
        if (zzdjVar != null) {
            return zzdjVar.zza();
        }
    ...
    private static zzdj zzj(b bVar) {
        zzdj zzdjVar = (zzdj) bVar.c(zzdj.class);
        if (zzdjVar != null) {
            return zzdjVar;
        }
    ...
    private final zzdl zzk(c cVar, b bVar, Object obj, boolean z11) {
    ...
    private final zzdl zzl(e eVar, b bVar, Object obj, boolean z11) {
    ...
    public final zzdl zzd(b bVar, int i11, boolean z11) {
        if (z11 && i11 == 0) {
            return this;
        }
        zzdj zzj = zzj(bVar);
    ...
    public final zzdl zze(b bVar, long j11, boolean z11) {
        if (z11 && j11 == 0) {
            return this;
        }
        zzdj zzj = zzj(bVar);
    ...
    public final zzdl zzf(Object obj) {
        if (obj == null) {
            return this;
        }
        c cVar = (c) this.zzf.get(obj.getClass());
