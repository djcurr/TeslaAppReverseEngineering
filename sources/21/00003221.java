...
public final class zzaei extends zzael {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzaei(byte[] bArr, int i11, int i12) {
        super(null);
    ...
    @Override // com.google.android.libraries.places.internal.zzael
    public final void zze(int i11, zzaed zzaedVar) {
        zzq((i11 << 3) | 2);
        zzq(zzaedVar.zzd());
        zzaedVar.zzh(this);
    }
    ...
    public final void zzn(String str) {
        int i11 = this.zzd;
        try {
            int zzA = zzael.zzA(str.length() * 3);
            int zzA2 = zzael.zzA(str.length());
            if (zzA2 == zzA) {
                int i12 = i11 + zzA2;
                this.zzd = i12;
                int zzb = zzahw.zzb(str, this.zzb, i12, this.zzc - i12);
                this.zzd = i11;
                zzq((zzb - i11) - zzA2);
                this.zzd = zzb;
                return;
            ...
            byte[] bArr = this.zzb;
            int i13 = this.zzd;
            this.zzd = zzahw.zzb(str, bArr, i13, this.zzc - i13);
        } catch (zzahv e11) {
            this.zzd = i11;
            zzE(str, e11);
