...
public class a2 {
    ...
    public static void p(long[] jArr, long[] jArr2) {
        ...
        long j14 = (g14 & (-4294967296L)) | (g13 >>> 32);
        long j15 = j14 >>> 49;
        ...
        while (i11 < i12) {
            int i13 = iArr[i11] >>> 6;
            int i14 = iArr[i11] & 63;
            l11[i13] = l11[i13] ^ (j12 << i14);
            int i15 = i13 + 1;
            int[] iArr2 = iArr;
            int i16 = -i14;
            l11[i15] = l11[i15] ^ ((j17 << i14) | (j12 >>> i16));
            int i17 = i13 + 2;
            l11[i17] = l11[i17] ^ ((j16 << i14) | (j17 >>> i16));
            int i18 = i13 + 3;
            l11[i18] = l11[i18] ^ ((j15 << i14) | (j16 >>> i16));
            int i19 = i13 + 4;
            l11[i19] = l11[i19] ^ (j15 >>> i16);
            i11++;
            i12 = 2;
            iArr = iArr2;
        }
