...
public interface IAlixPay extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAlixPay {
        ...
        public static class a implements IAlixPay {
            ...
            public IBinder f10051a;

            public a(IBinder iBinder) {
                this.f10051a = iBinder;
            }
            ...
            public String Pay(String str) {
                ...
                try {
                    ...
                    this.f10051a.transact(1, obtain, obtain2, 0);
            ...
            public void deployFastConnect() {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f10051a.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public int getVersion() {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f10051a.transact(8, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public boolean manager(String str) {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    obtain.writeString(str);
                    this.f10051a.transact(7, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public String pay02(String str, Map map) {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    obtain.writeMap(map);
                    this.f10051a.transact(9, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.readString();
                } finally {
                    obtain2.recycle();
            ...
            public String prePay(String str) {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    obtain.writeString(str);
                    this.f10051a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.readString();
                } finally {
                    obtain2.recycle();
            ...
            public void r03(String str, String str2, Map map) {
                ...
                try {
                    ...
                    obtain.writeMap(map);
                    this.f10051a.transact(10, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void registerCallback(IRemoteServiceCallback iRemoteServiceCallback) {
                ...
                try {
                    ...
                    this.f10051a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void registerCallback03(IRemoteServiceCallback iRemoteServiceCallback, String str, Map map) {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    obtain.writeMap(map);
                    this.f10051a.transact(11, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public String test() {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.f10051a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.readString();
                } finally {
                    obtain2.recycle();
            ...
            public void unregisterCallback(IRemoteServiceCallback iRemoteServiceCallback) {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    obtain.writeStrongBinder(iRemoteServiceCallback != null ? iRemoteServiceCallback.asBinder() : null);
                    this.f10051a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
