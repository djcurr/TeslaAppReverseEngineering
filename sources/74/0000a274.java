...
public class SecP224K1FieldElement extends ECFieldElement {
    ...
    protected int[] f43727x;
    public static final BigInteger Q = SecP224K1Curve.f43726q;
    ...
    public SecP224K1FieldElement(BigInteger bigInteger) {
        if (bigInteger != null && bigInteger.signum() >= 0 && bigInteger.compareTo(Q) < 0) {
            this.f43727x = SecP224K1Field.fromBigInteger(bigInteger);
            return;
        }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP224K1Field.add(this.f43727x, ((SecP224K1FieldElement) eCFieldElement).f43727x, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat224.create();
        SecP224K1Field.addOne(this.f43727x, create);
        return new SecP224K1FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        Mod.invert(SecP224K1Field.P, ((SecP224K1FieldElement) eCFieldElement).f43727x, create);
        SecP224K1Field.multiply(create, this.f43727x, create);
        return new SecP224K1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP224K1FieldElement) {
            return Nat224.eq(this.f43727x, ((SecP224K1FieldElement) obj).f43727x);
        }
        return false;
    }
    ...
    public int hashCode() {
        return Q.hashCode() ^ Arrays.hashCode(this.f43727x, 0, 7);
    }

    @Override // org.spongycastle.math.ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat224.create();
        Mod.invert(SecP224K1Field.P, this.f43727x, create);
        return new SecP224K1FieldElement(create);
    }

    @Override // org.spongycastle.math.ec.ECFieldElement
    public boolean isOne() {
        return Nat224.isOne(this.f43727x);
    }

    @Override // org.spongycastle.math.ec.ECFieldElement
    public boolean isZero() {
        return Nat224.isZero(this.f43727x);
    }

    @Override // org.spongycastle.math.ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224K1Field.multiply(this.f43727x, ((SecP224K1FieldElement) eCFieldElement).f43727x, create);
        return new SecP224K1FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat224.create();
        SecP224K1Field.negate(this.f43727x, create);
        return new SecP224K1FieldElement(create);
    }

    @Override // org.spongycastle.math.ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f43727x;
    ...
    public ECFieldElement square() {
        int[] create = Nat224.create();
        SecP224K1Field.square(this.f43727x, create);
        return new SecP224K1FieldElement(create);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224K1Field.subtract(this.f43727x, ((SecP224K1FieldElement) eCFieldElement).f43727x, create);
        return new SecP224K1FieldElement(create);
    }

    @Override // org.spongycastle.math.ec.ECFieldElement
    public boolean testBitZero() {
        return Nat224.getBit(this.f43727x, 0) == 1;
    }

    @Override // org.spongycastle.math.ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat224.toBigInteger(this.f43727x);
    }

    public SecP224K1FieldElement() {
        this.f43727x = Nat224.create();
    }
