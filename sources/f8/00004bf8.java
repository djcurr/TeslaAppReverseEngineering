...
@f(c = "com.stripe.android.Stripe$handleNextActionForPayment$1", f = "Stripe.kt", l = {316}, m = "invokeSuspend")
/* loaded from: classes2.dex */
public final class Stripe$handleNextActionForPayment$1 extends l implements p<o0, zz.d<? super b0>, Object> {
    ...
    public Stripe$handleNextActionForPayment$1(Stripe stripe, ComponentActivity componentActivity, String str, String str2, zz.d<? super Stripe$handleNextActionForPayment$1> dVar) {
        super(2, dVar);
        this.this$0 = stripe;
    ...
    public final zz.d<b0> create(Object obj, zz.d<?> dVar) {
        return new Stripe$handleNextActionForPayment$1(this.this$0, this.$activity, this.$clientSecret, this.$stripeAccountId, dVar);
    }

    @Override // h00.p
    public final Object mo160invoke(o0 o0Var, zz.d<? super b0> dVar) {
        return ((Stripe$handleNextActionForPayment$1) create(o0Var, dVar)).invokeSuspend(b0.f54756a);
    }
