...
public class RC2CBCParameter extends ASN1Object {
    ...
    ASN1OctetString f43387iv;
    ASN1Integer version;

    public RC2CBCParameter(byte[] bArr) {
        this.version = null;
        this.f43387iv = new DEROctetString(bArr);
    }
    ...
    public byte[] getIV() {
        return this.f43387iv.getOctets();
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f43387iv);
    ...
    private RC2CBCParameter(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() == 1) {
            this.version = null;
            this.f43387iv = (ASN1OctetString) aSN1Sequence.getObjectAt(0);
            return;
        }
        this.version = (ASN1Integer) aSN1Sequence.getObjectAt(0);
        this.f43387iv = (ASN1OctetString) aSN1Sequence.getObjectAt(1);
    }
}