...
public final class CustomerSessionOperationExecutor$execute$5 extends l implements p<o0, zz.d<? super b0>, Object> {
    ...
    public CustomerSessionOperationExecutor$execute$5(CustomerSessionOperationExecutor customerSessionOperationExecutor, EphemeralOperation ephemeralOperation, Object obj, zz.d<? super CustomerSessionOperationExecutor$execute$5> dVar) {
        super(2, dVar);
    ...
    public final Object invoke(o0 o0Var, zz.d<? super b0> dVar) {
        return ((CustomerSessionOperationExecutor$execute$5) create(o0Var, dVar)).invokeSuspend(b0.f54756a);
    }
