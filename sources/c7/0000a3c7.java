    ...
    public static byte[] decode(int i11, int i12, GF2Vector gF2Vector) {
        if (gF2Vector.getLength() == i11 && gF2Vector.getHammingWeight() == i12) {
            ...
            for (int i14 = 0; i14 < i11; i14++) {
                binomial = binomial.multiply(BigInteger.valueOf(i13 - i12)).divide(BigInteger.valueOf(i13));
                i13--;
                if ((vecArray[i14 >> 5] & (1 << (i14 & 31))) != 0) {
                    ...
                    if (i13 == i12) {
                        ...
                        binomial = binomial.multiply(BigInteger.valueOf(i12 + 1)).divide(BigInteger.valueOf(i13 - i12));
                    }
                }
            }
            ...
            for (int i21 = 0; i21 < i11; i21++) {
                ...
                if (((byte) (bArr2[i21 >>> 3] & (1 << (i21 & 7)))) != 0) {
                    ...
                    if (i19 == i12) {
                        ...
                        binomial = binomial.multiply(new BigInteger(Integer.toString(i12 + 1))).divide(new BigInteger(Integer.toString(i19 - i12)));
                    }
                }
            }
            int i22 = i13 + 1;
