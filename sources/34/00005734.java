...
public final class USBankAccountFormFragment$renderSavedAccountScreen$1 extends u implements p<i, Integer, b0> {
    ...
    public static final class AnonymousClass1 extends u implements p<i, Integer, b0> {
        ...
        public final void invoke(i iVar, int i11) {
            if (((i11 & 11) ^ 2) == 0 && iVar.i()) {
                ...
                this.this$0.SavedAccountScreen(this.$screenState, iVar, 64);
            }
        }
    }
    ...
    public final void invoke(i iVar, int i11) {
        if (((i11 & 11) ^ 2) == 0 && iVar.i()) {
            ...
            PaymentsThemeKt.PaymentsTheme(null, null, null, c.b(iVar, -819898743, true, new AnonymousClass1(this.this$0, this.$screenState)), iVar, 3072, 7);
        }
    }
}