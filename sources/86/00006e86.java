...
class c {
    ...
    public static a a(ECParameterSpec eCParameterSpec) {
        ...
        ECParameterSpec eCParameterSpec2 = f26747a;
        ...
        ECParameterSpec eCParameterSpec3 = f26748b;
        ...
        ECParameterSpec eCParameterSpec4 = f26749c;
        ...
        ECParameterSpec eCParameterSpec5 = f26750d;
    ...
    public static ECParameterSpec b(a aVar) {
        if (a.f26716c.equals(aVar)) {
            return f26747a;
        }
        if (a.f26717d.equals(aVar)) {
            return f26748b;
        }
        if (a.f26719f.equals(aVar)) {
            return f26749c;
        }
        if (a.f26720g.equals(aVar)) {
            return f26750d;
        }
        return null;
    }
