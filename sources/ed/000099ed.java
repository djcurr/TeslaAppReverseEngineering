...
public class X509v3CertificateBuilder {
    ...
    public X509v3CertificateBuilder addExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z11, ASN1Encodable aSN1Encodable) {
        CertUtils.addExtension(this.extGenerator, aSN1ObjectIdentifier, z11, aSN1Encodable);
        return this;
    }
    ...
    public X509v3CertificateBuilder copyAndAddExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z11, X509CertificateHolder x509CertificateHolder) {
        ...
        if (extension != null) {
            this.extGenerator.addExtension(aSN1ObjectIdentifier, z11, extension.getExtnValue().getOctets());
            return this;
        }
    ...
    public X509v3CertificateBuilder addExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z11, byte[] bArr) {
