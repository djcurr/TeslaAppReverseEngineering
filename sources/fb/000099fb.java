...
public class ProtectedPKIMessageBuilder {
    ...
    private ProtectedPKIMessage finaliseMessage(PKIHeader pKIHeader, DERBitString dERBitString) {
        if (!this.extraCerts.isEmpty()) {
            ...
            for (int i11 = 0; i11 != size; i11++) {
                cMPCertificateArr[i11] = new CMPCertificate(((X509CertificateHolder) this.extraCerts.get(i11)).toASN1Structure());
            }
    ...
    public ProtectedPKIMessageBuilder(int i11, GeneralName generalName, GeneralName generalName2) {
        this.generalInfos = new ArrayList();
        this.extraCerts = new ArrayList();
        this.hdrBuilder = new PKIHeaderBuilder(i11, generalName, generalName2);
    }
