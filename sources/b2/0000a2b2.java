...
public class SecT283R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT283R1Curve() {
        ...
        this.f43693a = fromBigInteger(BigInteger.valueOf(1L));
        this.f43694b = fromBigInteger(new BigInteger(1, Hex.decode("027B680AC8B8596DA5A4AF8A19A0303FCA97FD7645309FA2A581485AF6263E313B79A2F5")));
    ...
    public ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, boolean z11) {
        return new SecT283R1Point(this, eCFieldElement, eCFieldElement2, z11);
    }
    ...
    public ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr, boolean z11) {
        return new SecT283R1Point(this, eCFieldElement, eCFieldElement2, eCFieldElementArr, z11);
    }
}