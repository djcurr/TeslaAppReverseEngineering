...
public final class CalendarModule$moduleRegistry$$inlined$getFromModuleRegistry$1<T> extends u implements a<T> {
    final /* synthetic */ ModuleRegistryDelegate this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CalendarModule$moduleRegistry$$inlined$getFromModuleRegistry$1(ModuleRegistryDelegate moduleRegistryDelegate) {
        super(0);
