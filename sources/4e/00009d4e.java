...
public final class SessionParameters {
    ...
    public static final class Builder {
        ...
        private void validate(boolean z11, String str) {
            if (z11) {
                return;
            }
        ...
        public Builder setCipherSuite(int i11) {
            this.cipherSuite = i11;
            return this;
        }

        public Builder setCompressionAlgorithm(short s11) {
            this.compressionAlgorithm = s11;
            return this;
        }
    ...
    private SessionParameters(int i11, short s11, byte[] bArr, Certificate certificate, byte[] bArr2, byte[] bArr3, byte[] bArr4) {
