...
public class j1 extends i.b {
    ...
    public j1(n60.e eVar, n60.f fVar, n60.f fVar2) {
        super(eVar, fVar, fVar2);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public j1(n60.e eVar, n60.f fVar, n60.f fVar2, n60.f[] fVarArr) {
    ...
    public n60.i J() {
        ...
        boolean h11 = fVar3.h();
        n60.f j11 = h11 ? fVar2 : fVar2.j(fVar3);
        if (!h11) {
            fVar3 = fVar3.o();
        }
        n60.f a11 = fVar2.o().a(j11).a(fVar3);
        if (a11.i()) {
            return new j1(i11, a11, i11.o());
        }
        n60.f o11 = a11.o();
        n60.f j12 = h11 ? a11 : a11.j(fVar3);
        n60.f o12 = fVar2.a(fVar).o();
        return new j1(i11, o11, o12.a(a11).a(fVar3).j(o12).a(o11), new n60.f[]{j12});
    }
    ...
    public n60.i K(n60.i iVar) {
        ...
        n60.f o13 = fVar2.o();
        n60.f o14 = fVar3.o();
        n60.f a11 = o14.a(o13).a(fVar2.j(fVar3));
        n60.f l11 = o11.j(o14).a(o13).l(a11, o12, o14);
        n60.f j11 = n11.j(o14);
        n60.f o15 = j11.a(a11).o();
        if (o15.i()) {
            return l11.i() ? iVar.J() : i11.u();
        } else if (l11.i()) {
            return new j1(i11, l11, i11.o());
        } else {
            n60.f j12 = l11.o().j(j11);
            n60.f j13 = l11.j(o15).j(o14);
            return new j1(i11, j12, l11.a(o15).o().l(a11, o11.b(), j13), new n60.f[]{j13});
        }
    }
    ...
    public n60.i a(n60.i iVar) {
        ...
        if (n11.i()) {
            ...
            fVar4 = d11.o().a(d11).a(q11).b();
            if (fVar4.i()) {
                return new j1(i11, fVar4, i11.o());
            }
        ...
        return new j1(i11, fVar4, fVar6, new n60.f[]{fVar5});
    }
    ...
    public n60.i z() {
        ...
        n60.f fVar2 = this.f40630c;
        n60.f fVar3 = this.f40631d[0];
        return new j1(this.f40628a, fVar, fVar2.a(fVar3), new n60.f[]{fVar3});
    }
}