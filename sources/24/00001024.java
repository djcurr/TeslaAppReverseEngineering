...
public class PatternLayout extends PatternLayoutBase<ILoggingEvent> {
    ...
    static {
        ...
        hashMap.put(c.f9084i, LoggerConverter.class.getName());
        ...
        hashMap.put(Stripe3ds2AuthResult.Ares.VALUE_CHALLENGE, ClassOfCallerConverter.class.getName());
        hashMap.put(Action.CLASS_ATTRIBUTE, ClassOfCallerConverter.class.getName());
        hashMap.put(Gender.MALE, MethodOfCallerConverter.class.getName());
        ...
        hashMap.put(Gender.FEMALE, FileOfCallerConverter.class.getName());
