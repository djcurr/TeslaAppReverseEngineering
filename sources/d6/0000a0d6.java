...
public final class RC2 {
    ...
    public static class AlgParams extends BaseAlgorithmParameters {
        ...
        protected byte[] engineGetEncoded() {
            return Arrays.clone(this.f43656iv);
        }

        @Override // java.security.AlgorithmParametersSpi
        protected void engineInit(AlgorithmParameterSpec algorithmParameterSpec) {
            if (algorithmParameterSpec instanceof IvParameterSpec) {
                this.f43656iv = ((IvParameterSpec) algorithmParameterSpec).getIV();
                ...
                this.f43656iv = rC2ParameterSpec.getIV();
            } else {
        ...
        protected AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) {
            ...
            if ((cls == RC2ParameterSpec.class || cls == AlgorithmParameterSpec.class) && (i11 = this.parameterVersion) != -1) {
                if (i11 < 256) {
                    return new RC2ParameterSpec(ekb[this.parameterVersion], this.f43656iv);
                }
                return new RC2ParameterSpec(this.parameterVersion, this.f43656iv);
            } else if (cls != IvParameterSpec.class && cls != AlgorithmParameterSpec.class) {
                throw new InvalidParameterSpecException("unknown parameter spec passed to RC2 parameters object.");
            } else {
                return new IvParameterSpec(this.f43656iv);
            }
        }
        ...
        protected byte[] engineGetEncoded(String str) {
            if (isASN1FormatString(str)) {
                ...
                return new RC2CBCParameter(i11, engineGetEncoded()).getEncoded();
        ...
        protected void engineInit(byte[] bArr) {
            this.f43656iv = Arrays.clone(bArr);
        }
        ...
        protected void engineInit(byte[] bArr, String str) {
            if (isASN1FormatString(str)) {
                ...
                this.f43656iv = rC2CBCParameter.getIV();
            } else if (str.equals("RAW")) {
                engineInit(bArr);
            } else {
