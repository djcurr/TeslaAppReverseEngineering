...
public class k extends e.c {
    ...
    public static final BigInteger f47882j = m.f47899h;

    /* renamed from: k  reason: collision with root package name */
    private static final n60.f[] f47883k = {new m(n60.d.f40585b)};
    ...
    class a extends n60.a {
        ...
        private n60.i d(int[] iArr, int[] iArr2) {
            return k.this.i(new m(iArr), new m(iArr2), k.f47883k);
        }
        ...
        public n60.i b(int i11) {
            ...
            int[] d12 = v60.e.d();
            int i12 = 0;
            for (int i13 = 0; i13 < this.f47885a; i13++) {
                int i14 = ((i13 ^ i11) - 1) >> 31;
                for (int i15 = 0; i15 < 5; i15++) {
                    int i16 = d11[i15];
                    int[] iArr = this.f47886b;
    ...
    public k() {
        super(f47882j);
        this.f47884i = new n(this, null, null);
        this.f40591b = m(new BigInteger(1, org.bouncycastle.util.encoders.b.b("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC70")));
        this.f40592c = m(new BigInteger(1, org.bouncycastle.util.encoders.b.b("B4E134D3FB59EB8BAB57274904664D5AF50388BA")));
        this.f40593d = new BigInteger(1, org.bouncycastle.util.encoders.b.b("0100000000000000000000351EE786A818F3A1A16B"));
