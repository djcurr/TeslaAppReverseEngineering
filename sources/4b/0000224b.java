...
public final class zzbh extends zzaw {
    ...
    private static zzap zzc(zzbf zzbfVar, Iterator it2, zzap zzapVar) {
        if (it2 != null) {
            while (it2.hasNext()) {
                zzap zzc = zzbfVar.zza((zzap) it2.next()).zzc((zzae) zzapVar);
                ...
                case 29:
                    ...
                    if (zzb instanceof zzae) {
                        ...
                        for (int i11 = 0; i11 < zzaeVar.zzc(); i11++) {
                            String zzi = zzaeVar.zze(i11).zzi();
                        ...
                        while (zzgVar.zzb(zzapVar).zzg().booleanValue()) {
                            ...
                            zzg zza2 = zzgVar.zza();
                            for (int i12 = 0; i12 < zzaeVar.zzc(); i12++) {
                                String zzi2 = zzaeVar.zze(i12).zzi();
