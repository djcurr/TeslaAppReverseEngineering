...
public class e<K, V> {
    ...
    public final V get(K k11) {
        ...
        synchronized (this) {
            ...
            synchronized (this) {
                this.createCount++;
                put = this.map.put(k11, create);
                if (put != null) {
                    this.map.put(k11, put);
                } else {
                    this.size += safeSizeOf(k11, create);
                }
            }
            if (put != null) {
                entryRemoved(false, k11, create, put);
                return put;
            }
    ...
    public final synchronized String toString() {
        ...
        return String.format(Locale.US, "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", Integer.valueOf(this.maxSize), Integer.valueOf(this.hitCount), Integer.valueOf(this.missCount), Integer.valueOf(i12 != 0 ? (i11 * 100) / i12 : 0));
    }
