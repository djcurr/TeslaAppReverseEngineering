...
public class EglBase14Impl implements EglBase14 {
    ...
    private static EGLContext createEglContext(EGLContext eGLContext, EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i11) {
    ...
    public void createPbufferSurface(int i11, int i12) {
        ...
        if (this.eglSurface == EGL14.EGL_NO_SURFACE) {
            ...
            int eglGetError = EGL14.eglGetError();
            String hexString = Integer.toHexString(EGL14.eglGetError());
            throw new GLException(eglGetError, "Failed to create pixel buffer surface with size " + i11 + "x" + i12 + ": 0x" + hexString);
        }
        throw new RuntimeException("Already has an EGLSurface");
    }
