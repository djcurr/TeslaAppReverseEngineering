...
public class X9ECParameters extends ASN1Object implements X9ObjectIdentifiers {
    ...
    private X9ECPoint f43420g;

    /* renamed from: h  reason: collision with root package name */
    private BigInteger f43421h;

    /* renamed from: n  reason: collision with root package name */
    private BigInteger f43422n;
    private byte[] seed;
    ...
    private X9ECParameters(ASN1Sequence aSN1Sequence) {
        if ((aSN1Sequence.getObjectAt(0) instanceof ASN1Integer) && ((ASN1Integer) aSN1Sequence.getObjectAt(0)).getValue().equals(ONE)) {
            ...
            if (objectAt instanceof X9ECPoint) {
                this.f43420g = (X9ECPoint) objectAt;
            } else {
                this.f43420g = new X9ECPoint(this.curve, (ASN1OctetString) objectAt);
            }
            this.f43422n = ((ASN1Integer) aSN1Sequence.getObjectAt(4)).getValue();
            this.seed = x9Curve.getSeed();
            if (aSN1Sequence.size() == 6) {
                this.f43421h = ((ASN1Integer) aSN1Sequence.getObjectAt(5)).getValue();
                return;
            }
            return;
        }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f43420g);
        aSN1EncodableVector.add(new ASN1Integer(this.f43422n));
        BigInteger bigInteger = this.f43421h;
        if (bigInteger != null) {
    ...
    public X9ECParameters(ECCurve eCCurve, X9ECPoint x9ECPoint, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
        this.curve = eCCurve;
        this.f43420g = x9ECPoint;
        this.f43422n = bigInteger;
        this.f43421h = bigInteger2;
        this.seed = bArr;
