...
class PrincipalUtils {
    ...
    public static c getEncodedIssuerPrincipal(Object obj) {
        return obj instanceof X509Certificate ? getIssuerPrincipal((X509Certificate) obj) : getX500Name((X500Principal) ((h) obj).getIssuer().b()[0]);
    }
    ...
    static c getX500Name(e eVar, X500Principal x500Principal) {
        return notNull(c.e(eVar, getEncoded(x500Principal)));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static c getX500Name(X500Principal x500Principal) {
        return notNull(c.f(getEncoded(x500Principal)));
    }
