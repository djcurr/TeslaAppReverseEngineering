...
final class k extends z0 implements h {
    ...
    private final h00.l<v1.c, b0> f47304b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public k(h00.l<? super v1.c, b0> onDraw, h00.l<? super y0, b0> inspectorInfo) {
        super(inspectorInfo);
        s.g(onDraw, "onDraw");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof k) {
            return s.c(this.f47304b, ((k) obj).f47304b);
        }
        return false;
    }
