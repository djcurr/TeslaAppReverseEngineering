    ...
    public static AsymmetricKeyParameter createKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        if (!algorithm.getAlgorithm().equals(PKCSObjectIdentifiers.rsaEncryption) && !algorithm.getAlgorithm().equals(X509ObjectIdentifiers.id_ea_rsa)) {
            ...
            if (algorithm.getAlgorithm().equals(X9ObjectIdentifiers.dhpublicnumber)) {
                ...
                BigInteger p11 = domainParameters.getP();
                BigInteger g11 = domainParameters.getG();
                BigInteger q11 = domainParameters.getQ();
                BigInteger j11 = domainParameters.getJ() != null ? domainParameters.getJ() : null;
                ValidationParams validationParams = domainParameters.getValidationParams();
                return new DHPublicKeyParameters(y11, new DHParameters(p11, g11, q11, j11, validationParams != null ? new DHValidationParameters(validationParams.getSeed(), validationParams.getPgenCounter().intValue()) : null));
                ...
                BigInteger l11 = dHParameter.getL();
                return new DHPublicKeyParameters(aSN1Integer.getValue(), new DHParameters(dHParameter.getP(), dHParameter.getG(), null, l11 != null ? l11.intValue() : 0));
