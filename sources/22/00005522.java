...
final class PaymentOptionsAdapterKt$PaymentOptionUi$2$5$1 extends kotlin.jvm.internal.u implements h00.l<z2.d, vz.b0> {
    final /* synthetic */ z2.e $card;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PaymentOptionsAdapterKt$PaymentOptionUi$2$5$1(z2.e eVar) {
        super(1);
        this.$card = eVar;
    }
    ...
    public final void invoke2(z2.d constrainAs) {
        ...
        u.a.a(constrainAs.e(), this.$card.e(), x2.g.f(-9), BitmapDescriptorFactory.HUE_RED, 4, null);
