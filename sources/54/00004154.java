...
public final class Button$ButtonPane extends GeneratedMessageLite<Button$ButtonPane, a> implements MessageLiteOrBuilder {
    private static final Button$ButtonPane DEFAULT_INSTANCE;
    private static volatile Parser<Button$ButtonPane> PARSER;
    ...
    public static final class Actions extends GeneratedMessageLite<Actions, b> implements MessageLiteOrBuilder {
        ...
        public static final class ButtonDisclaimerTapAction extends GeneratedMessageLite<ButtonDisclaimerTapAction, a> implements MessageLiteOrBuilder {
            ...
            public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
                switch (m.f18998a[methodToInvoke.ordinal()]) {
                    case 1:
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void clearTertiaryButtonTap() {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void mergeTertiaryButtonTap(TertiaryButtonTapAction tertiaryButtonTapAction) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setTertiaryButtonTap(TertiaryButtonTapAction tertiaryButtonTapAction) {
            tertiaryButtonTapAction.getClass();
            this.action_ = tertiaryButtonTapAction;
            this.actionCase_ = 5;
        }
        ...
        public TertiaryButtonTapAction getTertiaryButtonTap() {
            if (this.actionCase_ == 5) {
                return (TertiaryButtonTapAction) this.action_;
            }
            return TertiaryButtonTapAction.getDefaultInstance();
        }
        ...
        public static final class b extends GeneratedMessageLite.Builder<Actions, b> implements MessageLiteOrBuilder {
            ...
            public b a(TertiaryButtonTapAction tertiaryButtonTapAction) {
                copyOnWrite();
                ((Actions) this.instance).setTertiaryButtonTap(tertiaryButtonTapAction);
                return this;
            }
    ...
    public static final class Rendering extends GeneratedMessageLite<Rendering, a> implements MessageLiteOrBuilder {
        ...
        public static final int BUTTON_DISCLAIMER_FIELD_NUMBER = 8;
        ...
        public static final class Events extends GeneratedMessageLite<Events, a> implements MessageLiteOrBuilder {
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public void clearOnTertiaryButtonTap() {
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public void mergeOnTertiaryButtonTap(Common$SDKEvent common$SDKEvent) {
                common$SDKEvent.getClass();
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public void setOnTertiaryButtonTap(Common$SDKEvent common$SDKEvent) {
                common$SDKEvent.getClass();
                this.onTertiaryButtonTap_ = common$SDKEvent;
            }
            ...
            public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
                switch (m.f18998a[methodToInvoke.ordinal()]) {
                    ...
                    case 2:
                        return new a();
                    case 3:
                        return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0004\u0000\u0000\u0001\u0004\u0004\u0000\u0001\u0000\u0001\u001b\u0002\t\u0003\t\u0004\t", new Object[]{"onAppear_", Common$SDKEvent.class, "onButtonTap_", "onSecondaryButtonTap_", "onTertiaryButtonTap_"});
                    case 4:
                        return DEFAULT_INSTANCE;
                    case 5:
            ...
            public boolean hasOnTertiaryButtonTap() {
                return this.onTertiaryButtonTap_ != null;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void clearHeaderAssetCaption() {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void clearTertiaryButton() {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void mergeHeaderAssetCaption(Common$LocalizedString common$LocalizedString) {
            common$LocalizedString.getClass();
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void mergeTertiaryButton(Common$ButtonContent common$ButtonContent) {
            common$ButtonContent.getClass();
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setHeaderAssetCaption(Common$LocalizedString common$LocalizedString) {
            common$LocalizedString.getClass();
            this.headerAssetCaption_ = common$LocalizedString;
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setTertiaryButton(Common$ButtonContent common$ButtonContent) {
            common$ButtonContent.getClass();
            this.tertiaryButton_ = common$ButtonContent;
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (m.f18998a[methodToInvoke.ordinal()]) {
                ...
                case 2:
                    return new a();
                case 3:
                    return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u000e\u0000\u0000\u0002\u0010\u000e\u0000\u0001\u0000\u0002\t\u0004\t\u0005\t\u0006\t\u0007\t\b\t\t\t\n\t\u000b\t\f\t\r\t\u000e\t\u000f\t\u0010\u001b", new Object[]{"institution_", "headerAsset_", "headerAssetCaption_", "header_", "content_", "buttonDisclaimer_", "button_", "secondaryButton_", "events_", "tertiaryButton_", "buttonDisclaimerText_", "paneHeader_", "attributedContent_", "incrementalResults_", SdkIncrementalResult$SDKIncrementalResult.class});
                case 4:
                    return DEFAULT_INSTANCE;
                case 5:
        ...
        public boolean hasHeaderAssetCaption() {
            return this.headerAssetCaption_ != null;
        }
        ...
        public boolean hasTertiaryButton() {
            return this.tertiaryButton_ != null;
        }
        ...
        public static final class a extends GeneratedMessageLite.Builder<Rendering, a> implements MessageLiteOrBuilder {
            ...
            public a a(Common$RenderedAssetAppearance common$RenderedAssetAppearance) {
                copyOnWrite();
                ((Rendering) this.instance).setHeaderAsset(common$RenderedAssetAppearance);
                return this;
            }

            public a b(Common$LocalizedString common$LocalizedString) {
                copyOnWrite();
                ((Rendering) this.instance).setHeader(common$LocalizedString);
                return this;
            }

            public a a(Common$LocalizedString common$LocalizedString) {
                copyOnWrite();
                ((Rendering) this.instance).setContent(common$LocalizedString);
                return this;
            }

            public a a(Common$ButtonContent.a aVar) {
                copyOnWrite();
                ((Rendering) this.instance).setButton(aVar.build());
                return this;
            }
        }
    ...
    /* loaded from: classes2.dex */
    public static final class a extends GeneratedMessageLite.Builder<Button$ButtonPane, a> implements MessageLiteOrBuilder {
        public a() {
            super(Button$ButtonPane.DEFAULT_INSTANCE);
        }
    }

    static {
        Button$ButtonPane button$ButtonPane = new Button$ButtonPane();
        DEFAULT_INSTANCE = button$ButtonPane;
        GeneratedMessageLite.registerDefaultInstance(Button$ButtonPane.class, button$ButtonPane);
    }

    private Button$ButtonPane() {
    }

    public static Button$ButtonPane getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }
    ...
    public static Button$ButtonPane parseDelimitedFrom(InputStream inputStream) {
        return (Button$ButtonPane) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static Button$ButtonPane parseFrom(ByteBuffer byteBuffer) {
        return (Button$ButtonPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }

    public static Parser<Button$ButtonPane> parser() {
        return DEFAULT_INSTANCE.getParserForType();
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (m.f18998a[methodToInvoke.ordinal()]) {
            ...
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                Parser<Button$ButtonPane> parser = PARSER;
                if (parser == null) {
                    synchronized (Button$ButtonPane.class) {
                        parser = PARSER;
                        if (parser == null) {
                            parser = new GeneratedMessageLite.DefaultInstanceBasedParser<>(DEFAULT_INSTANCE);
                            PARSER = parser;
    ...
    public static a newBuilder(Button$ButtonPane button$ButtonPane) {
        return DEFAULT_INSTANCE.createBuilder(button$ButtonPane);
    }

    public static Button$ButtonPane parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (Button$ButtonPane) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }

    public static Button$ButtonPane parseFrom(ByteBuffer byteBuffer, ExtensionRegistryLite extensionRegistryLite) {
        return (Button$ButtonPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, extensionRegistryLite);
    }

    public static Button$ButtonPane parseFrom(ByteString byteString) {
        return (Button$ButtonPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString);
    }

    public static Button$ButtonPane parseFrom(ByteString byteString, ExtensionRegistryLite extensionRegistryLite) {
        return (Button$ButtonPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, extensionRegistryLite);
    }

    public static Button$ButtonPane parseFrom(byte[] bArr) {
        return (Button$ButtonPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static Button$ButtonPane parseFrom(byte[] bArr, ExtensionRegistryLite extensionRegistryLite) {
        return (Button$ButtonPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, extensionRegistryLite);
    }

    public static Button$ButtonPane parseFrom(InputStream inputStream) {
        return (Button$ButtonPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static Button$ButtonPane parseFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (Button$ButtonPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }

    public static Button$ButtonPane parseFrom(CodedInputStream codedInputStream) {
        return (Button$ButtonPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, codedInputStream);
    }

    public static Button$ButtonPane parseFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (Button$ButtonPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, codedInputStream, extensionRegistryLite);
    }
}