...
public class JavaOnlyMap implements ReadableMap, WritableMap {
    ...
    private JavaOnlyMap(Object... objArr) {
        if (objArr.length % 2 == 0) {
            ...
            for (int i11 = 0; i11 < objArr.length; i11 += 2) {
                ...
                this.mBackingMap.put(objArr[i11], obj);
            }
            return;
        }
    ...
    public void putBoolean(String str, boolean z11) {
        this.mBackingMap.put(str, Boolean.valueOf(z11));
    }

    @Override // com.facebook.react.bridge.WritableMap
    public void putDouble(String str, double d11) {
        this.mBackingMap.put(str, Double.valueOf(d11));
    }

    @Override // com.facebook.react.bridge.WritableMap
    public void putInt(String str, int i11) {
        this.mBackingMap.put(str, new Double(i11));
    }
