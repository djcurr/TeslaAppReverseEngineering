...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRLEntryObject) {
            return this.f43671c.equals(((X509CRLEntryObject) obj).f43671c);
        }
    ...
    public byte[] getEncoded() {
        try {
            return this.f43671c.getEncoded(ASN1Encoding.DER);
    ...
    public Date getRevocationDate() {
        return this.f43671c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f43671c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f43671c.getExtensions() != null;
    }
