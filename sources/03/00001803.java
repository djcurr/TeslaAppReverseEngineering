            ...
            try {
                switch (AnonymousClass1.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i11).ordinal()]) {
                    case 1:
                        ...
                        break;
                    case 2:
                        jsonWriter.value(readableArray.getBoolean(i11));
                        break;
                    case 3:
                        jsonWriter.value(readableArray.getDouble(i11));
                        break;
                    case 4:
                        jsonWriter.value(readableArray.getString(i11));
                        break;
                    case 5:
                        readableMapValue(jsonWriter, readableArray.getMap(i11));
                        break;
                    case 6:
                        readableArrayValue(jsonWriter, readableArray.getArray(i11));
                        break;
                    default:
                        throw new IllegalArgumentException("Unknown data type: " + readableArray.getType(i11));
                }
            } finally {
                jsonWriter.endArray();
            }
