...
public class j extends k {
    ...
    private int i(byte[] bArr, byte[] bArr2, int i11) {
        ...
        bArr3[0] = k.a(bArr3[0], f30060d[0]);
        bArr3[1] = k.a(bArr3[1], f30060d[1]);
        bArr3[2] = k.a(bArr3[2], f30060d[2]);
        bArr3[3] = k.a(bArr3[3], f30060d[3]);
        bArr3[0] = k.a(bArr3[0], f30060d[4]);
        bArr3[1] = k.a(bArr3[1], f30060d[5]);
        bArr3[2] = k.a(bArr3[2], f30060d[6]);
        bArr3[3] = k.a(bArr3[3], f30060d[7]);
        j(bArr3, bArr4);
        bArr3[0] = k.a(bArr4[0], f30060d[8]);
        bArr3[1] = k.a(bArr4[1], f30060d[9]);
        bArr3[2] = k.a(bArr4[2], f30060d[10]);
        bArr3[3] = k.a(bArr4[3], f30060d[11]);
        bArr3[0] = k.a(bArr3[0], f30060d[12]);
        bArr3[1] = k.a(bArr3[1], f30060d[13]);
        bArr3[2] = k.a(bArr3[2], f30060d[14]);
        bArr3[3] = k.a(bArr3[3], f30060d[15]);
        j(bArr3, bArr4);
        bArr3[0] = k.a(bArr4[0], f30060d[16]);
        bArr3[1] = k.a(bArr4[1], f30060d[17]);
        bArr3[2] = k.a(bArr4[2], f30060d[18]);
        bArr3[3] = k.a(bArr4[3], f30060d[19]);
        bArr3[0] = k.a(bArr3[0], f30060d[20]);
        bArr3[1] = k.a(bArr3[1], f30060d[21]);
        bArr3[2] = k.a(bArr3[2], f30060d[22]);
        bArr3[3] = k.a(bArr3[3], f30060d[23]);
        j(bArr3, bArr4);
        bArr3[0] = k.a(bArr4[0], f30060d[24]);
        bArr3[1] = k.a(bArr4[1], f30060d[25]);
        bArr3[2] = k.a(bArr4[2], f30060d[26]);
        bArr3[3] = k.a(bArr4[3], f30060d[27]);
        bArr3[0] = k.a(bArr3[0], f30060d[28]);
        bArr3[1] = k.a(bArr3[1], f30060d[29]);
        bArr3[2] = k.a(bArr3[2], f30060d[30]);
        bArr3[3] = k.a(bArr3[3], f30060d[31]);
        j(bArr3, bArr4);
        bArr3[0] = k.a(bArr4[0], f30060d[32]);
        bArr3[1] = k.a(bArr4[1], f30060d[33]);
        bArr3[2] = k.a(bArr4[2], f30060d[34]);
        bArr3[3] = k.a(bArr4[3], f30060d[35]);
        bArr3[0] = k.a(bArr3[0], f30060d[36]);
        bArr3[1] = k.a(bArr3[1], f30060d[37]);
        bArr3[2] = k.a(bArr3[2], f30060d[38]);
        bArr3[3] = k.a(bArr3[3], f30060d[39]);
        j(bArr3, bArr4);
        bArr3[0] = k.g(bArr4[0], bArr, 0);
        bArr3[1] = k.g(bArr4[1], bArr, 16);
        bArr3[2] = k.g(bArr4[2], bArr, 32);
        bArr3[3] = k.g(bArr4[3], bArr, 48);
    ...
    public int doFinal(byte[] bArr, int i11) {
        if (this.f30062c == 64) {
            if (bArr.length - i11 >= 32) {
                int i12 = i(this.f30061b, bArr, i11);
                reset();
                return i12;
            }
    ...
    public void reset() {
        this.f30062c = 0;
        org.bouncycastle.util.a.g(this.f30061b);
    }
    ...
    public void update(byte[] bArr, int i11, int i12) {
        int i13 = this.f30062c;
        if (i13 + i12 > 64) {
            throw new IllegalArgumentException("total input cannot be more than 64 bytes");
        }
        System.arraycopy(bArr, i11, this.f30061b, i13, i12);
        this.f30062c += i12;
    }
}