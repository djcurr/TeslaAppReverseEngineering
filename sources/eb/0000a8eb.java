...
public final class j0 extends z0 implements l0 {

    /* renamed from: b  reason: collision with root package name */
    private final a.c f45345b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public j0(a.c vertical, h00.l<? super y0, vz.b0> inspectorInfo) {
        super(inspectorInfo);
        kotlin.jvm.internal.s.g(vertical, "vertical");
        kotlin.jvm.internal.s.g(inspectorInfo, "inspectorInfo");
        this.f45345b = vertical;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return kotlin.jvm.internal.s.c(this.f45345b, j0Var.f45345b);
    }
    ...
    public String toString() {
        return "VerticalAlignModifier(vertical=" + this.f45345b + CoreConstants.RIGHT_PARENTHESIS_CHAR;
    }
}