...
public final class ModuleDefinitionBuilder$function$13 extends u implements p<Object[], Promise, b0> {
    final /* synthetic */ t<P0, P1, P2, P3, P4, P5, R> $body;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public ModuleDefinitionBuilder$function$13(t<? super P0, ? super P1, ? super P2, ? super P3, ? super P4, ? super P5, ? extends R> tVar) {
        super(2);
        this.$body = tVar;
    }
