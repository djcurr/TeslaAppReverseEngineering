...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof X509CRLEntryObject ? this.f43204c.equals(((X509CRLEntryObject) obj).f43204c) : super.equals(this);
    }
    ...
    public byte[] getEncoded() {
        try {
            return this.f43204c.d(ASN1Encoding.DER);
    ...
    public Date getRevocationDate() {
        return this.f43204c.h().e();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f43204c.i().s();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f43204c.e() != null;
    }
                    ...
                    while (true) {
                        ...
                        while (i11.hasMoreElements()) {
                            ...
                            if (e12.h() != null) {
                                ...
                                stringBuffer.append(") ");
                                try {
                                    if (kVar.j(v0.f24808c)) {
                                        f11 = e50.m.e(e.q(hVar.D()));
                                    } else if (kVar.j(v0.f24809d)) {
