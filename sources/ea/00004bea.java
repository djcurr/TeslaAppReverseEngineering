...
public final class Stripe$createCardTokenSynchronous$1 extends l implements p<o0, zz.d<? super Token>, Object> {
    ...
    public Stripe$createCardTokenSynchronous$1(Stripe stripe, CardParams cardParams, String str, String str2, zz.d<? super Stripe$createCardTokenSynchronous$1> dVar) {
        super(2, dVar);
        this.this$0 = stripe;
    ...
    public final Object invoke(o0 o0Var, zz.d<? super Token> dVar) {
        return ((Stripe$createCardTokenSynchronous$1) create(o0Var, dVar)).invokeSuspend(b0.f54756a);
    }
