...
public class JCEECPublicKey implements ECPublicKey, org.spongycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    private ECPoint f43664q;
    private boolean withCompression;

    public JCEECPublicKey(String str, JCEECPublicKey jCEECPublicKey) {
        this.algorithm = "EC";
        this.algorithm = str;
        this.f43664q = jCEECPublicKey.f43664q;
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        if (subjectPublicKeyInfo.getAlgorithmId().getAlgorithm().equals(CryptoProObjectIdentifiers.gostR3410_2001)) {
            ...
            try {
                ...
                for (int i11 = 0; i11 != 32; i11++) {
                    bArr[i11] = octets[31 - i11];
                }
                for (int i12 = 0; i12 != 32; i12++) {
                    bArr2[i12] = octets[63 - i12];
                }
                ...
                this.f43664q = curve2.createPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2), false);
        ...
        this.f43664q = new X9ECPoint(curve, dEROctetString).getPoint();
    }
    ...
    public byte[] getEncoded() {
        ...
        if (this.algorithm.equals("ECGOST3410")) {
            ...
            BigInteger bigInteger = this.f43664q.getAffineXCoord().toBigInteger();
            BigInteger bigInteger2 = this.f43664q.getAffineYCoord().toBigInteger();
    ...
    public ECPoint getQ() {
        if (this.ecSpec == null) {
            return this.f43664q.getDetachedPoint();
        }
        return this.f43664q;
    }
    ...
    public java.security.spec.ECPoint getW() {
        return new java.security.spec.ECPoint(this.f43664q.getAffineXCoord().toBigInteger(), this.f43664q.getAffineYCoord().toBigInteger());
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f43664q.getAffineXCoord().toBigInteger().toString(16));
        stringBuffer.append(lineSeparator);
        stringBuffer.append("            Y: ");
        stringBuffer.append(this.f43664q.getAffineYCoord().toBigInteger().toString(16));
        stringBuffer.append(lineSeparator);
    ...
    public JCEECPublicKey(String str, ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.ecSpec = params;
        this.f43664q = EC5Util.convertPoint(params, eCPublicKeySpec.getW(), false);
    }

    public JCEECPublicKey(String str, org.spongycastle.jce.spec.ECPublicKeySpec eCPublicKeySpec) {
        this.algorithm = "EC";
        this.algorithm = str;
        this.f43664q = eCPublicKeySpec.getQ();
        ...
        if (this.f43664q.getCurve() == null) {
            this.f43664q = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve().createPoint(this.f43664q.getAffineXCoord().toBigInteger(), this.f43664q.getAffineYCoord().toBigInteger(), false);
        }
        this.ecSpec = null;
    }
    ...
    public JCEECPublicKey(String str, ECPublicKeyParameters eCPublicKeyParameters, ECParameterSpec eCParameterSpec) {
        ...
        this.algorithm = str;
        this.f43664q = eCPublicKeyParameters.getQ();
        if (eCParameterSpec == null) {
    ...
    public JCEECPublicKey(ECPublicKey eCPublicKey) {
        ...
        this.ecSpec = params;
        this.f43664q = EC5Util.convertPoint(params, eCPublicKey.getW(), false);
    }
