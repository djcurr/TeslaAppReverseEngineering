...
public class k1 extends e.b {
    ...
    private static final n60.f[] f47890k = {new h1(n60.d.f40585b)};

    /* renamed from: j  reason: collision with root package name */
    protected l1 f47891j;
    ...
    class a extends n60.a {
        ...
        private n60.i d(long[] jArr, long[] jArr2) {
            return k1.this.i(new h1(jArr), new h1(jArr2), k1.f47890k);
        }
        ...
        public n60.i b(int i11) {
            ...
            long[] i13 = v60.f.i();
            int i14 = 0;
            for (int i15 = 0; i15 < this.f47892a; i15++) {
                long j11 = ((i15 ^ i11) - 1) >> 31;
                for (int i16 = 0; i16 < 3; i16++) {
                    long j12 = i12[i16];
                    long[] jArr = this.f47893b;
    ...
    public k1() {
        ...
        this.f47891j = new l1(this, null, null);
        this.f40591b = m(new BigInteger(1, org.bouncycastle.util.encoders.b.b("07B6882CAAEFA84F9554FF8428BD88E246D2782AE2")));
        this.f40592c = m(new BigInteger(1, org.bouncycastle.util.encoders.b.b("0713612DCDDCB40AAB946BDA29CA91F73AF958AFD9")));
        this.f40593d = new BigInteger(1, org.bouncycastle.util.encoders.b.b("03FFFFFFFFFFFFFFFFFFFF48AAB689C29CA710279B"));
