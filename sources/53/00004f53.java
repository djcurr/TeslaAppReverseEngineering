...
@f(c = "com.stripe.android.link.repositories.LinkApiRepository$logout$2", f = "LinkApiRepository.kt", l = {153}, m = "invokeSuspend")
/* loaded from: classes6.dex */
public final class LinkApiRepository$logout$2 extends l implements p<o0, d<? super q<? extends ConsumerSession>>, Object> {
    ...
    public final d<b0> create(Object obj, d<?> dVar) {
        LinkApiRepository$logout$2 linkApiRepository$logout$2 = new LinkApiRepository$logout$2(this.this$0, this.$consumerSessionClientSecret, this.$authSessionCookie, dVar);
    ...
    public final Object invoke2(o0 o0Var, d<? super q<ConsumerSession>> dVar) {
        return ((LinkApiRepository$logout$2) create(o0Var, dVar)).invokeSuspend(b0.f54756a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (e11 != null) {
            ...
            logger.error("Error logging out", e11);
            q.a aVar5 = q.f54772b;
        ...
        if (a11 == null) {
            q.a aVar7 = q.f54772b;
            j11 = q.b(r.a(new InternalError("Error logging out")));
        } else {
            j11 = a11.j();
        }
        return q.a(j11);
