...
public final class ButtonWithWebview$ButtonWithWebviewPane extends GeneratedMessageLite<ButtonWithWebview$ButtonWithWebviewPane, a> implements MessageLiteOrBuilder {
    private static final ButtonWithWebview$ButtonWithWebviewPane DEFAULT_INSTANCE;
    private static volatile Parser<ButtonWithWebview$ButtonWithWebviewPane> PARSER;
    ...
    public static final class Actions extends GeneratedMessageLite<Actions, b> implements MessageLiteOrBuilder {
        ...
        public static final class ButtonDisclaimerTapAction extends GeneratedMessageLite<ButtonDisclaimerTapAction, a> implements MessageLiteOrBuilder {
            ...
            public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
                switch (m0.f18999a[methodToInvoke.ordinal()]) {
                    case 1:
    ...
    public static final class Rendering extends GeneratedMessageLite<Rendering, a> implements MessageLiteOrBuilder {
        ...
        public static final int BUTTON_DISCLAIMER_FIELD_NUMBER = 5;
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void clearAccessibilityTitle() {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void mergeAccessibilityTitle(Common$LocalizedString common$LocalizedString) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setAccessibilityTitle(Common$LocalizedString common$LocalizedString) {
            common$LocalizedString.getClass();
            this.accessibilityTitle_ = common$LocalizedString;
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setInlineHtmlBytes(ByteString byteString) {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (m0.f18999a[methodToInvoke.ordinal()]) {
                ...
                case 2:
                    return new a();
                case 3:
                    return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\f\u0001\u0000\u0001\r\f\u0000\u0000\u0000\u0001\t\u0002\t\u0003Ȼ\u0000\u0004Ȼ\u0000\u0005\t\u0006\t\u0007\t\b\t\t\t\n\t\f\t\r\t", new Object[]{"content_", "contentCase_", "headerAsset_", "header_", "buttonDisclaimer_", "button_", "secondaryButton_", "events_", "buttonDisclaimerText_", "accessibilityTitle_", "institution_", "paneHeader_"});
                case 4:
                    return DEFAULT_INSTANCE;
                case 5:
        ...
        public boolean hasAccessibilityTitle() {
            return this.accessibilityTitle_ != null;
        }
    ...
    /* loaded from: classes2.dex */
    public static final class a extends GeneratedMessageLite.Builder<ButtonWithWebview$ButtonWithWebviewPane, a> implements MessageLiteOrBuilder {
        public a() {
            super(ButtonWithWebview$ButtonWithWebviewPane.DEFAULT_INSTANCE);
        }
    }

    static {
        ButtonWithWebview$ButtonWithWebviewPane buttonWithWebview$ButtonWithWebviewPane = new ButtonWithWebview$ButtonWithWebviewPane();
        DEFAULT_INSTANCE = buttonWithWebview$ButtonWithWebviewPane;
        GeneratedMessageLite.registerDefaultInstance(ButtonWithWebview$ButtonWithWebviewPane.class, buttonWithWebview$ButtonWithWebviewPane);
    }

    private ButtonWithWebview$ButtonWithWebviewPane() {
    }

    public static ButtonWithWebview$ButtonWithWebviewPane getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }
    ...
    public static ButtonWithWebview$ButtonWithWebviewPane parseDelimitedFrom(InputStream inputStream) {
        return (ButtonWithWebview$ButtonWithWebviewPane) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static ButtonWithWebview$ButtonWithWebviewPane parseFrom(ByteBuffer byteBuffer) {
        return (ButtonWithWebview$ButtonWithWebviewPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }

    public static Parser<ButtonWithWebview$ButtonWithWebviewPane> parser() {
        return DEFAULT_INSTANCE.getParserForType();
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (m0.f18999a[methodToInvoke.ordinal()]) {
            case 1:
                return new ButtonWithWebview$ButtonWithWebviewPane();
            case 2:
                return new a();
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0000", null);
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                Parser<ButtonWithWebview$ButtonWithWebviewPane> parser = PARSER;
                if (parser == null) {
                    synchronized (ButtonWithWebview$ButtonWithWebviewPane.class) {
                        parser = PARSER;
                        if (parser == null) {
                            parser = new GeneratedMessageLite.DefaultInstanceBasedParser<>(DEFAULT_INSTANCE);
                            PARSER = parser;
    ...
    public static a newBuilder(ButtonWithWebview$ButtonWithWebviewPane buttonWithWebview$ButtonWithWebviewPane) {
        return DEFAULT_INSTANCE.createBuilder(buttonWithWebview$ButtonWithWebviewPane);
    }

    public static ButtonWithWebview$ButtonWithWebviewPane parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (ButtonWithWebview$ButtonWithWebviewPane) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }

    public static ButtonWithWebview$ButtonWithWebviewPane parseFrom(ByteBuffer byteBuffer, ExtensionRegistryLite extensionRegistryLite) {
        return (ButtonWithWebview$ButtonWithWebviewPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, extensionRegistryLite);
    }

    public static ButtonWithWebview$ButtonWithWebviewPane parseFrom(ByteString byteString) {
        return (ButtonWithWebview$ButtonWithWebviewPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString);
    }

    public static ButtonWithWebview$ButtonWithWebviewPane parseFrom(ByteString byteString, ExtensionRegistryLite extensionRegistryLite) {
        return (ButtonWithWebview$ButtonWithWebviewPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, extensionRegistryLite);
    }

    public static ButtonWithWebview$ButtonWithWebviewPane parseFrom(byte[] bArr) {
        return (ButtonWithWebview$ButtonWithWebviewPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static ButtonWithWebview$ButtonWithWebviewPane parseFrom(byte[] bArr, ExtensionRegistryLite extensionRegistryLite) {
        return (ButtonWithWebview$ButtonWithWebviewPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, extensionRegistryLite);
    }

    public static ButtonWithWebview$ButtonWithWebviewPane parseFrom(InputStream inputStream) {
        return (ButtonWithWebview$ButtonWithWebviewPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static ButtonWithWebview$ButtonWithWebviewPane parseFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (ButtonWithWebview$ButtonWithWebviewPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }

    public static ButtonWithWebview$ButtonWithWebviewPane parseFrom(CodedInputStream codedInputStream) {
        return (ButtonWithWebview$ButtonWithWebviewPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, codedInputStream);
    }

    public static ButtonWithWebview$ButtonWithWebviewPane parseFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (ButtonWithWebview$ButtonWithWebviewPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, codedInputStream, extensionRegistryLite);
    }
}