...
final class ComposableSingletons$WalletModalsKt$lambda2$1 extends u implements q<c0, i, Integer, b0> {
    ...
    public final void invoke(c0 TextButton, i iVar, int i11) {
        ...
        if (((i11 & 81) ^ 16) == 0 && iVar.i()) {
            ...
            o1.b(e.b(R.string.cancel, iVar, 0), null, ThemeKt.getLinkColors(h0.f58131a, iVar, 8).m192getDialogButtonLabel0d7_KjU(), 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, null, null, iVar, 0, 0, 65530);
        }
    }
}