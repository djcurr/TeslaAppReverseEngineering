...
public final class AuBankAccountNumberSpec$$serializer implements b0<AuBankAccountNumberSpec> {
    ...
    public AuBankAccountNumberSpec deserialize(e decoder) {
        ...
        b11.d(descriptor2);
        return new AuBankAccountNumberSpec(i11, (IdentifierSpec) obj, (q1) null);
    }
    ...
    @Override // c30.h
    public void serialize(f30.f encoder, AuBankAccountNumberSpec value) {
        s.g(encoder, "encoder");
        s.g(value, "value");
        f descriptor2 = getDescriptor();
        d b11 = encoder.b(descriptor2);
        AuBankAccountNumberSpec.write$Self(value, b11, descriptor2);
        b11.d(descriptor2);
    }
