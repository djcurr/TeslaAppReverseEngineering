...
public final class ImagePickerModule$moduleRegistry$$inlined$getFromModuleRegistry$1<T> extends u implements h00.a<T> {
    final /* synthetic */ ModuleRegistryDelegate this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ImagePickerModule$moduleRegistry$$inlined$getFromModuleRegistry$1(ModuleRegistryDelegate moduleRegistryDelegate) {
        super(0);
