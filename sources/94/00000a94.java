...
final class d extends c {
    private void b(List<atd.i.b> list) {
        list.add(new atd.i.a(atd.s0.a.a(-85829290355264L), Build.BOARD));
        list.add(new atd.i.a(atd.s0.a.a(-85842175257152L), Build.BOOTLOADER));
        list.add(new atd.i.a(atd.s0.a.a(-85855060159040L), Build.BRAND));
        list.add(new atd.i.a(atd.s0.a.a(-85867945060928L), Build.DEVICE));
        list.add(new atd.i.a(atd.s0.a.a(-86190067608128L), Build.DISPLAY));
        list.add(new atd.i.a(atd.s0.a.a(-86202952510016L), Build.FINGERPRINT));
        list.add(new atd.i.a(atd.s0.a.a(-86215837411904L), Build.HARDWARE));
        list.add(new atd.i.a(atd.s0.a.a(-86228722313792L), Build.ID));
        list.add(new atd.i.a(atd.s0.a.a(-86275966954048L), Build.MANUFACTURER));
        list.add(new atd.i.a(atd.s0.a.a(-86288851855936L), Build.PRODUCT));
        list.add(new atd.i.a(atd.s0.a.a(-86301736757824L), Build.getRadioVersion()));
        list.add(new atd.k.a());
        list.add(new atd.k.b());
        list.add(new atd.k.c());
        list.add(new atd.i.a(atd.s0.a.a(-86039743752768L), Build.TAGS));
        list.add(new atd.i.a(atd.s0.a.a(-86086988393024L), Long.valueOf(Build.TIME)));
        list.add(new atd.i.a(atd.s0.a.a(-86099873294912L), Build.TYPE));
        list.add(new atd.i.a(atd.s0.a.a(-86112758196800L), Build.USER));
    }

    private void c(List<atd.i.b> list) {
        list.add(new atd.i.a(atd.s0.a.a(-86125643098688L), Build.VERSION.CODENAME));
        list.add(new atd.i.a(atd.s0.a.a(-86172887738944L), Build.VERSION.INCREMENTAL));
        list.add(new atd.l.a());
        list.add(new atd.i.a(atd.s0.a.a(-85361138920000L), Integer.valueOf(Build.VERSION.SDK_INT)));
    ...
    private void e(List<atd.i.b> list) {
        ...
        list.add(new atd.i.a(atd.s0.a.a(-81225085413952L), Float.valueOf(displayMetrics.density)));
        list.add(new atd.i.a(atd.s0.a.a(-80413336595008L), Integer.valueOf(displayMetrics.densityDpi)));
        list.add(new atd.i.a(atd.s0.a.a(-80426221496896L), Float.valueOf(displayMetrics.scaledDensity)));
        list.add(new atd.i.a(atd.s0.a.a(-80439106398784L), Float.valueOf(displayMetrics.xdpi)));
        list.add(new atd.i.a(atd.s0.a.a(-80486351039040L), Float.valueOf(displayMetrics.ydpi)));
    }
