...
public class RNFileViewerModule extends ReactContextBaseJavaModule {
    ...
    class a extends BaseActivityEventListener {
        ...
        public void onActivityResult(Activity activity, int i11, int i12, Intent intent) {
            RNFileViewerModule.this.sendEvent(RNFileViewerModule.DISMISS_EVENT, Integer.valueOf(i11 - RNFileViewerModule.RN_FILE_VIEWER_REQUEST.intValue()), null);
        }
    }
    ...
    public void open(String str, Integer num, ReadableMap readableMap) {
        ...
        if (str.startsWith("content://")) {
            ...
            try {
                ...
                sendEvent(OPEN_EVENT, num, e11.getMessage());
                return;
            }
        }
        if (uriForFile == null) {
        ...
        if (intent.resolveActivity(getCurrentActivity().getPackageManager()) != null) {
            try {
                ...
                sendEvent(OPEN_EVENT, num, e12.getMessage());
                return;
            }
        }
        try {
            ...
            sendEvent(OPEN_EVENT, num, e13.getMessage());
        }
    }
