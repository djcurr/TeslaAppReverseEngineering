...
public final class AfterpayClearpayTextSpec$$serializer implements b0<AfterpayClearpayTextSpec> {
    ...
    static {
        ...
        g1 g1Var = new g1("com.stripe.android.ui.core.elements.AfterpayClearpayTextSpec", afterpayClearpayTextSpec$$serializer, 1);
    ...
    public AfterpayClearpayTextSpec deserialize(e decoder) {
        ...
        b11.d(descriptor2);
        return new AfterpayClearpayTextSpec(i11, (IdentifierSpec) obj, (q1) null);
    }
    ...
    @Override // c30.h
    public void serialize(f30.f encoder, AfterpayClearpayTextSpec value) {
        s.g(encoder, "encoder");
        s.g(value, "value");
        f descriptor2 = getDescriptor();
        d b11 = encoder.b(descriptor2);
        AfterpayClearpayTextSpec.write$Self(value, b11, descriptor2);
        b11.d(descriptor2);
    }
