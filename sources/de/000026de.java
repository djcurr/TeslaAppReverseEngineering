...
public final class zzos {
    ...
    zzos(Context context, String str) {
        this.zza = TelemetryLogging.getClient(context, TelemetryLoggingOptions.builder().setApi("mlkit:vision").build());
    }

    public static zzos zza(Context context) {
        return new zzos(context, "mlkit:vision");
    }
    ...
    public final synchronized void zzc(int i11, int i12, long j11, long j12) {
        ...
        this.zza.log(new TelemetryData(0, Arrays.asList(new MethodInvocation(i11, i12, 0, j11, j12, null, null, 0)))).addOnFailureListener(new OnFailureListener() { // from class: com.google.android.gms.internal.mlkit_vision_barcode.zzor
            {
                zzos.this = this;
            }
            ...
            public final void onFailure(Exception exc) {
                zzos.this.zzb(elapsedRealtime, exc);
            }
        });
    }
}