...
public final class zzay extends zzaw {
    ...
    private static boolean zzc(zzap zzapVar, zzap zzapVar2) {
        if (zzapVar.getClass().equals(zzapVar2.getClass())) {
            ...
            if (z12 && (zzapVar2 instanceof zzah)) {
    ...
    private static boolean zzd(zzap zzapVar, zzap zzapVar2) {
        ...
        return (Double.isNaN(doubleValue) || Double.isNaN(doubleValue2) || (doubleValue == 0.0d && doubleValue2 == 0.0d) || ((i11 == 0 && doubleValue2 == 0.0d) || Double.compare(doubleValue, doubleValue2) >= 0)) ? false : true;
    }
