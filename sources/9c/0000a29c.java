...
public class SecT163R2Curve extends ECCurve.AbstractF2m {
    ...
    public SecT163R2Curve() {
        ...
        this.f43694b = fromBigInteger(new BigInteger(1, Hex.decode("020A601907B8C953CA1481EB10512F78744A3205FD")));
    ...
    public ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, boolean z11) {
        return new SecT163R2Point(this, eCFieldElement, eCFieldElement2, z11);
    }
    ...
    public ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr, boolean z11) {
        return new SecT163R2Point(this, eCFieldElement, eCFieldElement2, eCFieldElementArr, z11);
    }
}