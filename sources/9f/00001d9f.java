...
public class GoogleApiManager implements Handler.Callback {
    ...
    private final void zaL(TaskCompletionSource taskCompletionSource, int i11, GoogleApi googleApi) {
        zacd zaa2;
            ...
            case 5:
                ...
                while (true) {
                    if (it3.hasNext()) {
                        ...
                        zabqVar = zabqVar5.zab() == i12 ? zabqVar5 : null;
                    }
                }
                if (zabqVar == null) {
    ...
    public final Task zar(GoogleApi googleApi, ListenerHolder.ListenerKey listenerKey, int i11) {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
    ...
    public final void zaw(GoogleApi googleApi, int i11, BaseImplementation.ApiMethodImpl apiMethodImpl) {
        zae zaeVar = new zae(i11, apiMethodImpl);
        Handler handler = this.zat;
        handler.sendMessage(handler.obtainMessage(4, new zach(zaeVar, this.zao.get(), googleApi)));
    }

    public final void zax(GoogleApi googleApi, int i11, TaskApiCall taskApiCall, TaskCompletionSource taskCompletionSource, StatusExceptionMapper statusExceptionMapper) {
