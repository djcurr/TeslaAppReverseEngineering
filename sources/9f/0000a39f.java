...
public class JcePKCSPBEInputDecryptorProviderBuilder {
                ...
                try {
                    if (algorithm.on(PKCSObjectIdentifiers.pkcs_12PbeIds)) {
                        ...
                        if (pBKDF2Params.isDefaultPrf()) {
                            generateSecret = createSecretKeyFactory.generateSecret(new PBEKeySpec(cArr, pBKDF2Params.getSalt(), pBKDF2Params.getIterationCount().intValue(), JcePKCSPBEInputDecryptorProviderBuilder.this.keySizeProvider.getKeySize(algorithmIdentifier2)));
                        } else {
                            generateSecret = createSecretKeyFactory.generateSecret(new PBKDF2KeySpec(cArr, pBKDF2Params.getSalt(), pBKDF2Params.getIterationCount().intValue(), JcePKCSPBEInputDecryptorProviderBuilder.this.keySizeProvider.getKeySize(algorithmIdentifier2), pBKDF2Params.getPrf()));
                        }
    ...
    public JcePKCSPBEInputDecryptorProviderBuilder setTryWrongPKCS12Zero(boolean z11) {
        this.wrongPKCS12Zero = z11;
        return this;
    }
