...
public final class c {
    ...
    public static final x1.c a(z0.a aVar) {
        ...
        c.a aVar2 = new c.a("Filled.MoreVert", g.f(24.0f), g.f(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
        int b11 = p.b();
        ...
        d dVar = new d();
        dVar.g(12.0f, 8.0f);
        dVar.c(1.1f, BitmapDescriptorFactory.HUE_RED, 2.0f, -0.9f, 2.0f, -2.0f);
        dVar.h(-0.9f, -2.0f, -2.0f, -2.0f);
        dVar.h(-2.0f, 0.9f, -2.0f, 2.0f);
        dVar.h(0.9f, 2.0f, 2.0f, 2.0f);
        dVar.b();
        dVar.g(12.0f, 10.0f);
        dVar.c(-1.1f, BitmapDescriptorFactory.HUE_RED, -2.0f, 0.9f, -2.0f, 2.0f);
