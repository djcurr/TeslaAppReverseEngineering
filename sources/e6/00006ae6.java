...
public final class ModuleDefinitionBuilder$AsyncFunction$9 extends u implements p<Object[], Promise, b0> {
    final /* synthetic */ r<P0, P1, P2, P3, R> $body;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public ModuleDefinitionBuilder$AsyncFunction$9(r<? super P0, ? super P1, ? super P2, ? super P3, ? extends R> rVar) {
        super(2);
        this.$body = rVar;
    }
