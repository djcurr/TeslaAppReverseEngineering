...
public interface Parser<MessageType> {
    ...
    MessageType parseFrom(byte[] bArr, int i11, int i12, ExtensionRegistryLite extensionRegistryLite);
    ...
    MessageType parsePartialFrom(byte[] bArr, int i11, int i12, ExtensionRegistryLite extensionRegistryLite);
