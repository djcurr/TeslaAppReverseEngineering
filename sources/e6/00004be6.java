...
@f(c = "com.stripe.android.Stripe$confirmSetupIntentSynchronous$1", f = "Stripe.kt", l = {773}, m = "invokeSuspend")
/* loaded from: classes2.dex */
public final class Stripe$confirmSetupIntentSynchronous$1 extends l implements p<o0, zz.d<? super SetupIntent>, Object> {
    ...
    public Stripe$confirmSetupIntentSynchronous$1(Stripe stripe, ConfirmSetupIntentParams confirmSetupIntentParams, String str, zz.d<? super Stripe$confirmSetupIntentSynchronous$1> dVar) {
        super(2, dVar);
        this.this$0 = stripe;
    ...
    @Override // h00.p
    public final Object invoke(o0 o0Var, zz.d<? super SetupIntent> dVar) {
        return ((Stripe$confirmSetupIntentSynchronous$1) create(o0Var, dVar)).invokeSuspend(b0.f54756a);
    }
