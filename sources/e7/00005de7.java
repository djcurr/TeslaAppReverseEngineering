...
public class CondNode extends Node {
    ...
    public CondNode(int i11, ReadableMap readableMap, NodesManager nodesManager) {
    ...
    protected Object evaluate() {
        ...
        if ((nodeValue instanceof Number) && ((Number) nodeValue).doubleValue() != 0.0d) {
            int i11 = this.mIfBlockID;
            return i11 != -1 ? this.mNodesManager.getNodeValue(i11) : Node.ZERO;
        }
        int i12 = this.mElseBlockID;
        return i12 != -1 ? this.mNodesManager.getNodeValue(i12) : Node.ZERO;
    }
}