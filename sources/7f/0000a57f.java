...
public class GlGenericDrawer implements RendererCommon.GlDrawer {
    ...
    public interface ShaderCallbacks {
        ...
        void onPrepareShader(GlShader glShader, float[] fArr, int i11, int i12, int i13, int i14);
    }
    ...
    private void prepareShader(ShaderType shaderType, float[] fArr, int i11, int i12, int i13, int i14) {
        GlShader glShader;
        ...
        this.shaderCallbacks.onPrepareShader(glShader, fArr, i11, i12, i13, i14);
    ...
    public void drawOes(int i11, float[] fArr, int i12, int i13, int i14, int i15, int i16, int i17) {
        prepareShader(ShaderType.OES, fArr, i12, i13, i16, i17);
    ...
    @Override // org.webrtc.RendererCommon.GlDrawer
    public void drawRgb(int i11, float[] fArr, int i12, int i13, int i14, int i15, int i16, int i17) {
        prepareShader(ShaderType.RGB, fArr, i12, i13, i16, i17);
        GLES20.glActiveTexture(33984);
    ...
    @Override // org.webrtc.RendererCommon.GlDrawer
    public void drawYuv(int[] iArr, float[] fArr, int i11, int i12, int i13, int i14, int i15, int i16) {
        prepareShader(ShaderType.YUV, fArr, i11, i12, i15, i16);
