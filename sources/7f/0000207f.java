...
public final class zzcb {
    ...
    static {
        ...
        for (zzcb zzcbVar52 : values) {
            zzjb[zzcbVar52.f14804id] = zzcbVar52;
        }
    }

    private zzcb(String str, int i11, int i12, zzcd zzcdVar, zzcq zzcqVar) {
        int i13;
        this.f14804id = i12;
        this.zziy = zzcdVar;
        this.zzix = zzcqVar;
        int i14 = zzcc.zzje[zzcdVar.ordinal()];
        boolean z11 = true;
        this.zziz = (i14 == 1 || i14 == 2) ? zzcqVar.zzbq() : null;
        this.zzja = (zzcdVar != zzcd.SCALAR || (i13 = zzcc.zzjf[zzcqVar.ordinal()]) == 1 || i13 == 2 || i13 == 3) ? false : z11;
    }
