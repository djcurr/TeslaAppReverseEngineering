...
public class MessageQueueThreadSpec {
    ...
    private MessageQueueThreadSpec(ThreadType threadType, String str, long j11) {
        this.mThreadType = threadType;
        this.mName = str;
        this.mStackSize = j11;
    }

    public static MessageQueueThreadSpec newBackgroundThreadSpec(String str, long j11) {
        return new MessageQueueThreadSpec(ThreadType.NEW_BACKGROUND, str, j11);
    }
}