...
class ErrorCorrection {
    ...
    static int f(int[] iArr, int i11, int i12, int i13) {
        ...
        return abs(i13 - ((iArr[i11] * 2) * 12289));
    }
    ...
    public static void rec(byte[] bArr, short[] sArr, short[] sArr2) {
        ...
        for (int i11 = 0; i11 < 256; i11++) {
            int i12 = i11 + 0;
            int i13 = i11 + 768;
            iArr[0] = ((sArr[i12] * 8) + 196624) - (((sArr2[i12] * 2) + sArr2[i13]) * 12289);
            int i14 = i11 + 256;
            iArr[1] = ((sArr[i14] * 8) + 196624) - (((sArr2[i14] * 2) + sArr2[i13]) * 12289);
            int i15 = i11 + 512;
            iArr[2] = ((sArr[i15] * 8) + 196624) - (((sArr2[i15] * 2) + sArr2[i13]) * 12289);
