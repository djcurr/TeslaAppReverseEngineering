...
public final class zzbn implements d {
    ...
    static {
        ...
        zzd = new c() { // from class: com.google.android.gms.internal.mlkit_common.zzbm
            @Override // lm.c
            public final void encode(Object obj, Object obj2) {
                zzbn.zzg((Map.Entry) obj, (d) obj2);
            }
        };
    }

    public zzbn(OutputStream outputStream, Map map, Map map2, c cVar) {
    ...
    private static int zzh(b bVar) {
        zzbl zzblVar = (zzbl) bVar.c(zzbl.class);
        if (zzblVar != null) {
            return zzblVar.zza();
        }
    ...
    private static zzbl zzj(b bVar) {
        zzbl zzblVar = (zzbl) bVar.c(zzbl.class);
        if (zzblVar != null) {
            return zzblVar;
        }
    ...
    private final zzbn zzk(c cVar, b bVar, Object obj, boolean z11) {
    ...
    private final zzbn zzl(e eVar, b bVar, Object obj, boolean z11) {
    ...
    public final zzbn zzd(b bVar, int i11, boolean z11) {
        if (z11 && i11 == 0) {
            return this;
        }
        zzbl zzj = zzj(bVar);
    ...
    public final zzbn zze(b bVar, long j11, boolean z11) {
        if (z11 && j11 == 0) {
            return this;
        }
        zzbl zzj = zzj(bVar);
    ...
    public final zzbn zzf(Object obj) {
        if (obj == null) {
            return this;
        }
        c cVar = (c) this.zzf.get(obj.getClass());
