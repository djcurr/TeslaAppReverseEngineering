...
public class VMPCRandomGenerator implements RandomGenerator {
    ...
    public void nextBytes(byte[] bArr, int i11, int i12) {
        synchronized (this.P) {
            ...
            while (i11 != i13) {
                byte[] bArr2 = this.P;
                byte b11 = this.f43625s;
                byte b12 = this.f43624n;
