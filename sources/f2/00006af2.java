...
public final class ModuleDefinitionBuilder$function$11 extends u implements p<Object[], Promise, b0> {
    final /* synthetic */ s<P0, P1, P2, P3, P4, R> $body;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public ModuleDefinitionBuilder$function$11(s<? super P0, ? super P1, ? super P2, ? super P3, ? super P4, ? extends R> sVar) {
        super(2);
        this.$body = sVar;
    }
