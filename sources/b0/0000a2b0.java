...
public class SecT283K1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT283K1Curve() {
        ...
        this.f43693a = fromBigInteger(BigInteger.valueOf(0L));
        this.f43694b = fromBigInteger(BigInteger.valueOf(1L));
    ...
    public ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, boolean z11) {
        return new SecT283K1Point(this, eCFieldElement, eCFieldElement2, z11);
    }
    ...
    public ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr, boolean z11) {
        return new SecT283K1Point(this, eCFieldElement, eCFieldElement2, eCFieldElementArr, z11);
    }
}