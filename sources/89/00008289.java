...
public class j implements org.bouncycastle.crypto.e {
    ...
    private int[] f36791c = new int[96];

    /* renamed from: d  reason: collision with root package name */
    private int[] f36792d = new int[8];

    /* renamed from: e  reason: collision with root package name */
    private int[] f36793e = new int[12];

    /* renamed from: f  reason: collision with root package name */
    private int[] f36794f = new int[4];
    ...
    private void b(int[] iArr, int[] iArr2, int i11) {
        ...
        iArr[0] = iArr[0] ^ i23;
        iArr[1] = (i23 ^ j(i21, 8)) ^ iArr[1];
    }

    private void c(int[] iArr, int[] iArr2, int i11) {
        iArr[1] = iArr[1] ^ g(iArr[0] & iArr2[i11 + 0], 1);
        iArr[0] = iArr[0] ^ (iArr2[i11 + 1] | iArr[1]);
        iArr[2] = iArr[2] ^ (iArr2[i11 + 3] | iArr[3]);
        iArr[3] = g(iArr2[i11 + 2] & iArr[2], 1) ^ iArr[3];
    }

    private static void d(int i11, int[] iArr, int i12, int[] iArr2, int i13) {
        int i14 = i13 + 2;
        int i15 = i12 + 0;
        int i16 = i12 + 1;
        int i17 = 32 - i11;
    ...
    private int h(byte[] bArr, int i11, byte[] bArr2, int i12) {
        for (int i13 = 0; i13 < 4; i13++) {
            this.f36794f[i13] = a(bArr, (i13 * 4) + i11);
            int[] iArr = this.f36794f;
            iArr[i13] = iArr[i13] ^ this.f36792d[i13];
        }
        b(this.f36794f, this.f36791c, 0);
        b(this.f36794f, this.f36791c, 4);
        b(this.f36794f, this.f36791c, 8);
        c(this.f36794f, this.f36793e, 0);
        b(this.f36794f, this.f36791c, 12);
        b(this.f36794f, this.f36791c, 16);
        b(this.f36794f, this.f36791c, 20);
        c(this.f36794f, this.f36793e, 4);
        b(this.f36794f, this.f36791c, 24);
        b(this.f36794f, this.f36791c, 28);
        b(this.f36794f, this.f36791c, 32);
        int[] iArr2 = this.f36794f;
        int i14 = iArr2[2];
        int[] iArr3 = this.f36792d;
        iArr2[2] = iArr3[4] ^ i14;
        iArr2[3] = iArr2[3] ^ iArr3[5];
        iArr2[0] = iArr2[0] ^ iArr3[6];
        iArr2[1] = iArr3[7] ^ iArr2[1];
        f(iArr2[2], bArr2, i12);
        f(this.f36794f[3], bArr2, i12 + 4);
        f(this.f36794f[0], bArr2, i12 + 8);
        f(this.f36794f[1], bArr2, i12 + 12);
        return 16;
    }

    private int i(byte[] bArr, int i11, byte[] bArr2, int i12) {
        for (int i13 = 0; i13 < 4; i13++) {
            this.f36794f[i13] = a(bArr, (i13 * 4) + i11);
            int[] iArr = this.f36794f;
            iArr[i13] = iArr[i13] ^ this.f36792d[i13];
        ...
        b(this.f36794f, this.f36791c, 28);
        b(this.f36794f, this.f36791c, 32);
        c(this.f36794f, this.f36793e, 8);
        b(this.f36794f, this.f36791c, 36);
        b(this.f36794f, this.f36791c, 40);
        b(this.f36794f, this.f36791c, 44);
        int[] iArr2 = this.f36794f;
        int i14 = iArr2[2];
        int[] iArr3 = this.f36792d;
        iArr2[2] = i14 ^ iArr3[4];
    ...
    private static void k(int i11, int[] iArr, int i12, int[] iArr2, int i13) {
        int i14 = i13 + 0;
        int i15 = i12 + 0;
        int i16 = i12 + 1;
        int i17 = 32 - i11;
    ...
    private static void l(int i11, int[] iArr, int i12, int[] iArr2, int i13) {
        int i14 = i13 + 0;
        int i15 = i12 + 1;
        int i16 = i11 - 32;
        int i17 = i12 + 2;
    ...
    private void m(boolean z11, byte[] bArr) {
        int[] iArr = new int[8];
        int[] iArr2 = new int[4];
        int[] iArr3 = new int[4];
        int[] iArr4 = new int[4];
        ...
        b(iArr2, f36784g, 4);
        if (this.f36790b) {
            int[] iArr5 = this.f36792d;
            if (z11) {
                iArr5[0] = iArr[0];
                iArr5[1] = iArr[1];
                iArr5[2] = iArr[2];
                iArr5[3] = iArr[3];
                k(15, iArr, 0, this.f36791c, 4);
                k(30, iArr, 0, this.f36791c, 12);
                k(15, iArr, 0, iArr4, 0);
                int[] iArr6 = this.f36791c;
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                k(17, iArr, 0, this.f36793e, 4);
                k(17, iArr, 0, this.f36791c, 24);
                k(17, iArr, 0, this.f36791c, 32);
                int[] iArr7 = this.f36791c;
                iArr7[0] = iArr2[0];
                iArr7[1] = iArr2[1];
                iArr7[2] = iArr2[2];
                iArr7[3] = iArr2[3];
                k(15, iArr2, 0, iArr7, 8);
                k(15, iArr2, 0, this.f36793e, 0);
                k(15, iArr2, 0, iArr4, 0);
                int[] iArr8 = this.f36791c;
                iArr8[16] = iArr4[0];
                iArr8[17] = iArr4[1];
                k(15, iArr2, 0, iArr8, 20);
                l(34, iArr2, 0, this.f36791c, 28);
                k(17, iArr2, 0, this.f36792d, 4);
                return;
            }
            iArr5[4] = iArr[0];
            iArr5[5] = iArr[1];
            iArr5[6] = iArr[2];
            iArr5[7] = iArr[3];
            d(15, iArr, 0, this.f36791c, 28);
            d(30, iArr, 0, this.f36791c, 20);
            d(15, iArr, 0, iArr4, 0);
            int[] iArr9 = this.f36791c;
            iArr9[16] = iArr4[0];
            iArr9[17] = iArr4[1];
            d(17, iArr, 0, this.f36793e, 0);
            d(17, iArr, 0, this.f36791c, 8);
            d(17, iArr, 0, this.f36791c, 0);
            int[] iArr10 = this.f36791c;
            iArr10[34] = iArr2[0];
            iArr10[35] = iArr2[1];
            iArr10[32] = iArr2[2];
            iArr10[33] = iArr2[3];
            d(15, iArr2, 0, iArr10, 24);
            d(15, iArr2, 0, this.f36793e, 4);
            d(15, iArr2, 0, iArr4, 0);
            int[] iArr11 = this.f36791c;
            iArr11[18] = iArr4[2];
            iArr11[19] = iArr4[3];
            d(15, iArr2, 0, iArr11, 12);
            e(34, iArr2, 0, this.f36791c, 4);
            k(17, iArr2, 0, this.f36792d, 0);
            return;
        }
        for (int i13 = 0; i13 < 4; i13++) {
        ...
        b(iArr3, f36784g, 8);
        int[] iArr12 = this.f36792d;
        if (z11) {
            iArr12[0] = iArr[0];
            iArr12[1] = iArr[1];
            iArr12[2] = iArr[2];
            iArr12[3] = iArr[3];
            l(45, iArr, 0, this.f36791c, 16);
            k(15, iArr, 0, this.f36793e, 4);
            k(17, iArr, 0, this.f36791c, 32);
            l(34, iArr, 0, this.f36791c, 44);
            k(15, iArr, 4, this.f36791c, 4);
            k(15, iArr, 4, this.f36793e, 0);
            k(30, iArr, 4, this.f36791c, 24);
            l(34, iArr, 4, this.f36791c, 36);
            k(15, iArr2, 0, this.f36791c, 8);
            k(30, iArr2, 0, this.f36791c, 20);
            int[] iArr13 = this.f36793e;
            iArr13[8] = iArr2[1];
            iArr13[9] = iArr2[2];
            iArr13[10] = iArr2[3];
            iArr13[11] = iArr2[0];
            l(49, iArr2, 0, this.f36791c, 40);
            int[] iArr14 = this.f36791c;
            iArr14[0] = iArr3[0];
            iArr14[1] = iArr3[1];
            iArr14[2] = iArr3[2];
            iArr14[3] = iArr3[3];
            k(30, iArr3, 0, iArr14, 12);
            k(30, iArr3, 0, this.f36791c, 28);
            l(51, iArr3, 0, this.f36792d, 4);
            return;
        }
        iArr12[4] = iArr[0];
        iArr12[5] = iArr[1];
        iArr12[6] = iArr[2];
        iArr12[7] = iArr[3];
        e(45, iArr, 0, this.f36791c, 28);
        d(15, iArr, 0, this.f36793e, 4);
        d(17, iArr, 0, this.f36791c, 12);
        e(34, iArr, 0, this.f36791c, 0);
        d(15, iArr, 4, this.f36791c, 40);
        d(15, iArr, 4, this.f36793e, 8);
        d(30, iArr, 4, this.f36791c, 20);
        e(34, iArr, 4, this.f36791c, 8);
        d(15, iArr2, 0, this.f36791c, 36);
        d(30, iArr2, 0, this.f36791c, 24);
        int[] iArr15 = this.f36793e;
        iArr15[2] = iArr2[1];
        iArr15[3] = iArr2[2];
        iArr15[0] = iArr2[3];
        iArr15[1] = iArr2[0];
        e(49, iArr2, 0, this.f36791c, 4);
        int[] iArr16 = this.f36791c;
        iArr16[46] = iArr3[0];
        iArr16[47] = iArr3[1];
        iArr16[44] = iArr3[2];
        iArr16[45] = iArr3[3];
        d(30, iArr3, 0, iArr16, 32);
        d(30, iArr3, 0, this.f36791c, 16);
        l(51, iArr3, 0, this.f36792d, 0);
    }
        ...
        if (this.f36789a) {
            if (i11 + 16 <= bArr.length) {
                if (i12 + 16 <= bArr2.length) {
                    return this.f36790b ? h(bArr, i11, bArr2, i12) : i(bArr, i11, bArr2, i12);
                }
