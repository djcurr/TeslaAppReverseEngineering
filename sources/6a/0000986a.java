...
public class ECGOST3410NamedCurves {
    ...
    static {
        ...
        ECCurve.Fp fp2 = new ECCurve.Fp(bigInteger, bigInteger3, bigInteger4, bigInteger2, bigInteger5);
        ECDomainParameters eCDomainParameters = new ECDomainParameters(fp2, fp2.createPoint(new BigInteger("1"), new BigInteger("64033881142927202683649881450433473985931760268884941288852745803908878638612")), bigInteger2);
        ...
        ECCurve.Fp fp3 = new ECCurve.Fp(bigInteger6, new BigInteger("115792089237316195423570985008687907853269984665640564039457584007913129639316"), new BigInteger("166"), bigInteger7, bigInteger5);
        ECDomainParameters eCDomainParameters2 = new ECDomainParameters(fp3, fp3.createPoint(new BigInteger("1"), new BigInteger("64033881142927202683649881450433473985931760268884941288852745803908878638612")), bigInteger7);
        ...
        ECCurve.Fp fp4 = new ECCurve.Fp(bigInteger8, new BigInteger("57896044618658097711785492504343953926634992332820282019728792003956564823190"), new BigInteger("28091019353058090096996979000309560759124368558014865957655842872397301267595"), bigInteger9, bigInteger5);
        ECDomainParameters eCDomainParameters3 = new ECDomainParameters(fp4, fp4.createPoint(new BigInteger("1"), new BigInteger("28792665814854611296992347458380284135028636778229113005756334730996303888124")), bigInteger9);
        ...
        ECCurve.Fp fp5 = new ECCurve.Fp(bigInteger10, new BigInteger("70390085352083305199547718019018437841079516630045180471284346843705633502616"), new BigInteger("32858"), bigInteger11, bigInteger5);
        ECDomainParameters eCDomainParameters4 = new ECDomainParameters(fp5, fp5.createPoint(new BigInteger("0"), new BigInteger("29818893917731240733471273240314769927240550812383695689146495261604565990247")), bigInteger11);
        ...
        ECCurve.Fp fp6 = new ECCurve.Fp(bigInteger12, new BigInteger("70390085352083305199547718019018437841079516630045180471284346843705633502616"), new BigInteger("32858"), bigInteger13, bigInteger5);
        ECDomainParameters eCDomainParameters5 = new ECDomainParameters(fp6, fp6.createPoint(new BigInteger("0"), new BigInteger("29818893917731240733471273240314769927240550812383695689146495261604565990247")), bigInteger13);
