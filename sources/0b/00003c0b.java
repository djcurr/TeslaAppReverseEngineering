...
public final class FieldType {
    ...
    static {
        ...
        for (FieldType fieldType52 : values) {
            VALUES[fieldType52.f17411id] = fieldType52;
        }
    }
    ...
    private FieldType(String str, int i11, int i12, Collection collection, JavaType javaType) {
        ...
        int i14 = AnonymousClass1.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        boolean z11 = true;
        if (i14 == 1) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i13 = AnonymousClass1.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i13 == 2 || i13 == 3) ? false : z11;
    }
