...
public final class CardBillingSpec$$serializer implements b0<CardBillingSpec> {
    ...
    public CardBillingSpec deserialize(e decoder) {
        ...
        b11.d(descriptor2);
        return new CardBillingSpec(i11, (IdentifierSpec) obj, (Set) obj2, (q1) null);
    }
    ...
    @Override // c30.h
    public void serialize(f30.f encoder, CardBillingSpec value) {
        s.g(encoder, "encoder");
        s.g(value, "value");
        f descriptor2 = getDescriptor();
        d b11 = encoder.b(descriptor2);
        CardBillingSpec.write$Self(value, b11, descriptor2);
        b11.d(descriptor2);
    }
