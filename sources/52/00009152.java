...
public class EdEC {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            k kVar = a.f33208e;
            configurableProvider.addAlgorithm("Alg.Alias.Signature", kVar, "ED448");
            k kVar2 = a.f33207d;
            configurableProvider.addAlgorithm("Alg.Alias.Signature", kVar2, "ED25519");
            ...
            configurableProvider.addAlgorithm("KeyPairGenerator", kVar, "org.bouncycastle.jcajce.provider.asymmetric.edec.KeyPairGeneratorSpi$Ed448");
            configurableProvider.addAlgorithm("KeyPairGenerator", kVar2, "org.bouncycastle.jcajce.provider.asymmetric.edec.KeyPairGeneratorSpi$Ed25519");
            ...
            k kVar3 = a.f33206c;
            configurableProvider.addAlgorithm("KeyAgreement", kVar3, "org.bouncycastle.jcajce.provider.asymmetric.edec.KeyAgreementSpi$X448");
            k kVar4 = a.f33205b;
            configurableProvider.addAlgorithm("KeyAgreement", kVar4, "org.bouncycastle.jcajce.provider.asymmetric.edec.KeyAgreementSpi$X25519");
            ...
            configurableProvider.addAlgorithm("KeyPairGenerator", kVar3, "org.bouncycastle.jcajce.provider.asymmetric.edec.KeyPairGeneratorSpi$X448");
            configurableProvider.addAlgorithm("KeyPairGenerator", kVar4, "org.bouncycastle.jcajce.provider.asymmetric.edec.KeyPairGeneratorSpi$X25519");
            registerOid(configurableProvider, kVar3, "XDH", new KeyFactorySpi.X448());
            registerOid(configurableProvider, kVar4, "XDH", new KeyFactorySpi.X25519());
            registerOid(configurableProvider, kVar, "EDDSA", new KeyFactorySpi.Ed448());
            registerOid(configurableProvider, kVar2, "EDDSA", new KeyFactorySpi.Ed25519());
        }
    }
