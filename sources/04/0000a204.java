...
public class X509CRLObject extends X509CRL {
    ...
    private CertificateList f43672c;
    ...
    private void doVerify(PublicKey publicKey, Signature signature) {
        if (this.f43672c.getSignatureAlgorithm().equals(this.f43672c.getTBSCertList().getSignature())) {
    ...
    private Set getExtensionOIDs(boolean z11) {
        ...
        if (getVersion() != 2 || (extensions = this.f43672c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f43672c.getRevokedCertificateEnumeration();
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRL) {
            if (obj instanceof X509CRLObject) {
                ...
                return this.f43672c.equals(x509CRLObject.f43672c);
            }
    ...
    public byte[] getEncoded() {
        try {
            return this.f43672c.getEncoded(ASN1Encoding.DER);
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f43672c.getTBSCertList().getExtensions();
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f43672c.getIssuer().toASN1Primitive()));
    }

    @Override // java.security.cert.X509CRL
    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f43672c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        if (this.f43672c.getNextUpdate() != null) {
            return this.f43672c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    public String getSigAlgOID() {
        return this.f43672c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f43672c.getSignature().getOctets();
    }

    @Override // java.security.cert.X509CRL
    public byte[] getTBSCertList() {
        try {
            return this.f43672c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e11) {
            throw new CRLException(e11.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f43672c.getThisUpdate().getDate();
    }

    @Override // java.security.cert.X509CRL
    public int getVersion() {
        return this.f43672c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        if (certificate.getType().equals("X.509")) {
            Enumeration revokedCertificateEnumeration = this.f43672c.getRevokedCertificateEnumeration();
            X500Name issuer2 = this.f43672c.getIssuer();
