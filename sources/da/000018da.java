...
@fg.a(name = SourceCodeModule.NAME)
...
public class SourceCodeModule extends NativeSourceCodeSpec {
    ...
    protected Map<String, Object> getTypedExportedConstants() {
        ...
        hashMap.put("scriptURL", (String) wf.a.d(getReactApplicationContext().getSourceURL(), "No source URL loaded, have you initialised the instance?"));
        return hashMap;
    }
}