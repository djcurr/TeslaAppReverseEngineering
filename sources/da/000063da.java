...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u0004\u001a\u00020\u0003¢\u0006\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, d2 = {"Lcom/withpersona/sdk/inquiry/selfie/network/CheckVerificationResponse_DataJsonAdapter;", "Lcom/squareup/moshi/f;", "Lcom/withpersona/sdk/inquiry/selfie/network/CheckVerificationResponse$Data;", "Lcom/squareup/moshi/p;", "moshi", "<init>", "(Lcom/squareup/moshi/p;)V", "selfie_release"}, k = 1, mv = {1, 5, 1})
/* loaded from: classes6.dex */
public final class CheckVerificationResponse_DataJsonAdapter extends f<CheckVerificationResponse.Data> {

    /* renamed from: a  reason: collision with root package name */
    private final h.b f22863a;

    /* renamed from: b  reason: collision with root package name */
    private final f<String> f22864b;

    /* renamed from: c  reason: collision with root package name */
    private final f<CheckVerificationResponse.Attributes> f22865c;
    ...
    public CheckVerificationResponse.Data b(h reader) {
        ...
        while (reader.p()) {
            int G0 = reader.G0(this.f22863a);
            if (G0 == -1) {
                reader.Q0();
                reader.R0();
            } else if (G0 == 0) {
                str = this.f22864b.b(reader);
                if (str == null) {
                    JsonDataException v11 = b.v("id", "id", reader);
                    s.f(v11, "unexpectedNull(\"id\", \"id\", reader)");
                    throw v11;
                }
            } else if (G0 == 1 && (attributes = this.f22865c.b(reader)) == null) {
                JsonDataException v12 = b.v("attributes", "attributes", reader);
        ...
        if (str == null) {
            ...
            return new CheckVerificationResponse.Data(str, attributes);
        } else {
    ...
    public void j(m writer, CheckVerificationResponse.Data data) {
        ...
        writer.j();
        writer.L("id");
        this.f22864b.j(writer, data.b());
        writer.L("attributes");
        this.f22865c.j(writer, data.a());
        writer.C();
    }
