...
public class Arguments {
    ...
    public static WritableArray fromArray(Object obj) {
        ...
        if (obj instanceof String[]) {
            ...
            while (i11 < length) {
                createArray.pushString(strArr[i11]);
                i11++;
            }
            ...
            while (i11 < length2) {
                createArray.pushMap(fromBundle(bundleArr[i11]));
                i11++;
            }
            ...
            while (i11 < length4) {
                createArray.pushDouble(fArr[i11]);
                i11++;
            }
            ...
            while (i11 < length5) {
                createArray.pushDouble(dArr[i11]);
                i11++;
            }
            ...
            while (i11 < length6) {
                createArray.pushBoolean(zArr[i11]);
                i11++;
            }
    ...
    public static ArrayList toList(ReadableArray readableArray) {
        ...
        for (int i11 = 0; i11 < readableArray.size(); i11++) {
            switch (AnonymousClass2.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i11).ordinal()]) {
                case 1:
                    arrayList.add(null);
                    break;
                case 2:
                ...
                case 4:
                    ...
                    break;
                case 5:
                    arrayList.add(toBundle(readableArray.getMap(i11)));
                    break;
                case 6:
                    arrayList.add(toList(readableArray.getArray(i11)));
                    break;
                default:
