...
public class CertPathValidationResult {
    ...
    public CertPathValidationResult(CertPathValidationContext certPathValidationContext, int i11, int i12, CertPathValidationException certPathValidationException) {
