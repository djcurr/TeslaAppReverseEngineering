...
public final class t extends com.squareup.wire.f {
    ...
    public static final class a extends ProtoAdapter<t> {
        ...
        public t decode(com.squareup.wire.k reader) {
            ...
            while (true) {
                int g11 = reader.g();
                if (g11 == -1) {
                    return new t(uVar, uVar2, uVar3, uVar4, reader.e(d11));
                } else if (g11 == 1) {
        ...
        public int encodedSize(t value) {
            ...
            ProtoAdapter<u> protoAdapter = u.f35845a;
            return z11 + protoAdapter.encodedSizeWithTag(1, value.b()) + protoAdapter.encodedSizeWithTag(2, value.c()) + protoAdapter.encodedSizeWithTag(3, value.e()) + protoAdapter.encodedSizeWithTag(4, value.d());
        }
        ...
        public t redact(t value) {
            ...
            u d11 = value.d();
            return value.a(redact, redact2, redact3, d11 != null ? u.f35845a.redact(d11) : null, okio.i.f42656d);
        }
    }
    ...
    static {
        new b(null);
        f35840e = new a(com.squareup.wire.b.LENGTH_DELIMITED, m0.b(t.class), com.squareup.wire.o.PROTO_3);
    }
    ...
    public /* synthetic */ t(u uVar, u uVar2, u uVar3, u uVar4, okio.i iVar, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this((i11 & 1) != 0 ? null : uVar, (i11 & 2) != 0 ? null : uVar2, (i11 & 4) != 0 ? null : uVar3, (i11 & 8) == 0 ? uVar4 : null, (i11 & 16) != 0 ? okio.i.f42656d : iVar);
    }

    public final t a(u uVar, u uVar2, u uVar3, u uVar4, okio.i unknownFields) {
        kotlin.jvm.internal.s.g(unknownFields, "unknownFields");
        return new t(uVar, uVar2, uVar3, uVar4, unknownFields);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof t) {
            t tVar = (t) obj;
            return kotlin.jvm.internal.s.c(unknownFields(), tVar.unknownFields()) && kotlin.jvm.internal.s.c(this.f35841a, tVar.f35841a) && kotlin.jvm.internal.s.c(this.f35842b, tVar.f35842b) && kotlin.jvm.internal.s.c(this.f35843c, tVar.f35843c) && kotlin.jvm.internal.s.c(this.f35844d, tVar.f35844d);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        u uVar2 = this.f35842b;
        if (uVar2 != null) {
            arrayList.add("Founder=" + uVar2);
        }
        u uVar3 = this.f35843c;
        if (uVar3 != null) {
            arrayList.add("Signature=" + uVar3);
        }
        u uVar4 = this.f35844d;
        if (uVar4 != null) {
            arrayList.add("Performance=" + uVar4);
        }
        l02 = e0.l0(arrayList, ", ", "VehicleBadging{", "}", 0, null, null, 56, null);
        return l02;
    }
    ...
    public t(u uVar, u uVar2, u uVar3, u uVar4, okio.i unknownFields) {
        super(f35840e, unknownFields);
        kotlin.jvm.internal.s.g(unknownFields, "unknownFields");
        this.f35841a = uVar;
        this.f35842b = uVar2;
        this.f35843c = uVar3;
        ...
        if (!(mr.d.e(uVar, uVar2, uVar3, uVar4, new Object[0]) <= 1)) {
            throw new IllegalArgumentException("At most one of Base, Founder, Signature, Performance may be non-null".toString());
        }
    }
}