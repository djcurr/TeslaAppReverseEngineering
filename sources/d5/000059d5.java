...
public final class AffirmTextSpec$$serializer implements b0<AffirmTextSpec> {
    ...
    static {
        ...
        g1 g1Var = new g1("com.stripe.android.ui.core.elements.AffirmTextSpec", affirmTextSpec$$serializer, 1);
    ...
    public AffirmTextSpec deserialize(e decoder) {
        ...
        b11.d(descriptor2);
        return new AffirmTextSpec(i11, (IdentifierSpec) obj, (q1) null);
    }
    ...
    @Override // c30.h
    public void serialize(f30.f encoder, AffirmTextSpec value) {
        s.g(encoder, "encoder");
        s.g(value, "value");
        f descriptor2 = getDescriptor();
        d b11 = encoder.b(descriptor2);
        AffirmTextSpec.write$Self(value, b11, descriptor2);
        b11.d(descriptor2);
    }
