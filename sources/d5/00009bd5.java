...
public class CamelliaEngine implements BlockCipher {
    ...
    private int[] f43490kw = new int[8];

    /* renamed from: ke  reason: collision with root package name */
    private int[] f43489ke = new int[12];
    ...
    private int processBlock192or256(byte[] bArr, int i11, byte[] bArr2, int i12) {
        ...
        camelliaF2(this.state, this.subkey, 28);
        camelliaF2(this.state, this.subkey, 32);
        camelliaFLs(this.state, this.f43489ke, 8);
    ...
    private void setKey(boolean z11, byte[] bArr) {
        ...
        if (this._keyIs128) {
            if (z11) {
                ...
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                roldq(17, iArr, 0, this.f43489ke, 4);
                ...
                roldq(15, iArr2, 0, this.f43489ke, 0);
                ...
                roldq(17, iArr2, 0, this.f43490kw, 4);
                return;
            }
            int[] iArr9 = this.f43490kw;
            iArr9[4] = iArr[0];
            iArr9[5] = iArr[1];
            iArr9[6] = iArr[2];
            iArr9[7] = iArr[3];
            ...
            iArr10[16] = iArr4[0];
            iArr10[17] = iArr4[1];
            decroldq(17, iArr, 0, this.f43489ke, 0);
            ...
            decroldq(15, iArr2, 0, this.f43489ke, 4);
            ...
            roldq(17, iArr2, 0, this.f43490kw, 0);
            return;
        }
        for (int i13 = 0; i13 < 4; i13++) {
        ...
        roldqo32(51, iArr3, 0, this.f43490kw, 0);
    }
