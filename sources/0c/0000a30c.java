    ...
    public OutputEncryptor build() {
        ...
        try {
            ...
            if (PEMUtilities.isPKCS5Scheme2(this.algOID)) {
                ...
                try {
                    KeyDerivationFunc keyDerivationFunc = new KeyDerivationFunc(this.algOID, ASN1Primitive.fromByteArray(generateParameters.getEncoded()));
                    ...
                    try {
                        SecretKey generateSecretKeyForPKCS5Scheme2 = PEMUtilities.generateSecretKeyForPKCS5Scheme2(this.helper, this.algOID.getId(), this.password, this.salt, this.iterationCount);
                ...
                try {
                    ...
                    throw new OperatorCreationException(e13.getMessage(), e13);
                }
            } else {
            ...
            throw new OperatorCreationException(this.algOID + " not available: " + e14.getMessage(), e14);
        }
    }

    public JceOpenSSLPKCS8EncryptorBuilder setIterationCount(int i11) {
