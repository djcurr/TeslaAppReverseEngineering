...
public class x1 extends i.b {
    ...
    public x1(n60.e eVar, n60.f fVar, n60.f fVar2) {
        super(eVar, fVar, fVar2);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public x1(n60.e eVar, n60.f fVar, n60.f fVar2, n60.f[] fVarArr) {
    ...
    public n60.i J() {
        ...
        return new x1(i11, o12, o13.a(a11).a(o11).j(o13).a(fVar3).a(o12).a(j11), new n60.f[]{j11});
    }
    ...
    public n60.i K(n60.i iVar) {
        ...
        if (o15.i()) {
            ...
            return new x1(i11, l11, i11.o());
        } else {
            n60.f j12 = l11.o().j(j11);
            n60.f j13 = l11.j(o15).j(o14);
            return new x1(i11, j12, l11.a(o15).o().l(a11, b11, j13), new n60.f[]{j13});
        }
    }
    ...
    public n60.i a(n60.i iVar) {
        ...
        return new x1(i11, fVar4, fVar6, new n60.f[]{fVar5});
    }
    ...
    public n60.i z() {
        ...
        n60.f fVar2 = this.f40630c;
        n60.f fVar3 = this.f40631d[0];
        return new x1(this.f40628a, fVar, fVar2.a(fVar3), new n60.f[]{fVar3});
    }
}