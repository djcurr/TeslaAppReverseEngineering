...
final class e extends c {
    private void b(List<atd.i.b> list) {
        list.add(new atd.i.a(atd.s0.a.a(-80499235940928L), Build.BOARD));
        list.add(new atd.i.a(atd.s0.a.a(-80512120842816L), Build.BOOTLOADER));
        list.add(new atd.i.a(atd.s0.a.a(-80525005744704L), Build.BRAND));
        list.add(new atd.i.a(atd.s0.a.a(-80297372478016L), Build.DEVICE));
        list.add(new atd.i.a(atd.s0.a.a(-80310257379904L), Build.DISPLAY));
        list.add(new atd.i.a(atd.s0.a.a(-80323142281792L), Build.FINGERPRINT));
        list.add(new atd.i.a(atd.s0.a.a(-80336027183680L), Build.HARDWARE));
        list.add(new atd.i.a(atd.s0.a.a(-80383271823936L), Build.ID));
        list.add(new atd.i.a(atd.s0.a.a(-80396156725824L), Build.MANUFACTURER));
        list.add(new atd.i.a(atd.s0.a.a(-80683919534656L), Build.PRODUCT));
        list.add(new atd.i.a(atd.s0.a.a(-80696804436544L), Build.getRadioVersion()));
        list.add(new atd.k.a());
        list.add(new atd.k.b());
        list.add(new atd.k.c());
        list.add(new atd.i.a(atd.s0.a.a(-80744049076800L), Build.TAGS));
        list.add(new atd.i.a(atd.s0.a.a(-80756933978688L), Long.valueOf(Build.TIME)));
        list.add(new atd.i.a(atd.s0.a.a(-80769818880576L), Build.TYPE));
        list.add(new atd.i.a(atd.s0.a.a(-80782703782464L), Build.USER));
    }

    private void c(List<atd.i.b> list) {
        list.add(new atd.i.a(atd.s0.a.a(-80555070515776L), Build.VERSION.CODENAME));
        list.add(new atd.i.a(atd.s0.a.a(-80567955417664L), Build.VERSION.INCREMENTAL));
        list.add(new atd.l.a());
        list.add(new atd.i.a(atd.s0.a.a(-80580840319552L), Integer.valueOf(Build.VERSION.SDK_INT)));
    ...
    private void e(List<atd.i.b> list) {
        ...
        list.add(new atd.i.a(atd.s0.a.a(-75620153092672L), Float.valueOf(displayMetrics.density)));
        list.add(new atd.i.a(atd.s0.a.a(-75633037994560L), Integer.valueOf(displayMetrics.densityDpi)));
        list.add(new atd.i.a(atd.s0.a.a(-75645922896448L), Float.valueOf(displayMetrics.scaledDensity)));
        list.add(new atd.i.a(atd.s0.a.a(-75693167536704L), Float.valueOf(displayMetrics.xdpi)));
        list.add(new atd.i.a(atd.s0.a.a(-75706052438592L), Float.valueOf(displayMetrics.ydpi)));
    }
