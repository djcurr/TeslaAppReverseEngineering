...
public class f {
    ...
    public f() {
        this.f56504a = ((o) w.f.a(o.class)) != null;
    }
    ...
    */
    public boolean a(java.util.List<android.hardware.camera2.CaptureRequest> r3, boolean r4) {
        ...
        L2c:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: x.f.a(java.util.List, boolean):boolean");
    }
}