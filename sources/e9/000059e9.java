...
public final class AuBecsDebitMandateTextSpec$$serializer implements b0<AuBecsDebitMandateTextSpec> {
    ...
    public AuBecsDebitMandateTextSpec deserialize(e decoder) {
        ...
        b11.d(descriptor2);
        return new AuBecsDebitMandateTextSpec(i11, (IdentifierSpec) obj, (q1) null);
    }
    ...
    @Override // c30.h
    public void serialize(f30.f encoder, AuBecsDebitMandateTextSpec value) {
        s.g(encoder, "encoder");
        s.g(value, "value");
        f descriptor2 = getDescriptor();
        d b11 = encoder.b(descriptor2);
        AuBecsDebitMandateTextSpec.write$Self(value, b11, descriptor2);
        b11.d(descriptor2);
    }
