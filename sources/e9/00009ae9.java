...
public class EnvelopedDataHelper {
    ...
    private CipherKeyGenerator createCipherKeyGenerator(SecureRandom secureRandom, int i11) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Object createContentCipher(boolean z11, CipherParameters cipherParameters, AlgorithmIdentifier algorithmIdentifier) {
        ...
        if (aSN1Primitive != null && !(aSN1Primitive instanceof ASN1Null)) {
            if (!algorithm.equals(CMSAlgorithm.DES_EDE3_CBC) && !algorithm.equals(CMSAlgorithm.IDEA_CBC) && !algorithm.equals(CMSAlgorithm.AES128_CBC) && !algorithm.equals(CMSAlgorithm.AES192_CBC) && !algorithm.equals(CMSAlgorithm.AES256_CBC) && !algorithm.equals(CMSAlgorithm.CAMELLIA128_CBC) && !algorithm.equals(CMSAlgorithm.CAMELLIA192_CBC) && !algorithm.equals(CMSAlgorithm.CAMELLIA256_CBC) && !algorithm.equals(CMSAlgorithm.SEED_CBC) && !algorithm.equals(OIWObjectIdentifiers.desCBC)) {
                if (algorithm.equals(CMSAlgorithm.CAST5_CBC)) {
                    createCipher.init(z11, new ParametersWithIV(cipherParameters, CAST5CBCParameters.getInstance(aSN1Primitive).getIV()));
                } else if (algorithm.equals(CMSAlgorithm.RC2_CBC)) {
                    RC2CBCParameter rC2CBCParameter = RC2CBCParameter.getInstance(aSN1Primitive);
                    createCipher.init(z11, new ParametersWithIV(new RC2Parameters(((KeyParameter) cipherParameters).getKey(), rc2Ekb[rC2CBCParameter.getRC2ParameterVersion().intValue()]), rC2CBCParameter.getIV()));
                } else {
                    throw new CMSException("cannot match parameters");
                }
            } else {
                createCipher.init(z11, new ParametersWithIV(cipherParameters, ASN1OctetString.getInstance(aSN1Primitive).getOctets()));
            }
    ...
    private static Map createTable() {
        HashMap hashMap = new HashMap();
        hashMap.put(PKCSObjectIdentifiers.id_hmacWithSHA1, new BcDigestProvider() { // from class: org.spongycastle.cms.bc.EnvelopedDataHelper.1
        ...
        hashMap.put(PKCSObjectIdentifiers.id_hmacWithSHA224, new BcDigestProvider() { // from class: org.spongycastle.cms.bc.EnvelopedDataHelper.2
            @Override // org.spongycastle.operator.bc.BcDigestProvider
            public ExtendedDigest get(AlgorithmIdentifier algorithmIdentifier) {
                return new SHA224Digest();
            }
        });
        hashMap.put(PKCSObjectIdentifiers.id_hmacWithSHA256, new BcDigestProvider() { // from class: org.spongycastle.cms.bc.EnvelopedDataHelper.3
            @Override // org.spongycastle.operator.bc.BcDigestProvider
            public ExtendedDigest get(AlgorithmIdentifier algorithmIdentifier) {
                return new SHA256Digest();
            }
        });
        hashMap.put(PKCSObjectIdentifiers.id_hmacWithSHA384, new BcDigestProvider() { // from class: org.spongycastle.cms.bc.EnvelopedDataHelper.4
            @Override // org.spongycastle.operator.bc.BcDigestProvider
            public ExtendedDigest get(AlgorithmIdentifier algorithmIdentifier) {
                return new SHA384Digest();
            }
        });
        hashMap.put(PKCSObjectIdentifiers.id_hmacWithSHA512, new BcDigestProvider() { // from class: org.spongycastle.cms.bc.EnvelopedDataHelper.5
            @Override // org.spongycastle.operator.bc.BcDigestProvider
            public ExtendedDigest get(AlgorithmIdentifier algorithmIdentifier) {
        ...
        if (!aSN1ObjectIdentifier.equals(CMSAlgorithm.AES128_CBC) && !aSN1ObjectIdentifier.equals(CMSAlgorithm.AES192_CBC) && !aSN1ObjectIdentifier.equals(CMSAlgorithm.AES256_CBC) && !aSN1ObjectIdentifier.equals(CMSAlgorithm.CAMELLIA128_CBC) && !aSN1ObjectIdentifier.equals(CMSAlgorithm.CAMELLIA192_CBC) && !aSN1ObjectIdentifier.equals(CMSAlgorithm.CAMELLIA256_CBC) && !aSN1ObjectIdentifier.equals(CMSAlgorithm.SEED_CBC)) {
            if (!aSN1ObjectIdentifier.equals(CMSAlgorithm.DES_EDE3_CBC) && !aSN1ObjectIdentifier.equals(CMSAlgorithm.IDEA_CBC) && !aSN1ObjectIdentifier.equals(OIWObjectIdentifiers.desCBC)) {
                if (aSN1ObjectIdentifier.equals(CMSAlgorithm.CAST5_CBC)) {
                    ...
                    return new AlgorithmIdentifier(aSN1ObjectIdentifier, new CAST5CBCParameters(bArr, ((KeyParameter) cipherParameters).getKey().length * 8));
                    ...
                    if (aSN1ObjectIdentifier.equals(PKCSObjectIdentifiers.RC2_CBC)) {
                        ...
                        return new AlgorithmIdentifier(aSN1ObjectIdentifier, new RC2CBCParameter(rc2Table[128], bArr2));
                    }
