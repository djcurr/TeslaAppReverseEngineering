...
public class JcaX509v3CertificateBuilder extends X509v3CertificateBuilder {
    ...
    public JcaX509v3CertificateBuilder copyAndAddExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z11, X509Certificate x509Certificate) {
        copyAndAddExtension(aSN1ObjectIdentifier, z11, new JcaX509CertificateHolder(x509Certificate));
        return this;
    }
