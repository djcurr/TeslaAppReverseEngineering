...
public class AppCompatAutoCompleteTextView extends AutoCompleteTextView implements androidx.core.view.y {

    /* renamed from: c  reason: collision with root package name */
    private static final int[] f1553c = {16843126};
    ...
    public AppCompatAutoCompleteTextView(Context context, AttributeSet attributeSet, int i11) {
        ...
        u0 v11 = u0.v(getContext(), attributeSet, f1553c, i11, 0);
        if (v11.s(0)) {
