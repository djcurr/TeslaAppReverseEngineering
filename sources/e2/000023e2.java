...
public final class zzac {
    public static int zza(int i11, int i12, String str) {
        ...
        if (i11 < 0 || i11 >= i12) {
            if (i11 < 0) {
                zza = zzad.zza("%s (%s) must not be negative", "index", Integer.valueOf(i11));
            } else if (i12 < 0) {
                throw new IllegalArgumentException("negative size: " + i12);
            } else {
                zza = zzad.zza("%s (%s) must be less than size (%s)", "index", Integer.valueOf(i11), Integer.valueOf(i12));
            }
    ...
    public static void zzc(int i11, int i12, int i13) {
        ...
        if (i11 < 0 || i12 < i11 || i12 > i13) {
            if (i11 >= 0 && i11 <= i13) {
                zze = (i12 < 0 || i12 > i13) ? zze(i12, i13, "end index") : zzad.zza("end index (%s) must not be less than start index (%s)", Integer.valueOf(i12), Integer.valueOf(i11));
            } else {
    ...
    private static String zze(int i11, int i12, String str) {
        if (i11 < 0) {
            return zzad.zza("%s (%s) must not be negative", str, Integer.valueOf(i11));
        }
        if (i12 >= 0) {
            return zzad.zza("%s (%s) must not be greater than size (%s)", str, Integer.valueOf(i11), Integer.valueOf(i12));
        }
        throw new IllegalArgumentException("negative size: " + i12);
    }
}