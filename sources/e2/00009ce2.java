...
public class HMacDSAKCalculator implements DSAKCalculator {
    ...
    private BigInteger bitsToInt(byte[] bArr) {
        ...
        return bArr.length * 8 > this.f43628n.bitLength() ? bigInteger.shiftRight((bArr.length * 8) - this.f43628n.bitLength()) : bigInteger;
    }
    ...
    public BigInteger nextK() {
        int bitLength = (this.f43628n.bitLength() + 7) / 8;
        ...
        while (true) {
            ...
            if (bitsToInt.compareTo(ZERO) > 0 && bitsToInt.compareTo(this.f43628n) < 0) {
                return bitsToInt;
            }
