...
public class IDEACBCPar extends ASN1Object {
    ...
    ASN1OctetString f43380iv;

    public IDEACBCPar(byte[] bArr) {
        this.f43380iv = new DEROctetString(bArr);
    }
    ...
    public byte[] getIV() {
        ASN1OctetString aSN1OctetString = this.f43380iv;
    ...
    public IDEACBCPar(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() == 1) {
            this.f43380iv = (ASN1OctetString) aSN1Sequence.getObjectAt(0);
        } else {
            this.f43380iv = null;
        }
    }
