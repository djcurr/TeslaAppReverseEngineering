...
public class j2 extends i.b {
    ...
    public j2(n60.e eVar, n60.f fVar, n60.f fVar2) {
        super(eVar, fVar, fVar2);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public j2(n60.e eVar, n60.f fVar, n60.f fVar2, n60.f[] fVarArr) {
    ...
    public n60.i J() {
        ...
        return new j2(i11, o12, fVar.p(a11, j11).a(o12).a(j12), new n60.f[]{j12});
    }
    ...
    public n60.i K(n60.i iVar) {
        ...
        if (o15.i()) {
            ...
            return new j2(i11, l11, i11.o().n());
        } else {
            n60.f j12 = l11.o().j(j11);
            n60.f j13 = l11.j(o15).j(o14);
            return new j2(i11, j12, l11.a(o15).o().l(a11, o11.b(), j13), new n60.f[]{j13});
        }
    }
    ...
    public n60.i a(n60.i iVar) {
        ...
        if (n11.i()) {
            ...
            if (fVar4.i()) {
                return new j2(i11, fVar4, i11.o().n());
            }
        ...
        return new j2(i11, fVar4, fVar6, new n60.f[]{fVar5});
    }
    ...
    public n60.i z() {
        ...
        n60.f fVar2 = this.f40630c;
        n60.f fVar3 = this.f40631d[0];
        return new j2(this.f40628a, fVar, fVar2.a(fVar3), new n60.f[]{fVar3});
    }
}