...
public class TlsDHUtils {
    ...
    public static void addNegotiatedDHEGroupsServerExtension(Hashtable hashtable, short s11) {
        hashtable.put(EXT_negotiated_ff_dhe_groups, createNegotiatedDHEGroupsServerExtension(s11));
    }
    ...
    public static byte[] createNegotiatedDHEGroupsServerExtension(short s11) {
    ...
    public static DHParameters getParametersForDHEGroup(short s11) {
        if (s11 != 0) {
            if (s11 != 1) {
                if (s11 != 2) {
                    if (s11 != 3) {
