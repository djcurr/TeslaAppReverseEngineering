...
public class CMSProcessableFile implements CMSTypedData, CMSReadable {
    ...
    public CMSProcessableFile(File file, int i11) {
        this(new ASN1ObjectIdentifier(CMSObjectIdentifiers.data.getId()), file, i11);
    }

    public CMSProcessableFile(ASN1ObjectIdentifier aSN1ObjectIdentifier, File file, int i11) {
