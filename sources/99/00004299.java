...
public final class OrderedList$OrderedListPane extends GeneratedMessageLite<OrderedList$OrderedListPane, a> implements MessageLiteOrBuilder {
    private static final OrderedList$OrderedListPane DEFAULT_INSTANCE;
    private static volatile Parser<OrderedList$OrderedListPane> PARSER;
    ...
    public static final class Actions extends GeneratedMessageLite<Actions, b> implements MessageLiteOrBuilder {
        ...
        public static final class ButtonTapAction extends GeneratedMessageLite<ButtonTapAction, a> implements MessageLiteOrBuilder {
            ...
            public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
                switch (p7.f19217a[methodToInvoke.ordinal()]) {
                    case 1:
    ...
    public static final class Rendering extends GeneratedMessageLite<Rendering, a> implements MessageLiteOrBuilder {
            ...
            public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
                switch (p7.f19217a[methodToInvoke.ordinal()]) {
                    ...
                    case 2:
                        return new a();
                    case 3:
                        return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001\t\u0002\t", new Object[]{"label_", "detail_"});
                    case 4:
                        return DEFAULT_INSTANCE;
                    case 5:
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setItems(int i11, ListItem listItem) {
            listItem.getClass();
            ensureItemsIsMutable();
            this.items_.set(i11, listItem);
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (p7.f19217a[methodToInvoke.ordinal()]) {
                ...
                case 2:
                    return new a();
                case 3:
                    return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u000b\u0000\u0000\u0001\u000b\u000b\u0000\u0001\u0000\u0001\t\u0002\t\u0003\t\u0004\t\u0005\u001b\u0006\t\u0007\t\b\t\t\t\n\t\u000b\t", new Object[]{"institution_", "headerAsset_", "header_", "events_", "items_", ListItem.class, "disclaimer_", "button_", "content_", "paneHeader_", "secondaryButton_", "buttonDisclaimerText_"});
                case 4:
                    return DEFAULT_INSTANCE;
                case 5:
        ...
        public ListItem getItems(int i11) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void addItems(int i11, ListItem listItem) {
            listItem.getClass();
            ensureItemsIsMutable();
            this.items_.add(i11, listItem);
        }
    ...
    /* loaded from: classes2.dex */
    public static final class a extends GeneratedMessageLite.Builder<OrderedList$OrderedListPane, a> implements MessageLiteOrBuilder {
        public a() {
            super(OrderedList$OrderedListPane.DEFAULT_INSTANCE);
        }
    }

    static {
        OrderedList$OrderedListPane orderedList$OrderedListPane = new OrderedList$OrderedListPane();
        DEFAULT_INSTANCE = orderedList$OrderedListPane;
        GeneratedMessageLite.registerDefaultInstance(OrderedList$OrderedListPane.class, orderedList$OrderedListPane);
    }

    private OrderedList$OrderedListPane() {
    }

    public static OrderedList$OrderedListPane getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }
    ...
    public static OrderedList$OrderedListPane parseDelimitedFrom(InputStream inputStream) {
        return (OrderedList$OrderedListPane) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static OrderedList$OrderedListPane parseFrom(ByteBuffer byteBuffer) {
        return (OrderedList$OrderedListPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }

    public static Parser<OrderedList$OrderedListPane> parser() {
        return DEFAULT_INSTANCE.getParserForType();
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (p7.f19217a[methodToInvoke.ordinal()]) {
            case 1:
                return new OrderedList$OrderedListPane();
            case 2:
                return new a();
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0000", null);
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                Parser<OrderedList$OrderedListPane> parser = PARSER;
                if (parser == null) {
                    synchronized (OrderedList$OrderedListPane.class) {
                        parser = PARSER;
                        if (parser == null) {
                            parser = new GeneratedMessageLite.DefaultInstanceBasedParser<>(DEFAULT_INSTANCE);
                            PARSER = parser;
    ...
    public static a newBuilder(OrderedList$OrderedListPane orderedList$OrderedListPane) {
        return DEFAULT_INSTANCE.createBuilder(orderedList$OrderedListPane);
    }

    public static OrderedList$OrderedListPane parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (OrderedList$OrderedListPane) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }

    public static OrderedList$OrderedListPane parseFrom(ByteBuffer byteBuffer, ExtensionRegistryLite extensionRegistryLite) {
        return (OrderedList$OrderedListPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, extensionRegistryLite);
    }

    public static OrderedList$OrderedListPane parseFrom(ByteString byteString) {
        return (OrderedList$OrderedListPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString);
    }

    public static OrderedList$OrderedListPane parseFrom(ByteString byteString, ExtensionRegistryLite extensionRegistryLite) {
        return (OrderedList$OrderedListPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteString, extensionRegistryLite);
    }

    public static OrderedList$OrderedListPane parseFrom(byte[] bArr) {
        return (OrderedList$OrderedListPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static OrderedList$OrderedListPane parseFrom(byte[] bArr, ExtensionRegistryLite extensionRegistryLite) {
        return (OrderedList$OrderedListPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, extensionRegistryLite);
    }

    public static OrderedList$OrderedListPane parseFrom(InputStream inputStream) {
        return (OrderedList$OrderedListPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static OrderedList$OrderedListPane parseFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (OrderedList$OrderedListPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }

    public static OrderedList$OrderedListPane parseFrom(CodedInputStream codedInputStream) {
        return (OrderedList$OrderedListPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, codedInputStream);
    }

    public static OrderedList$OrderedListPane parseFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
        return (OrderedList$OrderedListPane) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, codedInputStream, extensionRegistryLite);
    }
}