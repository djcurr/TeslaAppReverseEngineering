            ...
            if (i13 * 8 == i12) {
                if (i13 != 1) {
                    ...
                    if (i13 == 2) {
                        ...
                        rfc3394UnwrapNoIvCheck = rfc3394UnwrapNoIvCheck(bArr, i11, i12);
                    }
                    ...
                    if (i15 >= rfc3394UnwrapNoIvCheck.length) {
                        i15 = rfc3394UnwrapNoIvCheck.length;
                        constantTimeAreEqual = false;
                    }
                    byte[] bArr8 = new byte[i15];
                    System.arraycopy(rfc3394UnwrapNoIvCheck, rfc3394UnwrapNoIvCheck.length - i15, bArr8, 0, i15);
                    if (!Arrays.constantTimeAreEqual(bArr8, new byte[i15])) {
                        constantTimeAreEqual = false;
                    }
