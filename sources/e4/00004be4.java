...
@f(c = "com.stripe.android.Stripe$confirmSetupIntent$1", f = "Stripe.kt", l = {530}, m = "invokeSuspend")
/* loaded from: classes2.dex */
public final class Stripe$confirmSetupIntent$1 extends l implements p<o0, zz.d<? super b0>, Object> {
    ...
    public Stripe$confirmSetupIntent$1(Stripe stripe, ComponentActivity componentActivity, ConfirmSetupIntentParams confirmSetupIntentParams, String str, zz.d<? super Stripe$confirmSetupIntent$1> dVar) {
        super(2, dVar);
        this.this$0 = stripe;
    ...
    public final zz.d<b0> create(Object obj, zz.d<?> dVar) {
        return new Stripe$confirmSetupIntent$1(this.this$0, this.$activity, this.$confirmSetupIntentParams, this.$stripeAccountId, dVar);
    }

    @Override // h00.p
    public final Object mo160invoke(o0 o0Var, zz.d<? super b0> dVar) {
        return ((Stripe$confirmSetupIntent$1) create(o0Var, dVar)).invokeSuspend(b0.f54756a);
    }
