...
public class PBEPBKDF2 {
    ...
    public static class AlgParams extends BaseAlgorithmParameters {
        ...
        protected void engineInit(AlgorithmParameterSpec algorithmParameterSpec) {
            ...
            this.params = new l(pBEParameterSpec.getSalt(), pBEParameterSpec.getIterationCount());
        }

        @Override // java.security.AlgorithmParametersSpi
        protected void engineInit(byte[] bArr) {
            this.params = l.e(n.k(bArr));
        }
        ...
        protected AlgorithmParameterSpec localEngineGetParameterSpec(Class cls) {
            if (cls == PBEParameterSpec.class || cls == AlgorithmParameterSpec.class) {
                return new PBEParameterSpec(this.params.j(), this.params.f().intValue());
            }
    ...
    public static class BasePBKDF2 extends BaseSecretKeyFactory {
        ...
        private int getDigestCode(k kVar) {
        ...
        public SecretKey engineGenerateSecret(KeySpec keySpec) {
            if (keySpec instanceof PBEKeySpec) {
                ...
                if (pBEKeySpec.getSalt() == null) {
                    return new h(pBEKeySpec.getPassword(), this.scheme == 1 ? x.ASCII : x.UTF8);
                    ...
                    if (pBEKeySpec instanceof o) {
                        int digestCode = getDigestCode(((o) pBEKeySpec).a().e());
    ...
    static {
        ...
        prfCodes = hashMap;
        hashMap.put(a.f29840c, f.d(6));
        hashMap.put(w40.n.f55524a2, f.d(1));
        hashMap.put(w40.n.f55529d2, f.d(4));
        hashMap.put(w40.n.f55527c2, f.d(7));
        hashMap.put(w40.n.f55531e2, f.d(8));
        hashMap.put(w40.n.f55533f2, f.d(9));
        hashMap.put(b.f49160p, f.d(11));
        hashMap.put(b.f49159o, f.d(10));
        hashMap.put(b.f49161q, f.d(12));
        hashMap.put(b.f49162r, f.d(13));
        hashMap.put(k40.b.f34377q, f.d(14));
    }
