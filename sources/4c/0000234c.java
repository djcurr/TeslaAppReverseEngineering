...
final class zzkv extends zzii implements RandomAccess, zzkf, zzln {
    ...
    public final int hashCode() {
        ...
        for (int i12 = 0; i12 < this.zzc; i12++) {
            i11 = (i11 * 31) + zzkh.zzc(this.zzb[i12]);
        }
        return i11;
    }
    ...
    /* renamed from: zze */
    public final zzkf zzd(int i11) {
        if (i11 >= this.zzc) {
            return new zzkv(Arrays.copyOf(this.zzb, i11), this.zzc);
        }
    ...
    private zzkv(long[] jArr, int i11) {
        this.zzb = jArr;
        this.zzc = i11;
    }
