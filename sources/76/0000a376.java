...
public class JceKTSKeyWrapper extends AsymmetricKeyWrapper {
    ...
    public JceKTSKeyWrapper(PublicKey publicKey, String str, int i11, byte[] bArr, byte[] bArr2) {
        super(new AlgorithmIdentifier(PKCSObjectIdentifiers.id_rsa_KEM, new GenericHybridParameters(new AlgorithmIdentifier(ISOIECObjectIdentifiers.id_kem_rsa, new RsaKemParameters(new AlgorithmIdentifier(X9ObjectIdentifiers.id_kdf_kdf3, new AlgorithmIdentifier(NISTObjectIdentifiers.id_sha256)), (i11 + 7) / 8)), JceSymmetricKeyWrapper.determineKeyEncAlg(str, i11))));
    ...
    public JceKTSKeyWrapper(X509Certificate x509Certificate, String str, int i11, byte[] bArr, byte[] bArr2) {
