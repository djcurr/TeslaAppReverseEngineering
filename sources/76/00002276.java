...
public final class zzcx extends zzdt {
    ...
    public final void zza() {
        ...
        try {
            ...
            zzcl zzclVar = new zzcl(60000L, Math.max(localVersion, remoteVersion), DynamiteModule.getRemoteVersion(this.zzc, ModuleDescriptor.MODULE_ID) < localVersion, str, str2, str3, this.zzd, com.google.android.gms.measurement.internal.zzfl.zza(this.zzc));
            zzccVar2 = this.zze.zzj;
            ((zzcc) Preconditions.checkNotNull(zzccVar2)).initialize(ObjectWrapper.wrap(this.zzc), zzclVar, this.zzh);
        } catch (Exception e11) {
            this.zze.zzS(e11, true, false);
        }
    }
}