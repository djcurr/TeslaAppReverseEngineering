...
public enum a {
    ...
    private static final Map<String, a> MAPPED_BY_NAME;
    ...
    static {
        ...
        for (a aVar : values()) {
            hashMap.put(aVar.mTxVariant, aVar);
        }
    ...
    public static List<a> estimate(String str) {
        a[] values;
        ArrayList arrayList = new ArrayList();
        for (a aVar : values()) {
            if (aVar.isEstimateFor(str)) {
                arrayList.add(aVar);
            }
        }
        return arrayList;
    ...
    public static a getByBrandName(String str) {
