...
public final class USBankAccountFormFragment$renderVerifyWithMicrodepositsScreen$1 extends u implements p<i, Integer, b0> {
    ...
    public static final class AnonymousClass1 extends u implements p<i, Integer, b0> {
        ...
        public final void invoke(i iVar, int i11) {
            if (((i11 & 11) ^ 2) == 0 && iVar.i()) {
                ...
                this.this$0.VerifyWithMicrodepositsScreen(this.$screenState, iVar, 72);
            }
        }
    }
    ...
    public final void invoke(i iVar, int i11) {
        if (((i11 & 11) ^ 2) == 0 && iVar.i()) {
            ...
            PaymentsThemeKt.PaymentsTheme(null, null, null, c.b(iVar, -819901628, true, new AnonymousClass1(this.this$0, this.$screenState)), iVar, 3072, 7);
        }
    }
}