...
public class Camera2Session implements CameraSession {
    ...
    public class CameraStateCallback extends CameraDevice.StateCallback {
        ...
        public void onError(CameraDevice cameraDevice, int i11) {
            Camera2Session.this.checkIsOnCameraThread();
            Camera2Session.this.reportError(getErrorDescription(i11));
        }
        ...
        public void onOpened(CameraDevice cameraDevice) {
            ...
            try {
                ...
                camera2Session.reportError("Failed to create capture session. " + e11);
            }
        }
    }
        ...
        public void onConfigured(CameraCaptureSession cameraCaptureSession) {
            ...
            try {
                ...
                Camera2Session.this.surfaceTextureHelper.startListening(new VideoSink() { // from class: org.webrtc.f
                    {
                        Camera2Session.CaptureSessionCallback.this = this;
                    }

                    @Override // org.webrtc.VideoSink
                    public final void onFrame(VideoFrame videoFrame) {
                        Camera2Session.CaptureSessionCallback.a(Camera2Session.CaptureSessionCallback.this, videoFrame);
                    }
                });
                ...
                Camera2Session camera2Session = Camera2Session.this;
                camera2Session.reportError("Failed to start capture request. " + e11);
            }
        }
    }
    ...
    private Camera2Session(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, Context context, CameraManager cameraManager, SurfaceTextureHelper surfaceTextureHelper, String str, int i11, int i12, int i13) {
    ...
    public static void create(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, Context context, CameraManager cameraManager, SurfaceTextureHelper surfaceTextureHelper, String str, int i11, int i12, int i13) {
    ...
    private void openCamera() {
        ...
        try {
            ...
            reportError("Failed to open camera: " + e11);
        }
    }
