...
public class d1 extends i.b {
    ...
    public d1(n60.e eVar, n60.f fVar, n60.f fVar2) {
        super(eVar, fVar, fVar2);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public d1(n60.e eVar, n60.f fVar, n60.f fVar2, n60.f[] fVarArr) {
    ...
    public n60.i J() {
        ...
        n60.f a11 = fVar2.o().a(j11).a(n11);
        if (a11.i()) {
            return new d1(i11, a11, i11.o().n());
        }
        n60.f o12 = a11.o();
        n60.f j12 = h11 ? a11 : a11.j(o11);
        if (!h11) {
            fVar = fVar.j(fVar3);
        }
        return new d1(i11, o12, fVar.p(a11, j11).a(o12).a(j12), new n60.f[]{j12});
    }
    ...
    public n60.i K(n60.i iVar) {
        ...
        n60.f o13 = fVar2.o();
        n60.f o14 = fVar3.o();
        n60.f a11 = i11.n().j(o14).a(o13).a(fVar2.j(fVar3));
        n60.f b11 = o11.b();
        n60.f l11 = i11.n().a(b11).j(o14).a(o13).l(a11, o12, o14);
        n60.f j11 = n11.j(o14);
        n60.f o15 = j11.a(a11).o();
        if (o15.i()) {
            return l11.i() ? iVar.J() : i11.u();
        } else if (l11.i()) {
            return new d1(i11, l11, i11.o().n());
        } else {
            n60.f j12 = l11.o().j(j11);
            n60.f j13 = l11.j(o15).j(o14);
            return new d1(i11, j12, l11.a(o15).o().l(a11, b11, j13), new n60.f[]{j13});
        }
    }
    ...
    public n60.i a(n60.i iVar) {
        ...
        if (n11.i()) {
            ...
            fVar4 = d11.o().a(d11).a(q11).a(i11.n());
            if (fVar4.i()) {
                return new d1(i11, fVar4, i11.o().n());
            }
        ...
        return new d1(i11, fVar4, fVar6, new n60.f[]{fVar5});
    }
    ...
    public n60.i z() {
        ...
        n60.f fVar2 = this.f40630c;
        n60.f fVar3 = this.f40631d[0];
        return new d1(this.f40628a, fVar, fVar2.a(fVar3), new n60.f[]{fVar3});
    }
}