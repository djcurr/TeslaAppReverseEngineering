...
public class TextInputEditText extends j {
    ...
    public boolean requestRectangleOnScreen(Rect rect) {
        ...
        if (textInputLayout != null && this.textInputLayoutFocusedRectEnabled) {
            this.parentRect.set(0, textInputLayout.getHeight() - getResources().getDimensionPixelOffset(fk.d.K), textInputLayout.getWidth(), textInputLayout.getHeight());
    ...
    public TextInputEditText(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, fk.b.f26379o);
    }
    ...
    public TextInputEditText(Context context, AttributeSet attributeSet, int i11) {
        ...
        TypedArray h11 = com.google.android.material.internal.j.h(context, attributeSet, k.A3, i11, fk.j.f26503g, new int[0]);
        setTextInputLayoutFocusedRectEnabled(h11.getBoolean(k.B3, false));
        h11.recycle();
    }
}