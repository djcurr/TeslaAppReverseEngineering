...
public final class zzaj extends SQLiteOpenHelper {
    ...
    public final SQLiteDatabase getWritableDatabase() {
        ...
        zzkdVar = zzakVar.zzk;
        zzakVar.zzs.zzf();
        if (zzkdVar.zzc(CoreConstants.MILLIS_IN_ONE_HOUR)) {
            try {
                ...
                try {
                    ...
                    this.zza.zzs.zzay().zzd().zzb("Failed to open freshly created database", e11);
                    throw e11;
                }
            }
        }
